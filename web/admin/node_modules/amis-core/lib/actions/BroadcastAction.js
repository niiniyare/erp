            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        event.setData(object.createObject(event.data, (_b = action.data) !== null && _b !== void 0 ? _b : {}));
                        eventName = ((_c = action.args) === null || _c === void 0 ? void 0 : _c.eventName) || action.eventName;
                        return [4 /*yield*/, rendererEvent.dispatchGlobalEventForRenderer(eventName, renderer, event.context.scoped, action.data, event)];
                    case 1: 
                    // 直接触发对应的动作
