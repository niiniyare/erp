                ...
                switch (_v.label) {
                    case 0:
                        ...
                        if (modal.$ref && renderer.props.resolveDefinitions) {
                            modal = tslib.__assign(tslib.__assign({}, renderer.props.resolveDefinitions(modal.$ref)), modal);
                        }
                        type = modal === null || modal === void 0 ? void 0 : modal.type;
                        if (!!type) return [3 /*break*/, 2];
                        return [4 /*yield*/, ((_c = (_b = event.context.env).confirm) === null || _c === void 0 ? void 0 : _c.call(_b, tpl.filter(modal === null || modal === void 0 ? void 0 : modal.msg, event.data) || ((_d = action.args) === null || _d === void 0 ? void 0 : _d.msg), tpl.filter((_e = action.dialog) === null || _e === void 0 ? void 0 : _e.title, event.data) || ((_f = action.args) === null || _f === void 0 ? void 0 : _f.title), {
                                closeOnEsc: tpl.filter((_g = action.dialog) === null || _g === void 0 ? void 0 : _g.closeOnEsc, event.data) ||
                                    ((_h = action.args) === null || _h === void 0 ? void 0 : _h.closeOnEsc),
                                size: tpl.filter((_j = action.dialog) === null || _j === void 0 ? void 0 : _j.size, event.data) || ((_k = action.args) === null || _k === void 0 ? void 0 : _k.size),
                                confirmText: tpl.filter((_l = action.dialog) === null || _l === void 0 ? void 0 : _l.confirmText, event.data) ||
                                    ((_m = action.args) === null || _m === void 0 ? void 0 : _m.confirmText),
                                cancelText: tpl.filter((_o = action.dialog) === null || _o === void 0 ? void 0 : _o.cancelText, event.data) ||
                                    ((_p = action.args) === null || _p === void 0 ? void 0 : _p.cancelText),
                                confirmBtnLevel: tpl.filter((_q = action.dialog) === null || _q === void 0 ? void 0 : _q.confirmBtnLevel, event.data) ||
                                    ((_r = action.args) === null || _r === void 0 ? void 0 : _r.confirmBtnLevel),
                                cancelBtnLevel: tpl.filter((_s = action.dialog) === null || _s === void 0 ? void 0 : _s.cancelBtnLevel, event.data) ||
                                    ((_t = action.args) === null || _t === void 0 ? void 0 : _t.cancelBtnLevel),
                                className: tpl.filter((_u = action.dialog) === null || _u === void 0 ? void 0 : _u.className, event.data) || ''
                            }))];
                    case 1:
                        confirmed_1 = _v.sent();
