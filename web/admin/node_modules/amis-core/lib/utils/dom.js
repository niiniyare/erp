...
function ownerDocument(componentOrElement) {
    var _a;
    return (((_a = ReactDOM__default["default"].findDOMNode(componentOrElement)) === null || _a === void 0 ? void 0 : _a.ownerDocument) ||
        document);
}
function getContainerDimensions(containerNode) {
    ...
    if (containerNode.tagName === 'BODY') {
        ...
        (_a = offset.offset(containerNode), width = _a.width, height = _a.height);
