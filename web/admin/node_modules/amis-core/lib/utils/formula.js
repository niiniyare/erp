...
var FormulaExec = {
    tpl: function (expression, data) {
        var curData = data || {};
        return tpl.filter(expression, curData);
    },
    formula: function (expression, data) {
        ...
        try {
            ...
            result = resolveVariableAndFilter.resolveVariableAndFilter(expression, curData, '| raw');
        }
        catch (e) {
    ...
    js: function (expression, data) {
        ...
        try {
            curResult = fn.call(data, data, amisFormula.getFilters());
        }
        catch (e) {
    ...
    var: function (expression, data) {
        var curData = data || {};
        var result = getVariable.getVariable(curData, expression); // 不支持过滤器
        return result !== null && result !== void 0 ? result : expression;
    },
...
function replaceExpression(expression) {
    if (expression &&
        isString__default["default"](expression) &&
        /(\\)(\${).+(\})/.test(expression)) {
