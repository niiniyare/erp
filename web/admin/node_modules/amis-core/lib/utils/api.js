...
var apiCaches = [];
var requestAdaptors = [];
var responseAdaptors = [];
/**
 * 添加全局发送适配器
 * @param adaptor
 */
function addApiRequestAdaptor(adaptor) {
    requestAdaptors.push(adaptor);
    return function () { return removeApiRequestAdaptor(adaptor); };
}
/**
 * 删除全局发送适配器
 * @param adaptor
 */
function removeApiRequestAdaptor(adaptor) {
    var idx = requestAdaptors.findIndex(function (i) { return i === adaptor; });
 ...
 * @param adaptor
 */
function removeApiResponseAdaptor(adaptor) {
    var idx = responseAdaptors.findIndex(function (i) { return i === adaptor; });
...
function buildApi(api, data, options) {
    ...
    var queryStringify = function (query) {
        return helper.qsstringify(query, (api === null || api === void 0 ? void 0 : api.filterEmptyQuery)
            ? {
...
function str2function(contents) {
    ...
    try {
        var fn = new (Function.bind.apply(Function, tslib.__spreadArray(tslib.__spreadArray([void 0], tslib.__read(args), false), [contents], false)))();
        return fn;
    }
    catch (e) {
        console.warn(e);
...
function str2AsyncFunction(contents) {
    ...
    try {
        var fn = new (AsyncFunction.bind.apply(AsyncFunction, tslib.__spreadArray(tslib.__spreadArray([void 0], tslib.__read(args), false), [contents], false)))();
        return fn;
    }
    catch (e) {
        console.warn(e);
...
function callStrFunction(fn, argNames) {
    ...
    if (typeof fn === 'function') {
        ...
        var func = str2function.apply(void 0, tslib.__spreadArray([fn], tslib.__read(argNames), false));
...
function responseAdaptor(ret, api) {
    ...
    if (typeof data === 'string') {
        ...
        if (ret.headers &&
            ...
            if (api.responseType === 'blob') {
                ...
                throw new Error("Content is wrong content-type:\"".concat(contentType, "\" content: ").concat(escapeHtml.escapeHtml(data.substring(0, 100))));
            }
        }
    }
    // 兼容几种常见写法
    ...
    if (api.responseData && (payload.ok || !helper.isEmpty(payload.data))) {
        debug.debug('api', 'before dataMapping', payload.data);
        var responseData = dataMapping.dataMapping(api.responseData, object.createObject({ api: api }, normalizeApiResponseData(payload.data)), undefined, api.convertKeyToPath);
        debug.debug('api', 'after dataMapping', responseData);
        payload.data = responseData;
    }
    return payload;
}
function lazyResolve(value, waitFor) {
            ...
            return tslib.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, adaptor_1.call(api, api, context)];
                                        case 1:
                                            api = (_a.sent()) || api;
                        ...
                        if (!adaptors.length) return [3 /*break*/, 2];
                        return [4 /*yield*/, adaptors.reduce(function (api, fn) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                var ret;
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (api.mockResponse) {
                            ...
                            return [2 /*return*/, wrapAdaptor(lazyResolve(api.mockResponse, (_b = (_a = api.mockResponse) === null || _a === void 0 ? void 0 : _a.delay) !== null && _b !== void 0 ? _b : 100), api, data)];
                        }
                        ...
                        if (((_c = api.method) === null || _c === void 0 ? void 0 : _c.toLocaleLowerCase()) === 'jsonp') {
                            return [2 /*return*/, wrapAdaptor(jsonpFetcher(api), api, data)];
                        }
                        if (((_d = api.method) === null || _d === void 0 ? void 0 : _d.toLocaleLowerCase()) === 'js') {
                        ...
                        if (isIE && api && ((_e = api.method) === null || _e === void 0 ? void 0 : _e.toLocaleLowerCase()) === 'get') {
...
function wrapAdaptor(promise, api, context) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var adaptors, adaptor_2, response;
        var _this = this;
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adaptors = responseAdaptors.concat();
                    if (api.adaptor) {
                        adaptor_2 = api.adaptor;
                        adaptors.push(function (payload, response, api, context) { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var result;
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        debug.debug('api', 'before adaptor data', response.data);
                                        result = adaptor_2(response.data, response, api, context);
                    ...
                    return [4 /*yield*/, adaptors.reduce(function (promise, adaptor) { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var response, result;
                            var _a;
                            return tslib.__generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        response = _b.sent();
                                        result = (_a = adaptor(response.data, response, api, context)) !== null && _a !== void 0 ? _a : response.data;
                                        if (!(result === null || result === void 0 ? void 0 : result.then)) return [3 /*break*/, 3];
                                        return [4 /*yield*/, result];
                                    case 2:
                                        result = _b.sent();
                                        _b.label = 3;
                                    case 3: return [2 /*return*/, tslib.__assign(tslib.__assign({}, response), { data: result })];
                                }
                            });
                        }); }, promise)];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, responseAdaptor(response, api)];
            }
        });
    });
}
