...
function verifyBirthday(birthday) {
    var min = moment__default["default"](new Date('1850-01-01')); // 还有1850年前的人活着吗？
    var max = moment__default["default"]().endOf('day'); // 最大值是今天
    return !isNaN(+birthday) && moment__default["default"](birthday).isBetween(min, max);
}
/**
 * 校验码计算方式
