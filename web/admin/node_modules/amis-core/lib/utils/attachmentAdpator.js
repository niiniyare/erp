...
function attachmentAdpator(response, __, api) {
    ...
    if (response && response.headers && response.headers['content-disposition']) {
        ...
        if (disposition && disposition.indexOf('attachment') !== -1) {
            ...
            return tslib.__assign(tslib.__assign({}, response), { data: {
                    status: 0,
        ...
        return new Promise(function (resolve, reject) {
            ...
            reader.addEventListener('loadend', function (e) {
                ...
                try {
                    resolve(tslib.__assign(tslib.__assign({}, response), { data: tslib.__assign({}, JSON.parse(text)) }));
                }
                catch (e) {
                    reject(e);
                }
...
exports.attachmentAdpator = attachmentAdpator;
