...
var validations = {
    ...
    isDateTimeSame: function (values, value, targetDate, granularity) {
        return moment__default["default"](value).isSame(moment__default["default"](targetDate), granularity);
    },
    isDateTimeBefore: function (values, value, targetDate, granularity) {
        return moment__default["default"](value).isBefore(moment__default["default"](targetDate), granularity);
    },
    isDateTimeAfter: function (values, value, targetDate, granularity) {
        return moment__default["default"](value).isAfter(moment__default["default"](targetDate), granularity);
    },
    isDateTimeSameOrBefore: function (values, value, targetDate, granularity) {
        return moment__default["default"](value).isSameOrBefore(moment__default["default"](targetDate), granularity);
    },
    isDateTimeSameOrAfter: function (values, value, targetDate, granularity) {
        return moment__default["default"](value).isSameOrAfter(moment__default["default"](targetDate), granularity);
    },
    isDateTimeBetween: function (values, value, lhs, rhs, granularity, inclusivity) {
        return moment__default["default"](value).isBetween(moment__default["default"](lhs), moment__default["default"](rhs), granularity, inclusivity);
    },
    /** ============================ 时间相关 ============================= */
    isTimeSame: function (values, value, targetTime, granularity, format) {
        ...
        return moment__default["default"](value, format).isSame(moment__default["default"](targetTime, format), granularity);
    },
    isTimeBefore: function (values, value, targetTime, granularity, format) {
        format = format !== null && format !== void 0 ? format : 'hh:mm:ss';
        return moment__default["default"](value, format).isBefore(moment__default["default"](targetTime, format), granularity);
    },
    isTimeAfter: function (values, value, targetTime, granularity, format) {
        format = format !== null && format !== void 0 ? format : 'hh:mm:ss';
        return moment__default["default"](value, format).isAfter(moment__default["default"](targetTime, format), granularity);
    },
    isTimeSameOrBefore: function (values, value, targetTime, granularity, format) {
        format = format !== null && format !== void 0 ? format : 'hh:mm:ss';
        return moment__default["default"](value, format).isSameOrBefore(moment__default["default"](targetTime, format), granularity);
    },
    isTimeSameOrAfter: function (values, value, targetTime, granularity, format) {
        format = format !== null && format !== void 0 ? format : 'hh:mm:ss';
        return moment__default["default"](value, format).isSameOrAfter(moment__default["default"](targetTime, format), granularity);
    },
    isTimeBetween: function (values, value, lhs, rhs, granularity, inclusivity, format) {
        format = format !== null && format !== void 0 ? format : 'hh:mm:ss';
        return moment__default["default"](value, format).isBetween(moment__default["default"](lhs, format), moment__default["default"](rhs, format), granularity, inclusivity);
    },
    isVariableName: function (values, value, regexp) {
        return validations.matchRegexp(values, value, regexp instanceof RegExp ? regexp : /^[a-zA-Z_]+[a-zA-Z0-9_]*$/);
    }
};
