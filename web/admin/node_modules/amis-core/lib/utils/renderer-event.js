    ...
    if (listeners) {
        var _loop_2 = function (key) {
            ...
            bc.onmessage = function (e) {
                ...
                Action.runActions(actions, renderer, rendererEvent);
            };
        };
        try {
            for (var _b = tslib.__values(Object.keys(listeners)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
        ...
        return tslib.__generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    debug.debug('event', "dispatch `".concat(eventName, "` from \u300C").concat((renderer === null || renderer === void 0 ? void 0 : renderer.props.type) || 'unknown').concat(from ? "#".concat(from) : '', "\u300D"), data);
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    index.split(',').forEach(function (i) {
                        ...
                        if (i) {
                            ...
                            var row = helper.getTree(tree, indexes);
                            row && targets.push(row);
                        }
                    });
                    return [3 /*break*/, 9];
                case 5:
                    ...
                    promies_1 = [];
                    helper.eachTree(tree, function (item) {
                        var data = item.storeType ? item.data : item;
                        promies_1.push(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var result;
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 7:
                    ...
                    promies_2 = [];
                    helper.eachTree(tree, function (item, rowIndex) {
                        var record = item.storeType ? item.data : item;
                        promies_2.push(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var result;
                            return tslib.__generator(this, function (_a) {
                                result = tpl.evalExpression(oldCondition, object.createObject(ctx, {
                                    record: record,
                                    rowIndex: rowIndex,
                                    item: record,
                                    index: rowIndex,
...
exports.bindGlobalEventForRenderer = bindGlobalEventForRenderer;
exports.createRendererEvent = createRendererEvent;
exports.dispatchEvent = dispatchEvent;
exports.dispatchGlobalEvent = dispatchGlobalEvent;
exports.dispatchGlobalEventForRenderer = dispatchGlobalEventForRenderer;
