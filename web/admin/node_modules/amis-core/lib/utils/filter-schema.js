...
function filterClassNameObject(classValue, ctx) {
    ...
    if (classValue && typeof classValue === 'string') {
        result = tokenize.tokenize(classValue, ctx);
    }
    else if (classValue && isPlainObject__default["default"](classValue)) {
        result = helper.mapObject(classValue, function (value) {
            return typeof value === 'string' ? tpl.evalExpression(value, ctx) : value;
        }, undefined, function (key) { return tokenize.tokenize(key, ctx); });
    }
    return result;
}
/**
...
function getExprProperties(schema, data, ignoreList, props) {
    ...
    Object.getOwnPropertyNames(schema).forEach(function (key) {
        ...
        if (value &&
            ...
            value &&
            (typeof value === 'string' || isPlainObject__default["default"](value))) {
...
exports.filterClassNameObject = filterClassNameObject;
exports.getExprProperties = getExprProperties;
exports.hasExprPropertiesChanged = hasExprPropertiesChanged;
