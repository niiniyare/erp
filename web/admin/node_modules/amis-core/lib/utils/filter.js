...
function conditionalFilter(input, hasAlternate, filterContext, test, trueValue, falseValue, astOffset) {
    var _a, _b, _c;
    if (astOffset === void 0) { astOffset = 1; }
    (hasAlternate || test) && skipRestTest(filterContext.restFilters);
    var result = test ? trueValue : falseValue;
    var ast = test
        ? (_a = filterContext.filter) === null || _a === void 0 ? void 0 : _a.args[0 + astOffset]
        : (_b = filterContext.filter) === null || _b === void 0 ? void 0 : _b.args[1 + astOffset];
...
amisFormula.extendsFilters({
    map: function (input, fn) {
        ...
        return Array.isArray(input) && amisFormula.filters[fn]
            ? input.map(function (item) {
                var _a;
                return (_a = amisFormula.filters[fn]).call.apply(_a, tslib.__spreadArray([_this, item], tslib.__read(arg), false));
            })
            : input;
    },
    html: function (input) {
    ...
    dateModify: function (input, modifier, amount, unit) {
        ...
        if (!(input instanceof Date)) {
            ...
            input = moment__default["default"](input).isValid()
                ? moment__default["default"](input).toDate()
                : moment__default["default"]().toDate();
        }
    ...
    bytes: function (input, step) {
        ...
        return input ? prettyBytes.prettyBytes(input, (_a = parseInt(step, 10)) !== null && _a !== void 0 ? _a : 1000) : input;
    },
    ...
    url_decode: function (input) {
        ...
        try {
            ...
            console.warn("[amis] ".concat((_a = e === null || e === void 0 ? void 0 : e.name) !== null && _a !== void 0 ? _a : 'URIError', ": input string is not valid."));
        }
        return result;
    },
    ...
    concat: function (input) {
        ...
        return Array.isArray(input)
            ? input.concat.apply(input, tslib.__spreadArray([], tslib.__read(args.map(function (arg, index) { var _a; return getStrOrVariable(arg, _this.data, (_a = _this.filter) === null || _a === void 0 ? void 0 : _a.args[index]); })), false)) : input;
    },
