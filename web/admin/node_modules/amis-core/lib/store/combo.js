...
var ComboStore = iRenderer.iRendererStore
        ...
        get addable() {
            ...
            if (self.uniques.size) {
                ...
                self.uniques.forEach(function (item) {
                    ...
                    var total = helper.countTree(item.items[0].options, function (item) { return typeof item.value !== 'undefined'; });
    ...
    function setMemberValid(valid, index) {
        var _a;
        self.memberValidMap = tslib.__assign(tslib.__assign({}, self.memberValidMap), (_a = {}, _a[index] = valid, _a));
    }
    return {
        config: config,
