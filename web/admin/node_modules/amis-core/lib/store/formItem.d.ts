...
export declare const FormItemStore: import("mobx-state-tree").IModelType<{
    ...
    loadOptionsFromDataScope: (source: string, ctx: Record<string, any>, onChange?: ((value: any, submitOnChange?: boolean, changeImmediately?: boolean) => void) | undefined, clearValue?: boolean) => any[];
