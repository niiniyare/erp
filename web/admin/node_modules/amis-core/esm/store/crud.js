...
import { __extends, __assign, __generator, __rest, __values, __awaiter } from 'tslib';
...
var CRUDStore = ServiceStore.named('CRUDStore')
    ...
    function updateQuery(values, updater, pageField, perPageField, replace) {
        ...
        var query = replace
            ? __assign({}, values) : __assign(__assign({}, originQuery), values);
        /**
         * 非严格模式下也需要严格比较的CASE
            ...
            switch (_r.label) {
                case 0:
                    ...
                    if (!options.forceReload && options.loadDataOnce && (rawItems === null || rawItems === void 0 ? void 0 : rawItems.length)) {
                        ...
                        data_1 = __assign(__assign({}, self.data), (_c = { count: items.length }, _c[options.totalField || 'total'] = items.length, _c.items = items.slice((self.page - 1) * self.perPage, self.page * self.perPage), _c));
                        self.total =
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        env = getEnv(self);
                        ctx = createObject(self.data, __assign(__assign(__assign({}, self.query), options.data), (_a = {}, _a[pageField] = self.page || 1, _a[perPageField] = self.perPage || 10, _a)));
