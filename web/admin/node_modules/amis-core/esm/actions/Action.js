    ...
    return __generator(this, function (_y) {
        switch (_y.label) {
            case 0:
                ...
                mergeData = injectObjectChain(event.data, additional);
...
var registerActionMappingIgnoreKey = function (actionType, ignoreKey, replace) {
    ...
    ActionIgnoreKey[actionType] = __spreadArray(__spreadArray([], __read((ActionIgnoreKey[actionType] || [])), false), __read(ignoreKey), false);
};
// 注册多个动作参数映射忽略键
...
var registerComponentActionMappingIgnoreKey = function (cmptType, ignoreKey, replace) {
    ...
    CmptIgnoreMap[cmptType] = __spreadArray(__spreadArray([], __read((CmptIgnoreMap[cmptType] || [])), false), __read(ignoreKey), false);
};
// 注册多个组件动作参数映射忽略键
...
export { LoopStatus, getActionByType, getTargetComponent, registerAction, registerActionMappingIgnoreKey, registerActionMappingIgnoreMap, registerComponentActionMappingIgnoreKey, registerComponentActionMappingIgnoreMap, runAction, runActions };
