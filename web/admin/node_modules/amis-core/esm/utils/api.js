            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, adaptors.reduce(function (api, fn) { return __awaiter(_this, void 0, void 0, function () {
                                var ret;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (api.adaptor) {
                        ...
                        adaptors.push(function (payload, response, api, context) { return __awaiter(_this, void 0, void 0, function () {
                            var result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                    ...
                    return [4 /*yield*/, adaptors.reduce(function (promise, adaptor) { return __awaiter(_this, void 0, void 0, function () {
                            var response, result;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        result = _b.sent();
                                        _b.label = 3;
                                    case 3: return [2 /*return*/, __assign(__assign({}, response), { data: result })];
                                }
                            });
                        }); }, promise)];
                case 1:
