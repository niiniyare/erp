...
var VisitedCache = /** @class */ (function () {
    ...
    VisitedCache.prototype.updateCacheEntryOrder = function (key, entry, nextVisitCount) {
        ...
        this.keyOrderMatrixForByCount[nextVisitCount] = Array.isArray(this.keyOrderMatrixForByCount[nextVisitCount])
            ? __spreadArray(__spreadArray([], __read(this.keyOrderMatrixForByCount[nextVisitCount]), false), [key], false) : [key];
        entry.visitCount = nextVisitCount;
        // 重新按照访问量排序
        this.visitCountOrder = __spreadArray([], __read(new Set(__spreadArray(__spreadArray([], __read(this.visitCountOrder), false), [nextVisitCount], false))), false).sort(function (a, b) { return a - b; });
    };
    /**
     *
     * @param {K} key
...
export { VisitedCache as default };
