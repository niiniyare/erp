...
export declare function safeStringify(data: any): any;
/**
 * 一般调试日志
 * @param msg 简单消息
 * @param ext 扩展信息
 */
export declare function debug(cat: Category, msg: string, ext?: any): void;
/**
 * 警告日志
 * @param msg 简单消息
 * @param ext 扩展信息
 */
export declare function warning(cat: Category, msg: string, ext?: any): void;
