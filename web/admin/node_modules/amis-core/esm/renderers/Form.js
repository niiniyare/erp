...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.componentDidMount = function () {
        ...
        if (onValidate) {
            ...
            this.toDispose.push(this.addHook(function () { return __awaiter(_this, void 0, void 0, function () {
                var result;
        ...
        if (onValidChange) {
            this.toDispose.push(reaction(function () { return store.valid; }, function (valid) { return onValidChange(valid, _this.props); }));
        }
        if (rules.length) {
    ...
    Form.prototype.getNormalizedRules = function () {
        ...
        return rules
            .map(function (item) { return (__assign(__assign({}, item), (!item.message || typeof item.message !== 'string'
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, this.submit(function (values) { return __awaiter(_this, void 0, void 0, function () {
                                                        ...
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                ...
                                                                case 1:
                                                                    ...
                                                                    _a.label = 2;
                                                                case 2: return [2 /*return*/, injectObjectChain(store.data, {
                                                                        __payload: values,
                                                                        __response: response
                                                                    })];
                                                            }
        ...
        if (this.props.mode === 'row') {
            ...
            return (React.createElement("div", { className: cx('Form-row') }, children.map(function (control, key) {
                ...
                return ~['hidden', 'formula'].indexOf(control.type) ||
                    control.mode === 'inline' ? (_this.renderChild(control, key, otherProps)) : (React.createElement("div", { key: key, className: cx("Form-col", control.columnClassName), style: {
                        flex: colSize && !['1', 'auto'].includes(colSize)
                            ? "0 0 ".concat(colSize)
                            : '1'
                    } }, _this.renderChild(control, '', __assign(__assign({}, otherProps), { mode: 'row' }))));
            })));
        }
...
var FormRendererBase = /** @class */ (function (_super) {
    ...
    FormRendererBase.prototype.focus = function () {
        ...
        var focuableInput = find(inputs, function (input) { return input.focus; });
