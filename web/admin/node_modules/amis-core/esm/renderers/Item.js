...
import { __assign, __extends, __awaiter, __generator, __read, __rest, __decorate, __metadata, __spreadArray } from 'tslib';
...
var FormItemWrap = /** @class */ (function (_super) {
    ...
    FormItemWrap.prototype.handleDialogConfirm = function (_a) {
        var _b = __read(_a, 1), values = _b[0];
    ...
    return function (Control) {
        ...
        return wrapControl(config, hoistNonReactStatic((_a = /** @class */ (function (_super) {
                ...
                class_1.prototype.renderControl = function () {
                    ...
                    var _b = this.props, 
                    // 这里解构，不可轻易删除，避免被rest传到子组件
                    inputClassName = _b.inputClassName, model = _b.formItem, cx = _b.classnames, children = _b.children, type = _b.type, size = _b.size, defaultSize = _b.defaultSize, mobileUI = _b.mobileUI, rest = __rest(_b, ["inputClassName", "formItem", "classnames", "children", "type", "size", "defaultSize", "mobileUI"]);
            ...
            _a.propsList = __spreadArray([
                ...
                'readOnly',
                'strictMode'
            ], __read((Control.propsList || [])), false),
