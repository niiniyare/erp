...
function useValidationResolver(__, validate) {
    ...
    return React__default.useCallback(function (values, context, config) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    rules = {};
                    customValidator = {};
                    ruleKeys = Object.keys(validations);
                    try {
                        for (_a = __values(Object.keys(config.fields)), _b = _a.next(); !_b.done; _b = _a.next()) {
                            key = _b.value;
                    ...
                    errors = validateObject(values, rules, undefined, __);
                    _g.label = 1;
                case 1:
                    _g.trys.push([1, 6, 7, 8]);
                    _c = __values(Object.keys(customValidator)), _d = _c.next();
                    _g.label = 2;
                case 2:
...
export { useValidationResolver as default, useValidationResolver };
