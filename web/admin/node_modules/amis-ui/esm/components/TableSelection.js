            ...
            React__default.createElement("thead", null,
                React__default.createElement("tr", null,
                    multiple && Array.isArray(options) && options.length ? (React__default.createElement("th", { className: cx('Table-checkCell') },
                        React__default.createElement(Checkbox, { key: "checkbox", size: "sm", disabled: disabled, onChange: this.toggleAll, checked: partialChecked, partial: partialChecked && !allChecked, testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('check-all') }))) : null,
    ...
    TableSelection.prototype.renderTr = function (_a) {
        ...
        return (React__default.createElement("tr", { style: styles !== null && styles !== void 0 ? styles : {}, key: rowIndex, 
            ...
            multiple ? (React__default.createElement("td", { className: cx('Table-checkCell'), key: "checkbox", onClick: function (e) {
                ...
                React__default.createElement(Checkbox, { size: "sm", checked: checked, disabled: disabled, testIdBuilder: itemTIB }))) : null,
