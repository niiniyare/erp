...
var ItemActionsWrapper = /** @class */ (function (_super) {
    __extends(ItemActionsWrapper, _super);
    ...
    ItemActionsWrapper.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('Table-itemActions-wrap'), style: { top: top + 'px', height: height + 'px' } }, children));
    };
    return ItemActionsWrapper;
}(React__default.PureComponent));

export { ItemActionsWrapper as default };
