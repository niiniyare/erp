...
var TinymceEditor = /** @class */ (function (_super) {
    ...
    function TinymceEditor() {
        ...
        _this.elementRef = React__default.createRef();
        return _this;
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.config = __assign(__assign({ inline: false, skin: false, content_css: false, height: 400, language: !locale || locale === 'zh-CN' ? 'zh_CN' : 'en', branding: false, plugins: [
                                'advlist',
                                'autolink',
                                'autoresize',
                                'link',
                        ...
                        return [4 /*yield*/, (onLoaded === null || onLoaded === void 0 ? void 0 : onLoaded(tinymce))];
                    case 1:
                        _b.sent();
    ...
    TinymceEditor.prototype.render = function () {
        return React__default.createElement("textarea", { ref: this.elementRef });
    };
