...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.renderEllipsis = function (key) {
        ...
        var jumpContent = isPrevEllipsis ? (React__default.createElement(Icon, { icon: "arrow-double-left", className: "icon" })) : (React__default.createElement(Icon, { icon: "arrow-double-right", className: "icon" }));
    ...
    Pagination.prototype.render = function () {
        ...
        if ((mode !== 'simple' && mobileUI) || mode === 'simple') {
            basePager = mobileUI ? (
            // 移动端简洁模式不需要中间的数字
            mode === 'simple' ? null : (React__default.createElement("li", { className: cx('Pagination-simplego'), key: "simple-go" },
                ...
                "/",
                React__default.createElement("span", { className: cx('Pagination-simplego-right'), key: "go-right" }, lastPage)))) : (React__default.createElement("span", { className: "Pagination-simple-number" }, activePage));
            return (React__default.createElement("div", __assign({ className: cx('Pagination-wrap', "Pagination-wrap-size--".concat(size), 'Pagination-simple', { disabled: disabled }, className), style: style }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
                React__default.createElement("ul", { key: "pager-items", className: cx('Pagination', 'Pagination--sm', 'Pagination-pager-items', 'Pagination-item') },
                    React__default.createElement("li", { className: cx('Pagination-prev', {
                        ...
                        React__default.createElement("span", __assign({}, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild("go-prev").getTestId()), buttonType === 'icon' ? (React__default.createElement(Icon, { icon: "left-arrow", className: "icon" })) : buttonType === 'text' ? ('上一页') : null)),
                    basePager,
                    React__default.createElement("li", { className: cx('Pagination-next', {
                        ...
                        React__default.createElement("span", __assign({}, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild("go-next").getTestId()), buttonType === 'icon' ? (React__default.createElement(Icon, { icon: "right-arrow", className: "icon" })) : buttonType === 'text' ? ('下一页') : null)))));
        }
        var pageButtons = [];
        ...
        pageButtons.unshift(React__default.createElement("li", { className: cx('Pagination-prev', {
                'is-disabled': activePage < 2
            }), onClick: function (e) {
                if (activePage < 2) {
                    return e.preventDefault();
        ...
        var go = mobileUI ? null : (React__default.createElement("div", { className: cx('Pagination-inputGroup Pagination-item'), key: "go" },
            React__default.createElement("span", { className: cx('Pagination-inputGroup-left'), key: "go-left" }, __('Pagination.goto')),
        ...
        var perPageEle = mobileUI ? null : (React__default.createElement(EnhancedSelect, __assign({ key: "perpage", className: cx('Pagination-perpage', 'Pagination-item'), clearable: false, disabled: disabled, value: perPage, options: selection || [], popOverContainer: popOverContainer, popOverContainerSelector: popOverContainerSelector, onChange: function (p) {
                _this.setState({
                    perPage: p.value,
                    pageNum: ''
                });
        ...
        var totalPage = !(total || lastPage) || mobileUI ? null : (React__default.createElement("div", { className: cx('Pagination-total Pagination-item'), key: "total" }, total || total === 0
...
var Pagination$1 = themeable(localeable(Pagination));

export { Pagination, Pagination$1 as default };
