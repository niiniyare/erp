...
var Editor = /** @class */ (function (_super) {
    ...
    Editor.prototype.initMonaco = function (monaco) {
        ...
        this.editor = factory(containerElement, monaco, __assign(__assign({}, options), { readOnly: this.props.disabled, automaticLayout: true, value: value, language: language, editorTheme: editorTheme, theme: editorTheme }));
        // json 默认开启验证。
...
var MonacoEditor = themeable(localeable(Editor, ['getDom']), ['getDom']);

export { Editor, MonacoEditor as default, monacoFactory };
