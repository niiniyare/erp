...
import { getRange, autobind, localeable } from 'amis-core';
...
var QuarterView = /** @class */ (function (_super) {
    ...
    QuarterView.prototype.renderPicker = function () {
        ...
        var columns = [
            ...
            {
                options: getRange(1, 4).map(function (item) {
                    return {
                        text: 'Q' + item,
                        value: item
                    };
        ...
        return (React__default.createElement(Picker, { translate: this.props.translate, locale: this.props.locale, title: title, columns: columns, value: this.state.pickerValue, onChange: this.onPickerChange, onConfirm: this.onPickerConfirm, onClose: this.cancel }));
    };
    QuarterView.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, hideHeader = _a.hideHeader, mobileUI = _a.mobileUI;
        return mobileUI ? (this.renderPicker()) : (React__default.createElement("div", { className: cx('ClalendarQuarter') },
