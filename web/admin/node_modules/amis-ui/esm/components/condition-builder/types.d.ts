...
export type FieldTypes = 'text' | 'number' | 'boolean' | 'date' | 'time' | 'datetime' | 'select' | 'custom';
...
export type FieldSimple = TextField | NumberField | DateField | TimeField | DatetimeField | SelectField | BooleanField | CustomField;
