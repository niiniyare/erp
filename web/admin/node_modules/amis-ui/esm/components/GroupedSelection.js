...
var GroupedSelection = /** @class */ (function (_super) {
    ...
    GroupedSelection.prototype.renderPureOption = function (option, index, key, styles, testIdBuilder) {
        ...
        return (React__default.createElement("div", __assign({ key: index, style: styles, className: cx('GroupedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', !!~valueArray.indexOf(option) ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } }, itemTIB === null || itemTIB === void 0 ? void 0 : itemTIB.getTestId()),
            multiple ? (React__default.createElement(Checkbox, { size: "sm", checked: !!~valueArray.indexOf(option), disabled: disabled || option.disabled, labelClassName: labelClassName, description: option.description, testIdBuilder: itemTIB === null || itemTIB === void 0 ? void 0 : itemTIB.getChild('checkbox') })) : null,
            React__default.createElement("div", { className: cx('GroupedSelection-itemLabel') }, itemRender(option, {
                index: index,
                multiple: multiple,
