...
var SparkLine = /** @class */ (function (_super) {
    ...
    SparkLine.prototype.renderLines = function () {
        ...
        return (React__default.createElement("g", null,
            React__default.createElement("path", { className: cx("Sparkline-area"), d: areaD, stroke: "none" }),
    ...
    SparkLine.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('Sparkline', className, onClick ? 'Sparkline--clickable' : '', setThemeClassName(__assign(__assign({}, this.props), { name: 'baseControlClassName', id: id, themeCss: themeCss })), setThemeClassName(__assign(__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), style: style, onClick: onClick }, Array.isArray(value) && value.length > 1 ? (React__default.createElement("svg", { className: cx('Sparkline-svg'), width: width, height: height, viewBox: "0 0 ".concat(width, " ").concat(height) }, this.renderLines())) : (placeholder !== null && placeholder !== void 0 ? placeholder : __('placeholder.empty'))));
    };
...
var SparkLine$1 = themeable(localeable(SparkLine));

export { SparkLine, SparkLine$1 as default };
