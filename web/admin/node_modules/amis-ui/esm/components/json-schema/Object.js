...
function InputJSONSchemaObject(props, ref) {
    ...
    var _c = __read(React__default.useState([]), 2), members = _c[0], _setMembers = _c[1];
    ...
    var onMemberChange = function (member, memberValue) {
        ...
        arr.splice(idx, 1, __assign(__assign({}, arr[idx]), { value: memberValue }));
        setMembers(arr);
        emitChange();
    };
    var onMemberKeyChange = function (member, memberKey) {
        ...
        var arr = members.concat();
        var item = __assign(__assign({}, member), { schema: schema, name: memberKey, invalid: !memberKey || members.some(function (a, b) { return a.name === memberKey && b !== idx; })
                ? 'key'
                : undefined });
    ...
    React__default.useEffect(function () {
        ...
        var _loop_2 = function (key) {
            ...
            if (!exists && props.schema.additionalProperties !== false) {
                ...
                arr.splice(idx, 1, __assign(__assign({}, exists), { value: value === null || value === void 0 ? void 0 : value[key] }));
            }
        };
        try {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        React__default.createElement("div", { className: cx('JSONSchemaObject', className, {
                'is-mobile': mobileUI,
            ...
            collapsed ? (renderValue ? (React__default.createElement(InputJSONSchemaItem, __assign({}, props, { value: value, onChange: onChange, schema: {
                ...
                return (React__default.createElement("div", { key: member.key, className: cx('JSONSchemaMember') },
                    ...
                    React__default.createElement("div", { className: cx('JSONSchemaMember-value') },
                        React__default.createElement(InputJSONSchemaItem, __assign({}, props, { className: "", addButtonText: undefined, required: member.required, value: value === null || value === void 0 ? void 0 : value[member.name], onChange: onMemberChange.bind(null, member), schema: member.schema || {
                                type: 'string'
            ...
            allowAdd && !collapsed ? (React__default.createElement(Button, { level: "link", onClick: handleAdd, size: "xs", disabled: disabled }, addButtonText !== null && addButtonText !== void 0 ? addButtonText : __('JSONSchema.add_prop'))) : null)));
}
var InputJSONSchemaObject$1 = React__default.forwardRef(InputJSONSchemaObject);

export { InputJSONSchemaObject, InputJSONSchemaObject$1 as default };
