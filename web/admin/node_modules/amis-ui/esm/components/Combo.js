    ...
    function renderBody() {
        ...
        return (React__default.createElement("div", { className: cx("Combo Combo--multi", className, multiLine ? "Combo--ver" : "Combo--hor") },
            ...
            addable !== false && (!maxLength || fields.length < maxLength) ? (React__default.createElement("div", { className: cx("Combo-toolbar") },
                React__default.createElement(Button, { className: cx("Combo-addBtn", addButtonClassName), level: addButtonLevel !== null && addButtonLevel !== void 0 ? addButtonLevel : 'primary', onClick: function () { return append(__assign({}, scaffold)); }, size: (_a = addButtonSize) !== null && _a !== void 0 ? _a : 'sm' },
...
function ComboItem(_a) {
    ...
    if (Array.isArray(child)) {
        child = (React__default.createElement("div", { className: cx('Form-row') }, child.map(function (child, index) { return (React__default.createElement("div", { className: cx('Form-col', child === null || child === void 0 ? void 0 : child.props.columnClassName), key: child.key || index }, child)); })));
    }
