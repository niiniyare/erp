...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function () {
        ...
        if (typeof src === 'string' && hasImg) {
            ...
            childrenRender = React.createElement(Icon, { cx: cx, icon: icon });
        }
        else if (isIconRender) {
            childrenRender = icon;
        }
        else {
            childrenRender = (React.createElement("span", { className: cx(childPrefix), ref: this.avatarChildrenRef, style: scaleStyle }, typeof children === 'function' ? children() : children));
        }
        return (React.createElement("span", { className: cx("Avatar", className, prefix + shape, sizeClass), style: __assign(__assign({}, sizeStyle), style), onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, ref: this.avatarRef }, childrenRender));
    };
    Avatar.defaultProps = {
        shape: 'circle',
        size: 'default',
...
var Avatar$1 = themeable(Avatar);

export { Avatar, Avatar$1 as default };
