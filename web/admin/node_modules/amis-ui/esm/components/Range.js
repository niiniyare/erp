...
import { Overlay, autobind, camel, stripNumber, safeAdd, safeSub, themeable, uncontrollable } from 'amis-core';
    ...
    HandleItem.prototype.render = function () {
        ...
        return disabled ? (React__default.createElement("div", { className: cx('InputRange-handle'), style: style },
            React__default.createElement("div", { className: cx('InputRange-handle-icon') },
                React__default.createElement(Icon, { icon: "slider-handle", className: "icon" })))) : (React__default.createElement("div", { className: cx('InputRange-handle', {
                'is-mobile': mobileUI
            }), style: style, ref: this.handleRef },
            React__default.createElement("div", { className: cx(isDrag ? 'InputRange-handle-drage' : 'InputRange-handle-icon'), onMouseDown: this.onMouseDown, onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave, onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove, onTouchEnd: this.onTouchEnd },
...
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.getMarkMaxWidth = function (value, marks) {
        ...
        var curNum = isString(value) ? parseInt(value, 10) : value;
        // 给最大宽度赋初始值 默认最大
    ...
    Range.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('InputRange-wrap') },
            React__default.createElement("div", { ref: this.trackRef, className: cx('InputRange-track', 'InputRange-track--background'), onClick: this.onClickTrack },
                ...
                marks && (React__default.createElement("div", { className: cx('InputRange-marks') }, sortMaks.map(function (key) {
                    var _a, _b, _c;
                    var offsetLeft = _this.getOffsetLeft(key);
                    var markMaxWidth = _this.getMarkMaxWidth(key, marks);
                    if (MARKS_REG.test(offsetLeft)) {
                        return (React__default.createElement("div", { key: key, style: { left: offsetLeft, width: markMaxWidth } },
                            React__default.createElement(TooltipWrapper, { placement: 'bottom', tooltip: ((_a = marks[key]) === null || _a === void 0 ? void 0 : _a.label) || marks[key], trigger: ['hover', 'focus'], rootClose: false },
                                React__default.createElement("span", { style: (_b = marks[key]) === null || _b === void 0 ? void 0 : _b.style }, ((_c = marks[key]) === null || _c === void 0 ? void 0 : _c.label) || marks[key]))));
                    }
                    else {
                        return null;
                    }
