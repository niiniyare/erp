...
var TransferPicker = /** @class */ (function (_super) {
    ...
    TransferPicker.prototype.render = function () {
        ...
        return (React__default.createElement(PickerContainer, { title: __('Select.placeholder'), onFocus: this.onFocus, onClose: this.onBlur, mobileUI: mobileUI, popOverContainer: popOverContainer, bodyRender: function (_a) {
                _a.onClose; var value = _a.value; _a.onChange; var setState = _a.setState, states = __rest(_a, ["onClose", "value", "onChange", "setState"]);
                return (React__default.createElement(Transfer, __assign({ mobileUI: mobileUI }, rest, states, { value: value, labelField: labelField, onChange: function (value, optionModified) {
                        if (optionModified) {
            ...
            return (React__default.createElement(ResultBox, { className: cx('TransferPicker', className, isOpened ? 'is-active' : ''), allowInput: false, result: value, onItemClick: onItemClick, onResultChange: onChange, onResultClick: onClick, placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : __('Select.placeholder'), disabled: disabled, borderMode: borderMode, itemRender: function (option) { return (React__default.createElement("span", null, (option && option[labelField]) || 'undefined')); }, mobileUI: mobileUI, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover }, !mobileUI ? (React__default.createElement("span", { className: cx('TransferPicker-icon') },
...
var TransferPicker$1 = themeable(localeable(uncontrollable(TransferPicker, {
    value: 'onChange'
})));

export { TransferPicker, TransferPicker$1 as default };
