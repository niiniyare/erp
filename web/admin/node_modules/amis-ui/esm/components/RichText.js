...
export { default as FroalaEditor } from 'froala-editor';
...
var FroalaEditorComponent = /** @class */ (function (_super) {
    __extends(FroalaEditorComponent, _super);
    ...
    FroalaEditorComponent.prototype.render = function () {
        var _this = this;
        return (React__default.createElement("textarea", { ref: function (el) { return (_this.el = el); } }, this.props.children));
    };
...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        return (React__default.createElement(FroalaEditorComponent, { config: this.props.config, model: this.props.model, onModelChange: this.props.onModelChange }));
    };
    return default_1;
}(React__default.Component));
