...
var Collapse = /** @class */ (function (_super) {
    ...
    Collapse.prototype.render = function () {
        ...
        var dom = [
            React__default.createElement(HeadingComponent, { key: "header", onClick: this.toggleCollapsed, className: cx("Collapse-header", { 'is-mobile': mobileUI }, headingClassName, { noTitle: !finalHeader }) },
                showArrow && collapsable ? (expandIcon ? (React__default.cloneElement(expandIcon, __assign(__assign({}, expandIcon.props), { className: cx('Collapse-icon-tranform', (_b = expandIcon.props) === null || _b === void 0 ? void 0 : _b.className) }))) : (React__default.createElement("span", { className: cx('Collapse-arrow-wrap') },
                    React__default.createElement(Icon, { icon: "right-arrow-bold", className: cx('Collapse-arrow', 'icon'), classNameProp: cx('Collapse-arrow'), iconContent: "Collapse-arrow" })))) : (''),
                finalHeader),
