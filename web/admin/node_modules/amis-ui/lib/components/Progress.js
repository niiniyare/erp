...
var Progress = /** @class */ (function (_super) {
    tslib.__extends(Progress, _super);
    function Progress() {
    ...
    Progress.prototype.getLabel = function (prefixCls) {
        ...
        return (_J$X_("span", { className: cx("".concat(prefixCls, "-text")), key: "value" }, content));
    };
    Progress.prototype.render = function () {
        ...
        if (typeof value !== 'number') {
            viewValue = _J$X_("span", { className: "text-muted" }, placeholder);
        }
        else if (type === 'line') {
            var barStyle = {
                width: "".concat(value, "%")
            ...
            if (threshold) {
                var temp_1 = function (text, color) { return (_J$X_("div", { style: {
                        left: text,
                        borderColor: color || 'var(--text-color)'
                    }, className: cx("".concat(prefixCls, "-threshold")), key: text }, showThresholdText ? (_J$X_("span", { className: cx("".concat(prefixCls, "-threshold-text")) }, text)) : null)); };
            ...
            viewValue = [
                _J$X_("div", { key: "progress", className: cx(prefixCls, progressClassName) },
                    thresholdDom,
                    _J$X_("div", { className: cx("".concat(prefixCls, "-inter")) },
                        _J$X_("div", { className: cx("".concat(prefixCls, "-bar"), (_a = {}, _a[bgColor] = isColorClass, _a), (_b = {}, _b["".concat(prefixCls, "-bar--stripe")] = stripe, _b), (_c = {}, _c["".concat(prefixCls, "-bar--animate")] = animate && !stripe, _c), (_d = {}, _d["".concat(prefixCls, "-bar--stripe-animate")] = animate && stripe, _d)), title: "".concat(value, "%"), style: barStyle }))),
            ...
            viewValue = [
                _J$X_("div", { className: cx(prefixCls, progressClassName), key: "circle", style: circleStyle },
                    _J$X_(rcProgress.Circle, { percent: value, strokeColor: !isColorClass ? bgColor : '', strokeWidth: circleWidth, trailWidth: circleWidth, prefixCls: isColorClass ? bgColor : '', gapDegree: getGapDegree(), gapPosition: gapPos, style: circleStyle }),
                    this.getLabel(prefixCls))
            ];
        }
        return (_J$X_("div", { className: cx('Progress', className), style: style }, viewValue));
    };
...
var Progress$1 = amisCore.themeable(Progress);

exports.Progress = Progress;
exports["default"] = Progress$1;
