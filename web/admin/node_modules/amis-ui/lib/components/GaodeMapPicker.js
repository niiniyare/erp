...
var BaiduMapPicker = /** @class */ (function (_super) {
    ...
    function BaiduMapPicker() {
        ...
        _this.resultListRef = React__default["default"].createRef();
    ...
    BaiduMapPicker.prototype.componentDidMount = function () {
        if (window.AMap) {
            ...
            amisCore.loadStyle('https://cache.amap.com/lbs/static/main1119.css');
            amisCore.loadScript("//webapi.amap.com/maps?v=2.0&key=".concat(this.props.ak)).then(this.initMap);
        }
    };
    ...
    BaiduMapPicker.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('MapPicker') },
            _J$X_("div", { className: cx('MapPicker-search TextControl-control') },
                _J$X_("div", { className: cx('TextControl-input') },
                    _J$X_("input", { onChange: this.handleChange, value: inputValue, placeholder: "\u641C\u7D22\u5730\u70B9" }))),
            _J$X_("div", { ref: this.mapRef, className: cx('MapPicker-map', {
                    invisible: false
                }) }),
            _J$X_("div", { ref: this.resultListRef, className: cx('MapPicker-result', {
                    invisible: false
                }) })));
    };
    tslib.__decorate([
...
var GaodeMapPicker = amisCore.themeable(BaiduMapPicker);

exports.BaiduMapPicker = BaiduMapPicker;
exports["default"] = GaodeMapPicker;
