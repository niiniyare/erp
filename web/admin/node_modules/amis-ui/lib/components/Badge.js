...
var Badge = /** @class */ (function (_super) {
    ...
    Badge.prototype.renderBadge = function (text, size, position, offsetStyle, sizeStyle, animationElement) {
        ...
        var customStyle = amisCore.buildStyle(style, data);
        if (typeof level === 'string' && level[0] === '$') {
            level = amisCore.resolveVariableAndFilter(level, data);
        }
        switch (mode) {
            case 'dot':
                return (_J$X_("span", { className: cx('Badge-dot', "Badge--".concat(position), "Badge--".concat(level)), style: tslib.__assign(tslib.__assign(tslib.__assign({}, offsetStyle), sizeStyle), customStyle) }, animationElement));
            case 'text':
                return (_J$X_("span", { className: cx('Badge-text', "Badge--".concat(position), "Badge--".concat(level)), style: tslib.__assign(tslib.__assign(tslib.__assign({}, offsetStyle), sizeStyle), customStyle) },
                    text,
                    animationElement));
            case 'ribbon':
                var outSize = size * Math.sqrt(2) + 5;
                return (_J$X_("div", { className: cx('Badge-ribbon-out', "Badge-ribbon-out--".concat(position)), style: { width: outSize, height: outSize } },
                    _J$X_("span", { className: cx('Badge-ribbon', "Badge-ribbon--".concat(position), "Badge--".concat(level)), style: tslib.__assign(tslib.__assign({}, sizeStyle), customStyle) },
                        text,
                        animationElement)));
            default:
                return null;
    ...
    Badge.prototype.render = function () {
        ...
        if (typeof badge === 'string') {
            isDisplay = amisCore.evalExpression(badge, data) === true;
        }
        ...
        if (visibleOn) {
            isDisplay = amisCore.evalExpression(visibleOn, data) === true;
        }
        ...
        var animationElement = animation ? (_J$X_("div", { style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        return (_J$X_("div", { className: cx('Badge', className) },
            children,
            isDisplay
...
function withBadge(Component) {
    var _a;
    return hoistNonReactStatic__default["default"]((_a = /** @class */ (function (_super) {
            tslib.__extends(WithBadge, _super);
            function WithBadge() {
            ...
            WithBadge.prototype.render = function () {
                ...
                return (_J$X_(Badge, tslib.__assign({}, this.props),
