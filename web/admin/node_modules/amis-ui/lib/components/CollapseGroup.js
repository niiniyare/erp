    ...
    function CollapseGroup(props) {
        ...
        _this.getItems = function (children) {
            ...
            return children.map(function (child, index) {
                ...
                return React__default["default"].cloneElement(child, tslib.__assign(tslib.__assign({}, props), { key: collapseId, collapseId: collapseId, collapsed: collapsed, expandIcon: _this.props.expandIcon, propsUpdate: true, onCollapse: function (collapsed) {
