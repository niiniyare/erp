...
var Drawer = /** @class */ (function (_super) {
    ...
    function Drawer() {
        ...
        _this.resizer = React__default["default"].createRef();
        _this.resizeCoord = 0;
        ...
        _this.modalRef = function (ref) {
            ...
            if (ref) {
                ...
                ref.classList.add("".concat(_this.props.classPrefix, "Modal--").concat(ModalManager.current(), "th"));
            }
            else {
    ...
    Drawer.prototype.renderResizeCtrl = function () {
        ...
        return (_J$X_("div", { className: cx('Drawer-resizeCtrl'), ref: this.resizer, onMouseDown: this.resizeMouseDown },
            _J$X_("div", { className: cx('Drawer-resizeIcon') }, "\u00B7\u00B7\u00B7")));
    };
    Drawer.prototype.render = function () {
        ...
        return (_J$X_(Portal__default["default"], { container: Modal.getContainerWithFullscreen(container) },
            _J$X_(Transition__default["default"], { mountOnEnter: true, unmountOnExit: true, appear: true, in: show, timeout: 500, onEnter: this.handleEnter, onExited: this.handleExited, onEntered: this.handleEntered }, function (status) {
                var _a;
                ...
                return (_J$X_("div", { ref: _this.modalRef, role: "dialog", className: cx__default["default"]("amis-dialog-widget ".concat(ns, "Drawer"), (_a = {},
                        _a["".concat(ns, "Drawer--").concat(position)] = position,
                        _a["".concat(ns, "Drawer--").concat(size)] = size,
                        _a["".concat(ns, "Drawer--noOverlay")] = !overlay,
                        _a), className) },
                    overlay ? (_J$X_("div", { className: cx__default["default"]("".concat(ns, "Drawer-overlay"), fadeStyles[status], drawerMaskClassName) })) : null,
                    _J$X_("div", { ref: _this.contentRef, style: bodyStyle, className: cx__default["default"]("".concat(ns, "Drawer-content"), bodyClassName, fadeStyles[status], drawerClassName) },
                        show && showCloseButton ? (_J$X_("a", { onClick: disabled ? undefined : onHide, className: "".concat(ns, "Drawer-close") },
                            _J$X_(icons.Icon, { icon: "close", className: "icon", iconContent: "Drawer-close" }))) : null,
                        status === Transition.EXITED ? null : children,
...
var Drawer$1 = amisCore.themeable(Drawer);
