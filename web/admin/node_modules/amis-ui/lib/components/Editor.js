...
function monacoFactory(containerElement, monaco, options) {
    return monaco.editor.create(containerElement, tslib.__assign({ 'autoIndent': true, 'formatOnType': true, 'formatOnPaste': true, 'selectOnLineNumbers': true, 'scrollBeyondLastLine': false, 'folding': true, 'minimap': {
            enabled: false
        }, 'scrollbar': {
...
var Editor = /** @class */ (function (_super) {
    ...
    Editor.prototype.loadMonaco = function () {
        ...
        window.__amis_monaco_editor_locale = this.props.locale;
        Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['monaco-editor', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})}).then(function (monaco) { return _this.initMonaco(monaco); });
    };
    ...
    Editor.prototype.render = function () {
        ...
        var style = tslib.__assign({}, (this.props.style || {}));
        style.width = width;
        style.height = height;
        return (_J$X_("div", { className: cx("MonacoEditor", { 'is-fullscreen': this.state.isFullscreen }, className), style: style, ref: this.wrapperRef },
            this.editor && placeholder && !value ? (_J$X_("span", { className: cx('MonacoEditor-placeholder') }, placeholder)) : null,
            this.editor && this.props.allowFullscreen ? (_J$X_("div", { className: cx("MonacoEditor-header") },
                _J$X_("a", { className: cx('Modal-close', "MonacoEditor-fullscreen"), "data-tooltip": this.state.isFullscreen
                        ? __('Editor.exitFullscreen')
                        : __('Editor.fullscreen'), "data-position": "left", onClick: this.handleFullscreenModeChange },
                    _J$X_(icons.Icon, { icon: this.state.isFullscreen ? 'compress-alt' : 'expand-alt', className: "icon" })))) : null));
    };
    Editor.defaultProps = {
        language: 'javascript',
        editorTheme: 'vs',
