...
var SizeAndPositionManager = /** @class */ (function () {
    ...
    SizeAndPositionManager.prototype.getUpdatedOffsetForIndex = function (_a) {
        var _b = _a.align, align = _b === void 0 ? constants.ALIGNMENT.START : _b, containerSize = _a.containerSize, currentOffset = _a.currentOffset, targetIndex = _a.targetIndex;
        if (containerSize <= 0) {
            return 0;
        }
        ...
        var idealOffset;
        switch (align) {
            case constants.ALIGNMENT.END:
                idealOffset = minOffset;
                break;
            case constants.ALIGNMENT.CENTER:
                idealOffset = maxOffset - (containerSize - datum.size) / 2;
                break;
            case constants.ALIGNMENT.START:
