...
var SizeAndPositionManager = require('./SizeAndPositionManager.js');
var constants = require('./constants.js');
var AutoSizer = require('./AutoSizer.js');
...
var STYLE_STICKY_ITEM = tslib.__assign(tslib.__assign({}, STYLE_ITEM), { position: 'sticky' });
var VirtualList = /** @class */ (function (_super) {
    tslib.__extends(VirtualList, _super);
    function VirtualList() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.itemSizeGetter = function (itemSize) {
            return function (index) { return _this.getSize(index, itemSize); };
        };
        _this.sizeAndPositionManager = new SizeAndPositionManager["default"]({
        ...
        _this.state = {
            offset: _this.props.scrollOffset ||
                ...
                0,
            scrollChangeReason: constants.SCROLL_CHANGE_REASON.REQUESTED
        };
        _this.styleCache = {};
        ...
        _this.handleScroll = function (event) {
            ...
            _this.setState({
                offset: offset,
                scrollChangeReason: constants.SCROLL_CHANGE_REASON.OBSERVED
            });
    ...
    VirtualList.prototype.scrollTo = function (value) {
        var _a = this.props.scrollDirection, scrollDirection = _a === void 0 ? constants.DIRECTION.VERTICAL : _a;
        this.rootNode[constants.scrollProp[scrollDirection]] = value;
    };
    VirtualList.prototype.getOffsetForIndex = function (index, scrollToAlignment, itemCount) {
        ...
        return this.sizeAndPositionManager.getUpdatedOffsetForIndex({
            ...
            containerSize: this.props[constants.sizeProp[scrollDirection]],
    ...
    VirtualList.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this.props; _b.estimatedItemSize; var height = _b.height, _c = _b.overscanCount, overscanCount = _c === void 0 ? 3 : _c, renderItem = _b.renderItem; _b.itemCount; _b.itemSize; var onItemsRendered = _b.onItemsRendered; _b.onScroll; var _d = _b.scrollDirection, scrollDirection = _d === void 0 ? constants.DIRECTION.VERTICAL : _d; _b.scrollOffset; _b.scrollToIndex; _b.scrollToAlignment; var stickyIndices = _b.stickyIndices, style = _b.style, width = _b.width, WrapperComponent = _b.WrapperComponent, InnerComponent = _b.InnerComponent, prefix = _b.prefix, innerStyleFilter = _b.innerStyleFilter, props = tslib.__rest(_b, ["estimatedItemSize", "height", "overscanCount", "renderItem", "itemCount", "itemSize", "onItemsRendered", "onScroll", "scrollDirection", "scrollOffset", "scrollToIndex", "scrollToAlignment", "stickyIndices", "style", "width", "WrapperComponent", "InnerComponent", "prefix", "innerStyleFilter"]);
        var offset = this.state.offset;
        var _e = this.sizeAndPositionManager.getVisibleRange({
            containerSize: this.props[constants.sizeProp[scrollDirection]] || 0,
            offset: offset,
            overscanCount: overscanCount
        }), start = _e.start, stop = _e.stop;
        var items = [];
        var wrapperStyle = tslib.__assign(tslib.__assign(tslib.__assign({}, STYLE_WRAPPER), style), { height: height, width: width });
        var innerStyle = tslib.__assign(tslib.__assign({}, STYLE_INNER), (_a = {}, _a[constants.sizeProp[scrollDirection]] = this.sizeAndPositionManager.getTotalSize(), _a));
        if (stickyIndices != null && stickyIndices.length !== 0) {
            ...
            if (scrollDirection === constants.DIRECTION.HORIZONTAL) {
        ...
        return (_J$X_(WrapperCmpt, tslib.__assign({ ref: this.getRef }, props, { style: wrapperStyle }), prefix !== null && prefix !== void 0 ? prefix : null,
            _J$X_(InnerCmpt, { style: innerStyleFilter ? innerStyleFilter(innerStyle) : innerStyle }, items)));
    };
    VirtualList.prototype.getNodeOffset = function () {
        var _a = this.props.scrollDirection, scrollDirection = _a === void 0 ? constants.DIRECTION.VERTICAL : _a;
        return this.rootNode[constants.scrollProp[scrollDirection]];
    };
    ...
    VirtualList.prototype.getStyle = function (index, sticky) {
        ...
        var _c = this.props.scrollDirection, scrollDirection = _c === void 0 ? constants.DIRECTION.VERTICAL : _c;
        ...
        return (this.styleCache[index] = sticky
            ? tslib.__assign(tslib.__assign({}, STYLE_STICKY_ITEM), (_a = {}, _a[constants.sizeProp[scrollDirection]] = size, _a[constants.marginProp[scrollDirection]] = offset, _a[constants.oppositeMarginProp[scrollDirection]] = -(offset + size), _a.zIndex = 1, _a)) : tslib.__assign(tslib.__assign({}, STYLE_ITEM), (_b = {}, _b[constants.sizeProp[scrollDirection]] = size, _b[constants.positionProp[scrollDirection]] = offset, _b)));
    };
    VirtualList.defaultProps = {
        overscanCount: 3,
        scrollDirection: constants.DIRECTION.VERTICAL,
        width: '100%'
    };
    VirtualList.propTypes = {
        estimatedItemSize: PropTypes__namespace.number,
        height: PropTypes__namespace.oneOfType([PropTypes__namespace.number, PropTypes__namespace.string])
            .isRequired,
        itemCount: PropTypes__namespace.number.isRequired,
        itemSize: PropTypes__namespace.oneOfType([
            PropTypes__namespace.number,
            PropTypes__namespace.array,
            PropTypes__namespace.func
        ]).isRequired,
        onScroll: PropTypes__namespace.func,
        onItemsRendered: PropTypes__namespace.func,
        overscanCount: PropTypes__namespace.number,
        renderItem: PropTypes__namespace.func.isRequired,
        scrollOffset: PropTypes__namespace.number,
        scrollToIndex: PropTypes__namespace.number,
        scrollToAlignment: PropTypes__namespace.oneOf([
            constants.ALIGNMENT.AUTO,
            constants.ALIGNMENT.START,
            constants.ALIGNMENT.CENTER,
            constants.ALIGNMENT.END
        ]),
        scrollDirection: PropTypes__namespace.oneOf([
            constants.DIRECTION.HORIZONTAL,
            constants.DIRECTION.VERTICAL
        ]),
        stickyIndices: PropTypes__namespace.arrayOf(PropTypes__namespace.number),
        style: PropTypes__namespace.object,
        width: PropTypes__namespace.oneOfType([PropTypes__namespace.number, PropTypes__namespace.string])
    };
    return VirtualList;
...
Object.defineProperty(exports, 'ScrollDirection', {
    enumerable: true,
    get: function () { return constants.DIRECTION; }
});
