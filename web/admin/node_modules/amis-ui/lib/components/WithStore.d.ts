...
export declare function withStore<K extends IAnyStateTreeNode>(storeFactory: (props: any) => K): <T extends React.ComponentType<React.ComponentProps<T> & {
    ...
    new (props: JSX.LibraryManagedAttributes<T, Omit<React.ComponentProps<T>, "store">>): {
        ref: any;
        store?: K | undefined;
        refFn: (ref: any) => void;
        ...
        readonly props: Readonly<JSX.LibraryManagedAttributes<T, Omit<React.ComponentProps<T>, "store">>>;
        state: Readonly<{}>;
        refs: {
