...
var GridNavItem = function (_a) {
    var _b;
    var children = _a.children, cx = _a.classnames, className = _a.className, style = _a.style, props = tslib.__rest(_a, ["children", "classnames", "className", "style"]);
    ...
    var rootStyle = React.useMemo(function () {
        ...
        var internalStyle = tslib.__assign(tslib.__assign({}, style), { flexBasis: percent });
        if (square) {
    ...
    var contentStyle = React.useMemo(function () {
        ...
        if (square && gutter) {
            var gutterValue = addUnit(gutter);
            return tslib.__assign(tslib.__assign({}, props.contentStyle), { right: gutterValue, bottom: gutterValue, height: 'auto' });
        }
    ...
    var renderIcon = function () {
        ...
        if (typeof props.icon === 'string') {
            if (props.badge) {
                return (_J$X_(Badge.Badge, tslib.__assign({}, props.badge),
                    _J$X_("div", { className: cx('GridNavItem-image') },
                        _J$X_("img", { src: props.icon, style: { width: ratio + '%' } }))));
            }
            return (_J$X_("div", { className: cx('GridNavItem-image') },
                _J$X_("img", { src: props.icon, style: { width: ratio + '%' } })));
        }
        if (React__default["default"].isValidElement(props.icon)) {
            return _J$X_(Badge.Badge, tslib.__assign({}, props.badge), props.icon);
        }
        return null;
    };
    var renderText = function () {
        ...
        if (props.text) {
            return _J$X_("span", { className: cx('GridNavItem-text') }, props.text);
        }
        return null;
    };
    ...
    var classes = cx("".concat(prefix, " ").concat(props.contentClassName || ''), (_b = {},
        ...
        _b));
    return (_J$X_("div", { className: cx(className, { 'GridNavItem--square': square }), style: rootStyle },
        _J$X_("div", { role: props.onClick ? 'button' : undefined, className: classes, style: contentStyle, onClick: props.onClick }, renderContent())));
};
var GridNav = function (_a) {
    var children = _a.children, className = _a.className, cx = _a.classnames, itemClassName = _a.itemClassName, style = _a.style, props = tslib.__rest(_a, ["children", "className", "classnames", "itemClassName", "style"]);
    return (_J$X_("div", { style: tslib.__assign({ paddingLeft: addUnit(props.gutter) }, style), className: cx("GridNav ".concat(className || ''), {
