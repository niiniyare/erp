...
var UserSelect = /** @class */ (function (_super) {
    tslib.__extends(UserSelect, _super);
    function UserSelect(props) {
        var _this = _super.call(this, props) || this;
        _this.unmounted = false;
        _this.lazySearch = debounce__default["default"](function (text) {
            (function (text) { return tslib.__awaiter(_this, void 0, void 0, function () {
                var onSearch, result;
                var _this = this;
    ...
    UserSelect.prototype.initDragging = function () {
        ...
        this.sortable = new Sortable__default["default"](document.querySelector(".".concat(ns, "UserSelect-checkContent")), {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        res = _c.sent();
                        option.children = flatten__default["default"](res);
                        return [3 /*break*/, 4];
                    case 2:
    ...
    UserSelect.prototype.getResult = function () {
        ...
        if (Array.isArray((_b = options === null || options === void 0 ? void 0 : options[0]) === null || _b === void 0 ? void 0 : _b.leftOptions)) {
            amisCore.eachTree(options[0].leftOptions, function (item) {
                var index = _selection.findIndex(function (item2) { return item2[valueField] === item[valueField]; });
                if (!!~index) {
                    _selection.splice(index, 1, tslib.__assign(tslib.__assign({}, _selection[index]), { label: item[labelField] }));
                }
            });
        }
        amisCore.eachTree(options, function (item) {
            var index = _selection.findIndex(function (item2) { return item2[valueField] === item[valueField]; });
            if (!!~index) {
                _selection.splice(index, 1, tslib.__assign(tslib.__assign({}, _selection[index]), { label: item[labelField] }));
            }
    ...
    UserSelect.prototype.renderIcon = function (option, isSelect) {
        ...
        if (!option.icon) {
            if (option.isRef || ((isSearch || isSelect) && isRef)) {
                return (_J$X_("span", { className: cx('UserSelect-text-userPic') }, (_a = option[labelField]) === null || _a === void 0 ? void 0 : _a.slice(0, 1)));
            }
            else {
                // 没有icon默认返回部门图标
                return (_J$X_("span", { className: cx('icon', 'UserSelect-icon-box', 'department') },
                    _J$X_(icons.Icon, { icon: "department", className: "icon" })));
            }
        }
        // 支持角色、岗位等图标配置
        var IconHtml;
        switch (option.icon) {
            case 'user-default-department':
                IconHtml = (_J$X_("span", { className: cx('icon', 'UserSelect-icon-box', 'department') },
                    _J$X_(icons.Icon, { icon: "department", className: "icon" })));
                break;
            case 'user-default-role':
                IconHtml = (_J$X_("span", { className: cx('icon', 'UserSelect-icon-box', 'role') },
                    _J$X_(icons.Icon, { icon: "role", className: "icon" })));
                break;
            case 'user-default-post':
                IconHtml = (_J$X_("span", { className: cx('icon', 'UserSelect-icon-box', 'post') },
                    _J$X_(icons.Icon, { icon: "post", className: "icon" })));
                break;
            case '':
                IconHtml = (_J$X_("span", { className: cx('UserSelect-text-userPic') }, option[labelField].slice(0, 1)));
                break;
            default:
                IconHtml = (_J$X_("img", { src: option.icon, className: cx('UserSelect-userPic') }));
        }
        return IconHtml;
    };
    UserSelect.prototype.renderList = function (options, key, isSearch) {
        ...
        return options.length ? (_J$X_("div", { className: cx('UserSelect-memberList-box'), key: key },
            _J$X_("ul", { className: cx("UserSelect-memberList"), key: key }, options.map(function (option, index) {
                ...
                return (_J$X_("li", { key: index, className: restFiedls.length === 2 ? cx("UserSelect-h2") : '' },
                    (isTab || multiple) && checkVisible ? (_J$X_(Checkbox["default"], { size: "sm", checked: checkValues.includes(option[valueField]), label: '', onChange: function () { return _this.handleSelectChange(option); } })) : null,
                    _J$X_("span", { className: cx('UserSelect-memberName'), onClick: function () {
                            return checkVisible
                        ...
                        !avatar &&
                            userIcon &&
                            (isDep || defaultIcons.includes(option.icon)) ? (_J$X_("span", { className: cx('UserSelect-userPic-box') }, userIcon)) : null,
                        !option.isRef ? (_J$X_("span", { className: cx('UserSelect-label') }, option.label)) : null,
                        avatar && option.isRef ? (option.avatar ? (_J$X_("img", { className: "option-avatar-img ".concat(restFiedls.length === 2 ? 'avatar-2' : ''), src: option.avatar })) : (_J$X_("span", { className: "option-avatar-txt ".concat(restFiedls.length === 2 ? 'avatar-2' : '') }, first))) : null,
                        option.isRef ? (_J$X_("div", { className: "option-fields" }, restFiedls.map(function (key) { return (_J$X_("span", { className: cx('option-item'), key: key }, option[key])); }))) : null),
                    !isSearch && hasChildren ? (_J$X_("span", { className: cx("UserSelect-more"), onClick: function () { return _this.handleExpand(option); } },
                        _J$X_(icons.Icon, { icon: "caret", className: "icon" }))) : null));
            })))) : (_J$X_("div", { className: cx("UserSelect-noRecord") },
    ...
    UserSelect.prototype.renderselectList = function (options) {
        ...
        return options.length ? (_J$X_("div", { className: cx('UserSelect-selection-wrap') },
            _J$X_("ul", { className: cx("UserSelect-selection", "UserSelect-checkContent"), ref: this.dragRef }, options.map(function (option, index) {
                var _a;
                var userIcon = _this.renderIcon(option, true);
                var options = _this.state.options;
                var originOption = amisCore.findTree(options, function (item) { return item[valueField] === option[valueField]; });
                var displays = option.type === 'user' && displayFields
                    ? displayFields
                    : ['label'];
                var avatar = displays.find(function (i) { return i === 'avatar'; });
                ...
                return (_J$X_("li", { key: index, className: restFiedls.length === 2 ? cx("UserSelect-h2") : '' },
                    isEdit ? (_J$X_("span", { className: cx("UserSelect-del"), onClick: function () { return _this.onDelete(option, true); } },
                        _J$X_(icons.Icon, { icon: "user-remove", className: "icon" }))) : null,
                    _J$X_("span", { className: cx("UserSelect-memberName") },
                        !avatar &&
                            userIcon &&
                            (isDep || defaultIcons.includes(option.icon)) ? (_J$X_("span", { className: cx('UserSelect-userPic-box') }, userIcon)) : null,
                        !option.isRef ? (labelField === 'avatar' ? (option[labelField] ? (_J$X_("img", { className: cx('UserSelect-avatar-img'), src: option[labelField], alt: "" })) : (_J$X_("span", { className: cx('UserSelect-avatar-text') }, option[valueField].slice(0, 1).toLocaleUpperCase()))) : (_J$X_("span", { className: cx('UserSelect-label') }, originOption
                            ? originOption[labelField]
                            : option[labelField]))) : null,
                        avatar && option.isRef ? (option.avatar ? (_J$X_("img", { className: "option-avatar-img ".concat(restFiedls.length === 2 ? 'avatar-2' : ''), src: option.avatar })) : (_J$X_("span", { className: "option-avatar-txt ".concat(restFiedls.length === 2 ? 'avatar-2' : '') }, first))) : null,
                        option.isRef ? (_J$X_("div", { className: "option-fields" }, restFiedls.map(function (key) { return (_J$X_("span", { className: cx('option-item'), key: key }, option[key])); }))) : null),
                    isEdit ? (_J$X_("a", { className: cx('UserSelect-dragBar') },
                        _J$X_(icons.Icon, { icon: "drag-bar", className: cx('icon') }))) : null));
            })))) : (_J$X_("div", { className: cx("UserSelect-noRecord") },
            __('placeholder.noOption'),
            "~"));
    };
    UserSelect.prototype.renderContent = function () {
        ...
        return (_J$X_("div", { className: cx("UserSelect-wrap") },
            showNav ? (_J$X_("div", { className: cx('UserSelect-navbar') },
                _J$X_("span", { className: "left-arrow-box", onClick: this.handleBack },
                    _J$X_(icons.Icon, { icon: "left-arrow", className: "icon" })),
                _J$X_("div", { className: cx('UserSelect-navbar-title') }, navTitle))) : null,
            searchable ? (_J$X_("div", { className: cx('UserSelect-searchBox') },
                _J$X_(InputBox["default"], { className: cx("UserSelect-search"), value: this.state.inputValue, onChange: this.handleSearch, placeholder: searchPlaceholder, clearable: false, mobileUI: mobileUI }, this.state.isSearch ? (_J$X_("a", { onClick: this.handleSeachCancel },
                    _J$X_(icons.Icon, { icon: "close", className: "icon" }))) : (_J$X_(icons.Icon, { icon: "search", className: "icon" }))))) : null,
            breadList.length ? (_J$X_("div", { className: cx('UserSelect-breadcrumb') }, breadList
                .map(function (item, index) { return (_J$X_("span", { className: cx('UserSelect-breadcrumb-item'), key: index, onClick: function () { return _this.handleBreadChange(item, index); } }, item.label)); })
                .reduce(function (prev, curr, index) { return [
                prev,
                _J$X_(icons.Icon, { icon: "caret", className: cx('UserSelect-breadcrumb-separator', 'icon'), key: "separator-".concat(index) }),
                curr
            ]; }))) : null,
            (selection === null || selection === void 0 ? void 0 : selection.length) ? (_J$X_("div", { className: cx("UserSelect-resultBox") },
                _J$X_("div", { className: cx("UserSelect-resultBox-shadow") }),
                _J$X_("ul", { className: cx("UserSelect-selectList") }, selection.map(function (item, index) {
                    var originOption = amisCore.findTree(options, function (op) { return op[valueField] === item[valueField]; });
                    return (_J$X_("li", { key: index, className: cx('UserSelect-selectList-item') },
                        labelField === 'avatar' ? (item[labelField] ? (_J$X_("img", { className: cx('UserSelect-avatar-img'), src: item[labelField], alt: "" })) : (_J$X_("span", { className: cx('UserSelect-avatar-text') }, item[valueField].slice(0, 1).toLocaleUpperCase()))) : (_J$X_("span", null, originOption
                            ? originOption[labelField]
                            : item[labelField])),
                        _J$X_("span", { className: cx('UserSelect-selectList-item-closeBox'), onClick: function () { return _this.onDelete(item); } },
                            _J$X_(icons.Icon, { icon: "close", className: "icon" }))));
                })),
                multiple ? (_J$X_("span", { className: cx('UserSelect-selectSort-box'), onClick: this.handleSort },
                    _J$X_(icons.Icon, { icon: "menu", className: cx('UserSelect-selectSort', 'icon') }))) : null)) : null,
            isSearch ? (searchLoading ? (_J$X_("div", { className: cx("UserSelect-searchLoadingBox") },
                _J$X_(Spinner["default"], { loadingConfig: loadingConfig }))) : (_J$X_("div", { className: cx('UserSelect-searchResult') }, this.renderList(searchList, -1, true)))) : (_J$X_("div", { className: cx("UserSelect-contentBox") },
                _J$X_("div", { className: cx("UserSelect-scroll"), style: {
                        width: 100 * (breadList.length + 1) + 'vw',
                        left: -breadList.length * 100 + 'vw'
                    } },
                    this.renderList(options),
                    breadList.map(function (option, index) {
                        var treeOption = amisCore.findTree(options, Select.optionValueCompare(option[valueField], valueField || 'value'));
                        var children = treeOption.children;
                        var hasChildren = Array.isArray(children) && children;
                        return hasChildren ? (_this.renderList(children, option[valueField])) : (_J$X_("div", { className: cx("UserSelect-spinnerBox"), key: index },
                            _J$X_(Spinner["default"], { loadingConfig: loadingConfig })));
                    })))),
            !controlled ? (_J$X_("div", { className: cx('UserSelect-footer') },
                _J$X_("button", { type: "button", className: cx('Button Button--md Button--primary'), onClick: this.handleSubmit }, __('UserSelect.sure')))) : null));
    };
    UserSelect.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('UserSelect') },
            showResultBox ? (_J$X_(ResultBox["default"], { className: cx('UserSelect-input', isOpened ? 'is-active' : ''), allowInput: false, result: this.getResult(), disabled: disabled, itemRender: function (option) {
                    if (labelField !== 'avatar') {
                        return (_J$X_("span", null, "".concat(option.scopeLabel || '').concat(option.label)));
                    }
                    else {
                        if (option[labelField]) {
                            return (_J$X_("img", { className: cx('UserSelect-avatar-img'), src: option[labelField], alt: "" }));
                        }
                        return (_J$X_("span", { className: cx('UserSelect-avatar-text') }, option[valueField].slice(0, 1).toLocaleUpperCase()));
                    }
            ...
            showResultBox ? (_J$X_(PopUp["default"], { isShow: isOpened, className: cx("UserSelect-popup"), onHide: this.onClose, showClose: false }, this.renderContent())) : (this.renderContent()),
            _J$X_(PopUp["default"], { isShow: isSelectOpened, className: cx("UserSelect-selectPopup"), onHide: function () {
                    return _this.setState({
                        isSelectOpened: false,
                        isEdit: false
                    });
                }, showClose: false },
                _J$X_("div", { className: cx('UserSelect-selectBody') },
                    _J$X_("div", { className: cx('UserSelect-navbar') },
                        _J$X_("span", { className: "left-arrow-box", onClick: function () {
                                return _this.setState({
                                    isSelectOpened: false,
                                    isEdit: false
                                });
                            ...
                            _J$X_(icons.Icon, { icon: "left-arrow", className: "icon" })),
                        _J$X_("div", { className: cx('UserSelect-navbar-title') }, __('UserSelect.resultSort')),
                        _J$X_("span", { className: cx('UserSelect-navbar-btnEdit'), onClick: this.handleEdit }, isEdit ? __('UserSelect.save') : __('UserSelect.edit'))),
                    _J$X_("div", { className: cx('UserSelect-selectList-box') },
                        _J$X_("div", { className: cx('UserSelect-select-head') },
                            _J$X_("span", { className: cx('UserSelect-select-head-text') }, __('UserSelect.selected')),
                            isEdit ? (_J$X_("span", { className: cx('UserSelect-select-head-btnClear'), onClick: this.handleClear }, __('UserSelect.clear'))) : null),
...
var UserSelect$1 = amisCore.themeable(amisCore.localeable(UserSelect));

exports.UserSelect = UserSelect;
exports["default"] = UserSelect$1;
