...
var BaseTextArea = require('react-textarea-autosize');
...
var BaseTextArea__default = /*#__PURE__*/_interopDefaultLegacy(BaseTextArea);
...
var Textarea = /** @class */ (function (_super) {
    ...
    function Textarea() {
        ...
        _this.inputRef = function (ref) {
            _this.input = ReactDOM.findDOMNode(ref);
    ...
    Textarea.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx("TextareaControl", (_a = {},
                _a["TextareaControl--border".concat(amisCore.ucFirst(borderMode))] = borderMode,
                _a['is-focused'] = this.state.focused,
                _a['is-disabled'] = disabled || readOnly,
                _a), className), style: style },
            _J$X_(BaseTextArea__default["default"], tslib.__assign({ className: cx("TextareaControl-input", {
            ...
            clearable && !disabled && value ? (_J$X_("a", { onClick: this.handleClear, className: cx('TextareaControl-clear') },
                _J$X_(icons.Icon, { icon: "input-clear", className: "icon" }))) : null,
            showCounter ? (_J$X_("span", { className: cx('TextareaControl-counter', {
                    'is-empty': counter === 0,
                    'is-clearable': clearable && !disabled && value
                }) },
                _J$X_("span", null, counter),
                typeof maxLength === 'number' && maxLength ? (_J$X_(React__default["default"].Fragment, null,
                    _J$X_("i", null, "/"),
                    _J$X_("span", null, maxLength))) : null)) : null));
    };
...
var Textarea$1 = amisCore.themeable(amisCore.localeable(Textarea));
