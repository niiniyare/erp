...
var Rating = /** @class */ (function (_super) {
    ...
    function Rating(props) {
        ...
        _this.ratingRef = React__default["default"].createRef();
        _this.starsNode = {};
        _this.state = {
            value: props.value || 0,
            stars: [],
    ...
    Rating.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (amisCore.isObjectShallowModified({
            value: props.value,
            count: props.count
        }, {
        ...
        else if (amisCore.isObjectShallowModified(props.colors, prevProps.colors) ||
            amisCore.isObjectShallowModified(props.texts, prevProps.texts)) {
    ...
    Rating.prototype.sortKeys = function (map) {
        ...
        return Object.keys(map)
            .filter(function (item) { return amisCore.validations.isNumeric({}, item); })
    ...
    Rating.prototype.getShowColorAndText = function (value) {
        ...
        if (this.ratingRef.current) {
            ...
            if (isEmpty__default["default"](colors) && !isEmpty__default["default"](obj_1)) {
                tempColor = obj_1;
            }
        }
        if (!value)
        ...
        if (texts && amisCore.isObject(texts)) {
    ...
    Rating.prototype.renderStars = function () {
        ...
        return (_J$X_("ul", { onMouseLeave: this.mouseLeave }, stars.map(function (star, i) {
            var isThisHalf = half && !halfStar.hidden && halfStar.at === i;
            return (_J$X_("li", { ref: _this.saveRef(i), className: cx('Rating-star', charClassName, {
                    'is-half': isThisHalf,
                ...
                isThisHalf && (_J$X_("div", { className: cx('Rating-star-half'), style: {
                        color: showColor
                    } }, char)),
                char));
        })));
    ...
    Rating.prototype.renderText = function () {
        ...
        if (!showText)
            return null;
        return (_J$X_("span", { className: cx('Rating-text', textClassName, (_a = {},
    ...
    Rating.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('Rating', className), ref: this.ratingRef }, textPosition === 'left' ? (_J$X_(React__default["default"].Fragment, null,
            this.renderText(),
            this.renderStars())) : (_J$X_(React__default["default"].Fragment, null,
            this.renderStars(),
            this.renderText()))));
    };
    Rating.defaultProps = {
        ...
        value: 0,
        count: 5,
        char: _J$X_(icons.Icon, { icon: "star", className: "icon", iconContent: "Rating-star-icon" }),
        colors: '',
        textPosition: 'right'
    };
    return Rating;
}(React__default["default"].Component));
var Rating$1 = amisCore.themeable(Rating);
