...
var SelectMobile = /** @class */ (function (_super) {
    tslib.__extends(SelectMobile, _super);
    function SelectMobile(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
            selection: Select.value2array(props.value, props),
            isFocused: false,
            inputValue: '',
    ...
    SelectMobile.prototype.handleChange = function (_a) {
        var _b = tslib.__read(_a, 1), item = _b[0];
    ...
    SelectMobile.prototype.render = function () {
        ...
        var renderItem = function (_a) {
            ...
            return (_J$X_("div", tslib.__assign({}, getItemProps({
                ...
                disabled: item.disabled
                    ...
                    'is-active': checked,
                    'is-mobile': true
                }) }), renderMenu ? (multiple ? (_J$X_(React__default["default"].Fragment, null,
                _J$X_("div", { title: item[labelField], className: cx('Select-option-item-check'), onClick: function () { return !item.disabled && _this.handleChange([item]); } }, renderMenu(item, {
                    multiple: multiple,
                    checkAll: checkAll,
                    checked: checked,
                ...
                checked ? (_J$X_(icons.Icon, { icon: "check", className: cx('Select-option-mcheck') })) : null)) : (renderMenu(item, {
                multiple: multiple,
                checkAll: checkAll,
                checked: checked,
                onChange: function () { return _this.handleChange(item); },
                ...
                searchable: searchable,
                index: index
            }))) : multiple ? (_J$X_(React__default["default"].Fragment, null,
                _J$X_("div", { title: item[labelField], className: cx('Select-option-item-check'), onClick: function () { return !item.disabled && _this.handleChange([item]); } },
                    item.disabled
                        ? item[labelField]
                        : amisCore.highlight(item[labelField], inputValue, cx('Select-option-hl')),
                    item.tip),
                checked ? (_J$X_(icons.Icon, { icon: "check", className: cx('Select-option-mcheck') })) : null)) : (_J$X_("span", { className: cx('Select-option-content'), title: typeof item[labelField] === 'string' ? item[labelField] : '' },
                item.disabled
                    ? item[labelField]
                    : amisCore.highlight(item[labelField], inputValue, cx('Select-option-hl')),
                item.tip))));
        };
        var searchInput = (_J$X_("div", { className: cx("Select-input", {
        ...
        var menu = (_J$X_("div", { className: cx('Select-menu', {
        ...
        return (_J$X_(PopUp["default"], { className: cx("Select-popup"), container: popOverContainer, isShow: isOpen, showConfirm: true, onConfirm: this.onConfirm, onHide: onClose }, multiple ? (menu) : (_J$X_("div", { className: cx("Select-popup-inner") },
            searchable ? searchInput : null,
            _J$X_(Picker["default"], { className: 'Select-picker', columns: {
