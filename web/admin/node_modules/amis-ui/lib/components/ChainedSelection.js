...
var ChainedSelection = /** @class */ (function (_super) {
    tslib.__extends(ChainedSelection, _super);
    ...
    ChainedSelection.prototype.renderItem = function (option, index, depth, id, styles) {
        ...
        return (_J$X_("div", { style: styles, key: index, className: cx('ChainedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', !!~valueArray.indexOf(option) ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
            multiple ? (_J$X_(Checkbox["default"], { size: "sm", checked: !!~valueArray.indexOf(option), disabled: disabled || option.disabled, labelClassName: labelClassName, description: option.description, testIdBuilder: itemTIB })) : null,
            _J$X_("div", { className: cx('ChainedSelection-itemLabel') }, itemRender(option, {
                index: index,
                multiple: multiple,
    ...
    ChainedSelection.prototype.renderOption = function (option, index, depth, id, styles) {
        ...
        if (Array.isArray(option.children) || option[deferField]) {
            return (_J$X_("div", tslib.__assign({ style: styles, key: index, className: cx('ChainedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', ~this.state.selected.indexOf(id) ? 'is-active' : ''), onClick: function () { return _this.selectOption(option, depth, id); } }, itemTIB === null || itemTIB === void 0 ? void 0 : itemTIB.getTestId()),
                ...
                option[deferField] && option.loading ? (_J$X_(Spinner["default"], { loadingConfig: loadingConfig, size: "sm", show: true })) : null));
        }
    ...
    ChainedSelection.prototype.renderCheckAll = function () {
        ...
        return (_J$X_("div", { className: cx('ChainedSelection-item', 'ChainedSelection-checkAll', itemClassName), onClick: this.toggleAll },
            _J$X_(Checkbox["default"], { checked: checkedPartial, partial: checkedPartial && !checkedAll, size: "sm", labelClassName: labelClassName }),
            _J$X_("div", { className: cx('ChainedSelection-itemLabel') },
                _J$X_("span", null, __(checkAllLabel)))));
    };
    ChainedSelection.prototype.render = function () {
        ...
        if (Array.isArray(options) && options.length) {
            ...
            var depth = Math.min(amisCore.getTreeDepth(options), 3);
            times__default["default"](Math.max(depth - selected_1.length, 1), function () { return selected_1.push(null); });
            selected_1.reduce(function (_a, selected, depth) {
                ...
                if (Array.isArray(options) && options.length > virtualThreshold) {
                    ...
                    body.push(_J$X_("div", { key: depth, className: cx('ChainedSelection-col') },
                        _J$X_(AutoSizer["default"], { minHeight: virtualListHeight }, function (_a) {
                            var height = _a.height;
                            return (_J$X_(index["default"], { height: height, itemCount: finalOptions_1.length, itemSize: itemHeight, renderItem: function (_a) {
                                    ...
                                    if ((option === null || option === void 0 ? void 0 : option.type) === 'chainedSelection-subTitle') {
                                        return (_J$X_("div", { style: tslib.__assign(tslib.__assign({}, style), { width: '100%' }), key: indexes.join('-') + 'subTitle', className: cx('ChainedSelection-subTitle') }, option.value));
                                    }
                                    index = subTitle ? index - 1 : index;
                                    var id = indexes.concat(index).join('-');
                                    return _this.renderOption(option, index, depth, id, tslib.__assign(tslib.__assign({}, style), { width: '100%' }));
                                } }));
                        })));
                }
                else {
                    body.push(_J$X_("div", { key: depth, className: cx('ChainedSelection-col') },
                        subTitle ? (_J$X_("div", { className: cx('ChainedSelection-subTitle') }, subTitle)) : null,
                        ...
                        })) : (_J$X_("div", { className: cx('ChainedSelection-placeholder') }, __(placeholder)))));
                }
                return {
                    options: nextOptions,
        ...
        return (_J$X_("div", { className: cx('ChainedSelection', className) }, body && body.length ? (_J$X_(React__default["default"].Fragment, null,
            this.renderCheckAll(),
            body)) : (_J$X_("div", { className: cx('ChainedSelection-placeholder') }, __(placeholder)))));
    };
    return ChainedSelection;
}(Selection.BaseSelection));
var ChainedCheckboxes = amisCore.themeable(amisCore.localeable(amisCore.uncontrollable(ChainedSelection, {
    value: 'onChange'
})));

exports.ChainedSelection = ChainedSelection;
exports["default"] = ChainedCheckboxes;
