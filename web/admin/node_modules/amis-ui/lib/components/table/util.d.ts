...
export declare function hasFixedColumn(columns: Array<ColumnProps | SummaryProps>): number | ColumnProps | SummaryProps | (() => IterableIterator<ColumnProps | SummaryProps>) | (() => {
    copyWithin: boolean;
    entries: boolean;
    fill: boolean;
    find: boolean;
...
} | ((value: ColumnProps | SummaryProps, start?: number | undefined, end?: number | undefined) => (ColumnProps | SummaryProps)[]) | ((callbackfn: (value: ColumnProps | SummaryProps, index: number, array: (ColumnProps | SummaryProps)[]) => void, thisArg?: any) => void) | ((compareFn?: ((a: ColumnProps | SummaryProps, b: ColumnProps | SummaryProps) => number) | undefined) => (ColumnProps | SummaryProps)[]) | (() => string) | (() => string) | (() => ColumnProps | SummaryProps | undefined) | ((...items: (ColumnProps | SummaryProps)[]) => number) | ((separator?: string | undefined) => string) | (() => (ColumnProps | SummaryProps)[]) | (() => ColumnProps | SummaryProps | undefined) | {
...
} | ((predicate: (value: ColumnProps | SummaryProps, index: number, obj: (ColumnProps | SummaryProps)[]) => unknown, thisArg?: any) => number) | ((target: number, start: number, end?: number | undefined) => (ColumnProps | SummaryProps)[]) | (() => IterableIterator<[number, ColumnProps | SummaryProps]>) | (() => IterableIterator<number>) | (() => IterableIterator<ColumnProps | SummaryProps>) | (<U_3, This = undefined>(callback: (this: This, value: ColumnProps | SummaryProps, index: number, array: (ColumnProps | SummaryProps)[]) => U_3 | readonly U_3[], thisArg?: This | undefined) => U_3[]) | (<A, D extends number = 1>(this: A, depth?: D | undefined) => FlatArray<A, D>[]) | undefined;
