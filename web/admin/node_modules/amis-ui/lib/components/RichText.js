...
var Froala = require('froala-editor/js/froala_editor.min.js');
...
var Froala__default = /*#__PURE__*/_interopDefaultLegacy(Froala);
...
var FroalaEditorComponent = /** @class */ (function (_super) {
    tslib.__extends(FroalaEditorComponent, _super);
    ...
    FroalaEditorComponent.prototype.componentDidUpdate = function (prevProps) {
        if (!isEqual__default["default"](this.props.config, prevProps.config)) {
            this.destroyEditor();
            this.createEditor();
            return;
        }
    ...
    FroalaEditorComponent.prototype.createEditor = function () {
        ...
        this.config = tslib.__assign({}, this.config);
        ...
        this.editor = new FroalaEditor__default["default"](this.element, this.config);
    };
    ...
    FroalaEditorComponent.prototype.render = function () {
        var _this = this;
        return (_J$X_("textarea", { ref: function (el) { return (_this.el = el); } }, this.props.children));
    };
...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1(props) {
        var _this = _super.call(this, props) || this;
        Froala__default["default"].VIDEO_PROVIDERS = [
            {
                test_regex: /.*/,
                url_regex: '',
                url_text: '',
    ...
    default_1.prototype.render = function () {
        return (_J$X_(FroalaEditorComponent, { config: this.props.config, model: this.props.model, onModelChange: this.props.onModelChange }));
    };
    return default_1;
}(React__default["default"].Component));
...
Object.defineProperty(exports, 'FroalaEditor', {
    enumerable: true,
    get: function () { return FroalaEditor__default["default"]; }
});
