...
var TooltipWrapper = /** @class */ (function (_super) {
    ...
    TooltipWrapper.prototype.render = function () {
        ...
        var child = React__default["default"].Children.only(props.children);
        if (!props.tooltip) {
            return child;
        }
        // tooltip 对象内属性优先级更高
        var tooltipObj = tslib.__assign({ placement: props.placement, container: props.container, trigger: props.trigger, rootClose: props.rootClose, tooltipClassName: props.tooltipClassName, style: props.style, mouseLeaveDelay: props.delay, tooltipTheme: props.tooltipTheme }, (typeof props.tooltip === 'string'
        ...
        return [
            child ? React__default["default"].cloneElement(child, childProps) : null,
            _J$X_(amisCore.Overlay, { key: "overlay", target: this.getTarget, show: this.state.show && !disabled, onHide: this.handleHide, rootClose: rootClose, placement: placement, container: container, offset: Array.isArray(offset) ? offset : [0, 0] },
                _J$X_(Tooltip["default"], { title: typeof title === 'string' ? title : undefined, style: style, className: tooltipClassName, tooltipTheme: tooltipTheme, showArrow: showArrow, arrowClassName: tooltipArrowClassName, bodyClassName: tooltipBodyClassName, onMouseEnter: ~triggers.indexOf('hover') ? this.tooltipMouseEnter : function () { }, onMouseLeave: ~triggers.indexOf('hover') ? this.tooltipMouseLeave : function () { } }, children ? (_J$X_(React__default["default"].Fragment, null, typeof children === 'function' ? children() : children)) : (_J$X_(Html["default"], { html: typeof content === 'string' ? content : '', filterHtml: filterHtml }))))
        ];
    };
...
var TooltipWrapper$1 = amisCore.themeable(amisCore.uncontrollable(TooltipWrapper, {
    show: 'onVisibleChange'
}));

exports.TooltipWrapper = TooltipWrapper;
exports["default"] = TooltipWrapper$1;
