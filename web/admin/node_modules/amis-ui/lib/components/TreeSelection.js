...
var TreeSelection = /** @class */ (function (_super) {
    tslib.__extends(TreeSelection, _super);
    ...
    TreeSelection.prototype.syncExpanded = function () {
        ...
        if (mode === 'first' || mode === 'root') {
            ...
            amisCore.everyTree(options, function (option, index, level, paths, indexes) {
                if (Array.isArray(option.children)) {
    ...
    TreeSelection.prototype.renderItem = function (option, index, indexes) {
        ...
        return (_J$X_("div", { key: index, className: cx('TreeSelection-item', disabled || option.disabled || (option[deferField] && option.loading)
                ? 'is-disabled'
                : '', expaned ? 'is-expanded' : '') },
            _J$X_("div", { className: cx('TreeSelection-itemInner', itemClassName, option.className, checked ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
                hasChildren || option[deferField] ? (_J$X_("a", { onClick: function (e) {
                        e.stopPropagation();
                ...
                option[deferField] && option.loading ? (_J$X_(Spinner["default"], { loadingConfig: loadingConfig, show: true, size: "sm" })) : null,
                multiple && (!option[deferField] || option.loaded) ? (_J$X_(Checkbox["default"], { size: "sm", checked: checked, partial: partial, disabled: disabled || option.disabled, labelClassName: labelClassName, description: option.description })) : null,
                _J$X_("div", { className: cx('TreeSelection-itemLabel') }, itemRender(option, {
                    index: index,
                    multiple: multiple,
                    checked: checked,
                ...
                option[deferField] && option.loading ? (_J$X_(Spinner["default"], { loadingConfig: loadingConfig, show: true, size: "sm" })) : null),
            hasChildren ? (_J$X_("div", { className: cx('TreeSelection-sublist') }, option.children.map(function (option, key) {
    ...
    TreeSelection.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('TreeSelection', className) }, body && body.length ? (body) : (_J$X_("div", { className: cx('TreeSelection-placeholder') }, (_a = placeholderRender === null || placeholderRender === void 0 ? void 0 : placeholderRender(this.props)) !== null && _a !== void 0 ? _a : __(placeholder)))));
    };
    TreeSelection.defaultProps = tslib.__assign(tslib.__assign({}, Selection.BaseSelection.defaultProps), { expand: 'first' });
    return TreeSelection;
}(Selection.BaseSelection));
var TreeSelection$1 = amisCore.themeable(amisCore.localeable(amisCore.uncontrollable(TreeSelection, {
    value: 'onChange'
})));

exports.TreeSelection = TreeSelection;
exports["default"] = TreeSelection$1;
