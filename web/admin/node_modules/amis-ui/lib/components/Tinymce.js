...
require('tinymce/plugins/help/js/i18n/keynav/zh_CN');
require('tinymce/plugins/help/js/i18n/keynav/en');
require('tinymce/plugins/help/js/i18n/keynav/de');
...
var TinymceEditor = /** @class */ (function (_super) {
    tslib.__extends(TinymceEditor, _super);
    function TinymceEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.unmounted = false;
        _this.editorInitialized = false;
        _this.elementRef = React__default["default"].createRef();
        return _this;
    }
    ...
    TinymceEditor.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (props.model !== prevProps.model &&
            ...
            this.editorInitialized &&
                ((_a = this.editor) === null || _a === void 0 ? void 0 : _a.setContent((this.currentContent = props.model || '')));
        }
        if (this.editor && !isEqual__default["default"](this.props.config, prevProps.config)) {
            this.editor.contentWindow.removeEventListener('unload', this.handleIframeUnload);
    ...
    TinymceEditor.prototype.initTiny = function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this.props.config || {}, onLoaded = _a.onLoaded, rest = tslib.__rest(_a, ["onLoaded"]);
                        this.config = tslib.__assign(tslib.__assign({ inline: false, skin: false, content_css: false, height: 400, language: !locale || locale === 'zh-CN' ? 'zh_CN' : 'en', branding: false, plugins: [
                                'advlist',
                                'autolink',
                                'autoresize',
                                'link',
                                ...
                                'fontfamily fontsize forecolor backcolor emoticons | print help', quickbars_selection_toolbar: 'bold italic | link h2 h3 blockquote', quickbars_insert_toolbar: 'quickimage quicktable', menu: {
                                file: {
                                    title: 'File',
                            ...
                            }, paste_data_images: true, content_style: [
                                // 支持图片调整大小
                        ...
                        return [4 /*yield*/, (onLoaded === null || onLoaded === void 0 ? void 0 : onLoaded(tinymce__default["default"]))];
                    case 1:
                        _b.sent();
                        this.unmounted || tinymce__default["default"].init(this.config);
                        return [2 /*return*/];
                }
            });
        });
    ...
    ], TinymceEditor.prototype, "initTiny", null);
    tslib.__decorate([
        amisCore.autobind,
        tslib.__metadata("design:type", Function),
        tslib.__metadata("design:paramtypes", []),
        tslib.__metadata("design:returntype", void 0)
    ], TinymceEditor.prototype, "handleIframeUnload", null);
    return TinymceEditor;
}(React__default["default"].Component));
tinymce__default["default"].addI18n('zh_CN', {
    'Redo': '\u91cd\u505a',
    'Undo': '\u64a4\u9500',
    'Cut': '\u526a\u5207',
    'Copy': '\u590d\u5236',
...
Object.defineProperty(exports, 'tinymce', {
    enumerable: true,
    get: function () { return tinymce__default["default"]; }
});
