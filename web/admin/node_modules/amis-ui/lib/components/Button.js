...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.renderButton = function () {
        ...
        return (_J$X_(Comp, tslib.__assign({ type: Comp === 'input' || Comp === 'button' ? type : undefined }, amisCore.pickEventsProps(rest), { onClick: rest.onClick && disabled ? function () { } : rest.onClick, href: href }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId(), { className: cx(overrideClassName
                ? ''
                : (_a = {
                        'Button': true
                    },
            ...
            loading && !disabled && (_J$X_(Spinner["default"], { loadingConfig: loadingConfig, size: "sm", show: true, icon: "loading-outline", className: cx(overrideClassName
                    ? ''
    ...
    Button.prototype.render = function () {
        ...
        return (_J$X_(TooltipWrapper["default"], { placement: tooltipPlacement, tooltip: disabled ? disabledTip : tooltip, container: tooltipContainer, trigger: tooltipTrigger, rootClose: tooltipRootClose }, this.renderButton()));
    };
    Button.defaultProps = {
