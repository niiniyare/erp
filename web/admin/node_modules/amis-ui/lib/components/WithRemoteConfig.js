        ...
        var result = hoistNonReactStatic__default["default"](WithStore.withStore(function () { return Store.create(); })((_a = /** @class */ (function (_super) {
                ...
                class_1.prototype.loadConfig = function (ctx) {
                    ...
                    return tslib.__awaiter(this, void 0, void 0, function () {
                        var env, _a, store, data, source;
                        return tslib.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    env = this.props.env || this.context;
                                    _a = this.props, store = _a.store, data = _a.data;
                ...
                class_1.prototype.render = function () {
                    ...
                    var _b = this.props; _b.remoteConfigRef; var autoComplete = _b.autoComplete, rest = tslib.__rest(_b, ["remoteConfigRef", "autoComplete"]);
                    var refConfig = ((_a = ComposedComponent.prototype) === null || _a === void 0 ? void 0 : _a.isReactComponent) ||
                        ComposedComponent.$$typeof ===
                            Symbol.for('react.forward_ref')
                        ? { ref: this.childRef }
                        : { forwardedRef: this.childRef };
                    return (_J$X_(ComposedComponent, tslib.__assign({}, rest, (env && amisCore.isEffectiveApi(autoComplete) && this.loadOptions
