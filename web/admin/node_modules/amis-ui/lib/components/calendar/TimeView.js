...
var CustomTimeView = /** @class */ (function (_super) {
    ...
    CustomTimeView.prototype.render = function () {
                ...
                inputs.push(_J$X_(Downshift__default["default"], { key: i + 'input', inputValue: date.format(formatMap_1[type]) }, function (_a) {
                    ...
                    return (_J$X_("div", { className: cx('CalendarInputWrapper') },
                        _J$X_("div", { className: cx('CalendarInput-sugs', type === 'hours'
                            ...
                            var _a;
                            return (_J$X_("div", tslib.__assign({ key: option.value, className: cx('CalendarInput-sugsItem', {
                                    'is-mobile': mobileUI,
        ...
        var quickLists = [
            _J$X_("a", tslib.__assign({ key: "select-now", onClick: this.selectNowTime }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('select-now').getTestId()), __('TimeNow'))
        ];
        return (_J$X_(React__default["default"].Fragment, null,
            ...
            this.props.requiredConfirm && (_J$X_("div", { className: cx('TimeFooterWrapper') },
                ...
                _J$X_("a", tslib.__assign({ className: cx('Button', 'Button--primary', 'Button--size-sm'), onClick: this.confirm }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('confirm').getTestId()), __('confirm'))))));
    };
