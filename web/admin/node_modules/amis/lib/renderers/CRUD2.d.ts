...
export default class CRUD2<T extends CRUD2Props> extends React.Component<T, any> {
    ...
    transformTable2cards(): {
        ...
        card: T[string] & {
            ...
            mediaActionPosition?: string | undefined;
            body: any[];
            actions: any[];
        };
    } | null;
...
export declare class CRUD2RendererBase<T extends CRUD2Props> extends CRUD2<T> {
...
export declare class CRUD2Renderer extends CRUD2RendererBase<CRUD2Props> {
}
