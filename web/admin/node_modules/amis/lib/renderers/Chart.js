...
;var DEFAULT_EVENT_PARAMS = ['componentType', 'seriesType', 'seriesIndex', 'seriesName', 'name', 'dataIndex', 'data', 'dataType', 'value', 'color'];
var EVAL_CACHE = {};
/**
...
function recoverFunctionType(config) {
  ['interval', 'formatter', 'color', 'min', 'max', 'labelFormatter', 'valueFormatter', 'pageFormatter', 'optionToContent', 'contentToOption', 'animationDelay', 'animationDurationUpdate', 'animationDelayUpdate', 'animationDuration', 'position', 'sort', 'renderItem'].forEach(function (key) {
    var e_1, _a;
...
var Chart = /** @class */function (_super) {
  ...
  Chart.prototype.componentDidUpdate = function (prevProps) {
    ...
    if (amisCore.isApiOutdated(prevProps.api, props.api, prevProps.data, props.data)) {
      ...
      var prevRet = prevProps.source ? amisCore.resolveVariableAndFilter(prevProps.source, prevProps.data, '| raw') : null;
    ...
    } else if (props.config && props.trackExpression && amisCore.filter(props.trackExpression, props.data) !== amisCore.filter(prevProps.trackExpression, prevProps.data)) {
      this.renderChart(props.config || {});
      ...
      return tslib.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            clickAction && onAction && onAction(null, clickAction, amisCore.createObject(data, ctx));
            return [2 /*return*/];
        }
      });
    });
  ...
  Chart.prototype.dispatchEvent = function (ctx) {
    ...
    dispatchEvent(ctx.event || ctx.type, amisCore.createObject(data, tslib.__assign({}, pick__default["default"](ctx, ctx.type === 'legendselectchanged' ? ['name', 'selected'] : DEFAULT_EVENT_PARAMS))));
  };
  Chart.prototype.refFn = function (ref) {
    ...
    if (ref) {
      Promise.all([Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['echarts', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})}), Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['echarts-stat', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})}),
      // @ts-ignore 官方没提供 type
      Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['echarts/extension/dataTool', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})}),
      // @ts-ignore 官方没提供 type
      Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['echarts/extension/bmap/bmap', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})}),
      // @ts-ignore 官方没提供 type
      Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['echarts-wordcloud/dist/echarts-wordcloud', "tslib"], function(mod, tslib) {fullfill(tslib.__importStar(mod))})})})]).then(function (_a) {
            ...
            switch (_c.label) {
              ...
              case 8:
                ...
                if (typeof onChartMount === 'string') {
                  onChartMount = amisCore.str2function(onChartMount, 'chart', 'echarts');
                }
  ...
  Chart.prototype.doAction = function (action, data, throwErrors) {
    ...
    return (_b = (_a = this.echarts) === null || _a === void 0 ? void 0 : _a.dispatchAction) === null || _b === void 0 ? void 0 : _b.call(_a, tslib.__assign({
      ...
      return tslib.__generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 2:
            ...
            if (!result.ok) {
              !(api === null || api === void 0 ? void 0 : api.silent) && env.notify('error', (_d = (_c = api === null || api === void 0 ? void 0 : api.messages) === null || _c === void 0 ? void 0 : _c.failed) !== null && _d !== void 0 ? _d : result.msg || __('fetchFailed'), result.msgTimeout !== undefined ? {
                closeButton: true,
            ...
            delete this.reloadCancel;
            data = amisCore.normalizeApiResponseData(result.data);
            // 说明返回的是数据接口。
            if (!data.series && this.props.config) {
              ctx_1 = amisCore.createObject(this.props.data, data);
            ...
            curInterval && this.mounted && (this.timer = setTimeout(this.reload, Math.max(curInterval, 1000)));
  ...
  Chart.prototype.renderChart = function (config, data) {
    ...
    try {
      onDataFilter && (config = onDataFilter(config, window.echarts, data) || config);
    } catch (e) {
      console.warn(e);
    }
    if (config) {
        ...
        return tslib.__generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [4 /*yield*/, dispatchEvent('finished', amisCore.createObject(data, {}, {
                echarts: {
                  value: this.echarts,
                  enumerable: false,
                  configurable: true,
  ...
  Chart.prototype.render = function () {
    ...
    return _J$X_("div", {
      className: cx__default["default"]("".concat(ns, "Chart"), className, amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), {
...
var ChartRenderer = /** @class */function (_super) {
  ...
  ChartRenderer = tslib.__decorate([amisCore.Renderer({
    type: 'chart',
    storeType: amisCore.ServiceStore.name
  }), tslib.__metadata("design:paramtypes", [Object, Object])], ChartRenderer);
