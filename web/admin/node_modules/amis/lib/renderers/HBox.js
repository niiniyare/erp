...
;var HBox = /** @class */function (_super) {
  ...
  HBox.prototype.renderColumn = function (column, key, length) {
    ...
    return _J$X_("div", {
      key: key,
      className: cx("Hbox-col", style.width === 'auto' ? 'Hbox-col--auto' : style.width ? 'Hbox-col--customWidth' : '', (_a = {}, _a["Hbox-col--v".concat(amisCore.ucFirst(column.valign))] = column.valign, _a), column.columnClassName),
      style: style
    }, itemRender ? itemRender(column, key, length, this.props) : this.renderChild("column/".concat(key), column.body, {
  ...
  HBox.prototype.render = function () {
    ...
    var _b = this.props,
      ...
      hAlign = _b.align;
    return _J$X_("div", {
      className: cx("Hbox", className, (_a = {}, _a["Hbox--".concat(gap)] = gap, _a["Hbox--v".concat(amisCore.ucFirst(vAlign))] = vAlign, _a["Hbox--h".concat(amisCore.ucFirst(hAlign))] = hAlign, _a)),
      style: style
    }, this.renderColumns());
  };
...
var HBoxRenderer = /** @class */function (_super) {
  ...
  HBoxRenderer = tslib.__decorate([amisCore.Renderer({
    type: 'hbox'
  })], HBoxRenderer);
  return HBoxRenderer;
}(HBox);
