...
export default class Table<T extends TableProps = TableProps> extends React.Component<T, object> {
    ...
    static syncRows(store: ITableStore, props: TableProps, prevProps?: TableProps, forceUpdateRows?: boolean): boolean;
    componentDidMount(): void;
    loadDeferredRow(row: IRow): Promise<void>;
    autoFillHeightDispose?: () => void;
    autoFillHeightDispose2?: () => void;
    initAutoFillHeight(): void;
    /**
     * 自动设置表格高度占满界面剩余区域
...
export declare class TableRendererBase<T extends TableProps = TableProps> extends Table<T> {
...
export declare class TableRenderer extends TableRendererBase {
}
export { TableCell };
