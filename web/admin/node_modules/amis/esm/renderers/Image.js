...
import { autobind, themeable, localeable, setThemeClassName, handleAction, createObject, isPureVariable, resolveVariableAndFilter, filter, getPropValue, CustomStyle, ScopedContext, Renderer } from 'amis-core';
...
var ImageThumb = /** @class */ (function (_super) {
    ...
    ImageThumb.prototype.render = function () {
        ...
        var imageContent = (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "mask", style: { background: this.props.maskColor } },
        ...
        var image = (React.createElement("div", { className: cx('Image', imageMode === 'original' ? 'Image--original' : 'Image--thumb', className, imageControlClassName), style: href ? undefined : style },
            imageMode === 'original' ? (React.createElement("div", { className: "\n            ".concat(cx('Image-origin', thumbMode ? "Image-origin--".concat(thumbMode) : '', imageContentClassName), " ").concat(this.props.hoverMode, " Img-container"), style: { height: height, width: width } },
                imageContent,
                ...
                React.createElement("div", { className: cx('Image-thumb', thumbClassName, thumbMode ? "Image-thumb--".concat(thumbMode) : '', thumbRatio
                        ...
                        : '', imageContentClassName, 'Img-container', this.props.hoverMode), style: { height: height, width: width } }, imageContent),
                enlarge)),
            (title || caption) && !this.props.hoverMode && !this.props.sortType ? (React.createElement("div", { key: "caption", className: cx('Image-info') },
...
export { ImageField, ImageFieldRenderer, ImageThumb, ThemedImageThumb as default, imagePlaceholder };
