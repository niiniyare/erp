...
var ProgressField = /** @class */ (function (_super) {
    ...
    ProgressField.prototype.render = function () {
        var _a = this.props, data = _a.data, mode = _a.mode, className = _a.className, style = _a.style, placeholder = _a.placeholder, progressClassName = _a.progressClassName, map = _a.map, stripe = _a.stripe, animate = _a.animate, showLabel = _a.showLabel, strokeWidth = _a.strokeWidth, gapDegree = _a.gapDegree, gapPosition = _a.gapPosition, cx = _a.classnames, threshold = _a.threshold, showThresholdText = _a.showThresholdText;
...
export { ProgressField, ProgressFieldRenderer };
