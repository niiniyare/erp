...
var Service = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        clearTimeout(this.timer);
                        if (!isEffectiveApi(schemaApi, store.data)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3:
                        if (!isEffectiveApi(api, store.data)) return [3 /*break*/, 6];
                    ...
                    case 7:
                        _c.sent();
                        _c.label = 8;
                    case 8: return [2 /*return*/, store.data];
                }
            });
        });
    };
    ...
    Service.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ className: cx("".concat(ns, "Service"), className), style: style }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
            ...
            'modal', __assign(__assign({}, store.dialogSchema), { type: 'dialog' }), {
                key: 'dialog',
...
export { ServiceRenderer, Service as default, eventTypes };
