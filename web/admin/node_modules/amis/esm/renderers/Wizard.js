...
import { isEffectiveApi, until, toNumber, tokenize, createObject, isApiOutdated, evalExpressionWithConditionBuilderAsync, filter, filterTarget, SkipOperation, isVisible, autobind, evalExpression, ScopedContext, Renderer, ServiceStore } from 'amis-core';
...
var Wizard = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(isEffectiveApi(initApi, store.data) && this.state.currentStep === 1)) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        if (value_1 &&
                            value_1.data &&
                            (typeof value_1.data.step === 'number' ||
                                (typeof value_1.data.step === 'string' &&
                                    /^\d+$/.test(value_1.data.step)))) {
                            state.currentStep = toNumber(value_1.data.step, 1);
                        }
                        this.setState(state, function () {
                            // 如果 initApi 返回的状态是正在提交，则进入轮顺状态。
                            if (value_1 &&
                                value_1.data &&
                                (value_1.data.submiting || value_1.data.submited)) {
                                _this.checkSubmit();
                            }
                        });
                        _c.label = 2;
    ...
    Wizard.prototype.renderFooter = function () {
        ...
        return (React.createElement("div", { role: "wizard-footer", className: cx('Wizard-footer', wrapWithPanel ? 'Panel-footer' : '', affixFooter && wrapWithPanel ? 'Panel-fixedBottom' : '', footerClassName) }, actions));
    };
...
export { WizardRenderer, Wizard as default };
