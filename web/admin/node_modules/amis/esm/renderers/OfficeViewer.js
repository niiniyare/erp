...
var OfficeViewer = /** @class */ (function (_super) {
    ...
    OfficeViewer.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, __ = _a.translate, className = _a.className, _b = _a.loading, loading = _b === void 0 ? false : _b, src = _a.src, name = _a.name, display = _a.display, loadingConfig = _a.loadingConfig;
...
export { OfficeViewerRenderer, OfficeViewer as default };
