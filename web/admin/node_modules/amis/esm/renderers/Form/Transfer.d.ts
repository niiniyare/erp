...
export interface BaseTransferControlSchema extends FormOptionsSchema, SpinnerExtraProps {
    /**
     * 是否显示剪头
     */
    showArrow?: boolean;
...
export declare class BaseTransferRenderer<T extends OptionsControlWithSpinnerProps = BaseTransferProps> extends React.Component<T> {
    ...
    getResult(payload: any): any;
    handleSearch(term: string, cancelExecutor: Function, targetPage?: {
        page: number;
        perPage?: number;
    }): Promise<{
        items: any;
