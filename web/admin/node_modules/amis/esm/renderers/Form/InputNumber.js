...
import { normalizeOptions, getVariable, resolveEventData, filter, numberReverter, numberFormatter, setThemeClassName, CustomStyle, formatInputThemeCss, autobind, FormItem } from 'amis-core';
...
var NumberControl = /** @class */ (function (_super) {
    ...
    NumberControl.prototype.render = function () {
        ...
        var formatter = kilobitSeparator || prefix || suffix
            ? function (value, _a) {
                var _b, _c;
                var userTyping = _a.userTyping, input = _a.input;
                // 增加千分分隔
                if (kilobitSeparator && value) {
                    if ((userTyping || _this.input === document.activeElement) &&
                        numberReverter(value) === numberReverter((_b = _this.input) === null || _b === void 0 ? void 0 : _b.value)) {
                ...
                if (suffix &&
                    userTyping &&
                    ((_c = _this.input) === null || _c === void 0 ? void 0 : _c.selectionStart) === input.length) {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "NumberControl"), (_a = {},
            ...
            Array.isArray(unitOptions) && unitOptions.length !== 0 ? (unitOptions.length > 1 ? (React.createElement(Select, { value: unit, clearable: false, options: this.state.unitOptions || [], onChange: this.handleChangeUnit, className: "".concat(ns, "NumberControl-unit"), disabled: disabled, popOverContainer: popOverContainer })) : (React.createElement("div", { className: cx("".concat(ns, "NumberControl-unit"), "".concat(ns, "NumberControl-single-unit"), "".concat(ns, "Select"), "".concat(readOnly ? "".concat(ns, "NumberControl-readonly") : '')) }, typeof unitOptions[0] === 'string'
                ? unitOptions[0]
...
export { NumberControlRenderer, NumberControl as default };
