...
var TextControl = /** @class */ (function (_super) {
    ...
    TextControl.prototype.renderNormal = function () {
        var _a;
        var _b, _c;
        var _d = this.props, ns = _d.classPrefix, cx = _d.classnames, className = _d.className, style = _d.style, inputControlClassName = _d.inputControlClassName, nativeInputClassName = _d.nativeInputClassName, inputOnly = _d.inputOnly, value = _d.value, placeholder = _d.placeholder, onChange = _d.onChange, disabled = _d.disabled, readOnly = _d.readOnly, max = _d.max, min = _d.min, step = _d.step, clearable = _d.clearable, _e = _d.revealPassword, revealPassword = _e === void 0 ? true : _e, name = _d.name, borderMode = _d.borderMode, prefix = _d.prefix, suffix = _d.suffix, data = _d.data, showCounter = _d.showCounter, maxLength = _d.maxLength, minLength = _d.minLength, themeCss = _d.themeCss, css = _d.css, id = _d.id, nativeAutoComplete = _d.nativeAutoComplete, testIdBuilder = _d.testIdBuilder;
...
export { EmailControlRenderer, TextControlRenderer, UrlControlRenderer, TextControl as default, mapItemIndex };
