...
var SelectControl = /** @class */ (function (_super) {
    ...
    SelectControl.prototype.handleOptionAdd = function (idx, value, skipForm, callback) {
        ...
        var _a = this.props, onAdd = _a.onAdd, autoComplete = _a.autoComplete;
        onAdd === null || onAdd === void 0 ? void 0 : onAdd(idx, value, skipForm, function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    SelectControl.prototype.handleOptionEdit = function (value, origin, skipForm, callback) {
        var _this = this;
        var _a = this.props, onEdit = _a.onEdit, autoComplete = _a.autoComplete;
        onEdit === null || onEdit === void 0 ? void 0 : onEdit(value, origin, skipForm, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        callback === null || callback === void 0 ? void 0 : callback(value);
    ...
    SelectControl.prototype.handleOptionDelete = function (value, callback) {
        var _this = this;
        var _a = this.props, onDelete = _a.onDelete, autoComplete = _a.autoComplete;
        onDelete === null || onDelete === void 0 ? void 0 : onDelete(value, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        callback === null || callback === void 0 ? void 0 : callback(value);
    ...
    SelectControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, autoComplete = _a.autoComplete, searchable = _a.searchable, showInvalidMatch = _a.showInvalidMatch, options = _a.options, className = _a.className, popoverClassName = _a.popoverClassName, style = _a.style, loading = _a.loading, value = _a.value, selectedOptions = _a.selectedOptions, multi = _a.multi, multiple = _a.multiple, placeholder = _a.placeholder, id = _a.id, classPrefix = _a.classPrefix, classnames = _a.classnames, creatable = _a.creatable, inline = _a.inline, noResultsText = _a.noResultsText, render = _a.render, menuTpl = _a.menuTpl, borderMode = _a.borderMode, selectMode = _a.selectMode, env = _a.env, mobileUI = _a.mobileUI, overlay = _a.overlay, filterOption = _a.filterOption, rest = __rest(_a, ["autoComplete", "searchable", "showInvalidMatch", "options", "className", "popoverClassName", "style", "loading", "value", "selectedOptions", "multi", "multiple", "placeholder", "id", "classPrefix", "classnames", "creatable", "inline", "noResultsText", "render", "menuTpl", "borderMode", "selectMode", "env", "mobileUI", "overlay", "filterOption"]);
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], SelectControl.prototype, "handleOptionAdd", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Boolean, Function]),
        __metadata("design:returntype", void 0)
    ], SelectControl.prototype, "handleOptionEdit", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Function]),
        __metadata("design:returntype", void 0)
    ], SelectControl.prototype, "handleOptionDelete", null);
    __decorate([
        supportStatic(),
        __metadata("design:type", Function),
...
export { MultiSelectControlRenderer, SelectControlRenderer, SelectControl as default };
