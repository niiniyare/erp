...
var EditorControl = /** @class */ (function (_super) {
    ...
    EditorControl.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, style = _b.style, ns = _b.classPrefix, cx = _b.classnames, value = _b.value, onChange = _b.onChange, disabled = _b.disabled, options = _b.options, editorTheme = _b.editorTheme, theme = _b.theme, size = _b.size, data = _b.data, allowFullscreen = _b.allowFullscreen, placeholder = _b.placeholder;
...
export { EditorControlRenderer, EditorControls, availableLanguages, EditorControl as default };
