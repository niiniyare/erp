...
var UserSelectControl = /** @class */ (function (_super) {
    ...
    UserSelectControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, showNav = _a.showNav, navTitle = _a.navTitle, searchable = _a.searchable, options = _a.options, className = _a.className, style = _a.style, selectedOptions = _a.selectedOptions, tabOptions = _a.tabOptions, multi = _a.multi, multiple = _a.multiple, isDep = _a.isDep, isRef = _a.isRef, placeholder = _a.placeholder, searchPlaceholder = _a.searchPlaceholder, tabMode = _a.tabMode, data = _a.data, displayFields = _a.displayFields, labelField = _a.labelField, loadingConfig = _a.loadingConfig, disabled = _a.disabled;
        ...
        return (React.createElement("div", { className: cx("UserSelectControl", className) }, tabMode ? (React.createElement(UserTabSelect, { selection: selectedOptions, tabOptions: tabOptions, multiple: multiple, displayFields: displayFields, onChange: this.changeValue, onSearch: this.onSearch, deferLoad: this.deferLoad, data: data, disabled: disabled })) : (React.createElement(UserSelect, { loadingConfig: loadingConfig, showNav: showNav, navTitle: navTitle, selection: selectedOptions, options: options, multi: multi, multiple: multiple, searchable: searchable, placeholder: placeholder, searchPlaceholder: searchPlaceholder, deferLoad: this.deferLoad, onChange: this.changeValue, onSearch: this.onSearch, displayFields: displayFields, labelField: labelField, isDep: isDep, isRef: isRef, disabled: disabled }))));
    };
...
export { UserSelectControlRenderer, UserSelectControl as default };
