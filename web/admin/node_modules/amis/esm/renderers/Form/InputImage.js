...
import { isEmpty, guid, localeFormatter, prettyBytes, dataMapping, buildApi, createObject, qsparse, qsstringify, resolveEventData, filter, setThemeClassName, CustomStyle, FormItem, isEffectiveApi, isApiOutdated, isApiOutdatedWithData } from 'amis-core';
...
var ImageControl = /** @class */ (function (_super) {
    ...
    ImageControl.prototype.handleDropRejected = function (rejectedFiles, evt) {
        ...
        var _b = this.props, accept = _b.accept, multiple = _b.multiple, onChange = _b.onChange, maxLength = _b.maxLength, maxSize = _b.maxSize, __ = _b.translate, invalidTypeMessage = _b.invalidTypeMessage, invalidSizeMessage = _b.invalidSizeMessage;
    ...
    ImageControl.prototype.tick = function () {
        ...
        var _a = this.props, __ = _a.translate, multiple = _a.multiple;
    ...
    ImageControl.prototype.handleCrop = function () {
        var _this_1 = this;
        var _a;
        var _b = this.props, cropFormat = _b.cropFormat, cropQuality = _b.cropQuality;
            ...
            cropFile ? (React.createElement("div", { className: cx('ImageControl-cropperWrapper') },
                ...
                React.createElement("div", { className: cx('ImageControl-croperToolbar') },
                    ...
                    React.createElement("a", { className: cx('ImageControl-cropConfirm'), onClick: this.handleCrop, "data-tooltip": __('confirm'), "data-position": "left" },
                        React.createElement(Icon, { icon: "check", className: "icon" }))))) : (React.createElement(DropZone, { key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, onFileDialogCancel: this.handleFileCancel, accept: accept, multiple: dropMultiple, disabled: disabled || isStatic }, function (_a) {
                ...
                return (React.createElement("div", __assign({}, getRootProps({
                    ...
                    isDragActive || isDragAccept || isDragReject ? (React.createElement("div", { className: cx('ImageControl-acceptTip', {
                            ...
                            files.map(function (file, key) { return (React.createElement("div", { key: "".concat(_this_1.getFileKey(file), "-").concat(key), className: cx('ImageControl-item', {
                                ...
                                React.createElement("div", { className: cx('Image--thumb') },
                                    React.createElement("div", { className: cx('Image-thumbWrap') },
                                        ...
                                        React.createElement("div", { className: cx('Image-overlay') },
                                            ...
                                            !disabled && !isStatic ? (React.createElement("a", { "data-tooltip": __('Select.clear'), "data-position": "bottom", onClick: _this_1.removeFile.bind(_this_1, file, key) },
                                ...
                                React.createElement(ThemedImageThumb, { key: "image", className: cx('ImageControl-image', fixedSize ? 'Image-thumb--fixed-size' : ''), onLoad: _this_1.handleImageLoaded.bind(_this_1, key), src: file.preview || file.url, alt: file.name, thumbMode: thumbMode, thumbRatio: thumbRatio, overlays: React.createElement(React.Fragment, null,
                                        ...
                                        !!crop &&
                                            reCropable !== false &&
                                            !disabled &&
                                            !isStatic ? (React.createElement("a", { "data-tooltip": __('Image.crop'), "data-position": "bottom", onClick: _this_1.editImage.bind(_this_1, key) },
                                            React.createElement(Icon, { icon: "pencil", className: "icon" }))) : null,
                                        !disabled && !isStatic ? (React.createElement("a", { "data-tooltip": __('Select.upload'), "data-position": "bottom", onClick: function () {
                        ...
                        !isStatic &&
                            !autoUpload &&
                            !hideUploadButton &&
                            files.length ? (React.createElement(Button, { level: "default", className: cx('ImageControl-uploadBtn'), disabled: !hasPending, onClick: _this_1.toggleUpload }, __(uploading ? 'File.pause' : 'File.start'))) : null,
