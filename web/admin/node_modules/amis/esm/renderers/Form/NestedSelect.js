...
import { getVariable, resolveEventData, string2regExp, labelToString, getTreeAncestors, renderTextByKeyword, flattenTree, getTreeParent, filterTree, getTreeDepth, RootClose, Overlay, PopOver, setThemeClassName, ucFirst, CustomStyle, autobind, OptionsControl } from 'amis-core';
...
var NestedSelectControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent(eventName, resolveEventData(this.props, __assign({ options: options, items: options, // 为了保持名字统一
                                value: value, selectedItems: multiple ? selectedOptions : selectedOptions[0] }, eventData)))];
                    case 1:
    ...
    NestedSelectControl.prototype.renderValue = function (option, key) {
        ...
        var optionText = labelToString(option[labelField || 'label']);
        var splitJoin = ' / ';
        var title = ancestors
            ? ancestors
                .map(function (item) { return labelToString(item[labelField || 'label']); })
                .join(splitJoin)
            : optionText;
        return (React.createElement("span", { className: cx('Select-valueLabel'), key: key || option[valueField || 'value'], title: title }, ancestors
            ? ancestors.map(function (item, index) {
                var label = labelToString(item[labelField || 'label']);
    ...
    NestedSelectControl.prototype.renderOptions = function () {
        ...
        return (React.createElement(React.Fragment, null, stack.map(function (options, index) { return (React.createElement("div", { key: index, className: cx('NestedSelect-menu', menuClassName), style: _this.getMenuSelectMenuStyle() },
            ...
            options.map(function (option, idx) {
                ...
                var label = labelToString(option[labelField || 'label']);
    ...
    NestedSelectControl.prototype.renderOuter = function () {
        var _this = this;
        var _a = this.props, popOverContainer = _a.popOverContainer, __ = _a.translate, cx = _a.classnames, options = _a.options, render = _a.render, id = _a.id, themeCss = _a.themeCss;
        ...
        return (React.createElement(Overlay, { target: this.getTarget, container: popOverContainer || (function () { return findDOMNode(_this); }), placement: 'auto', show: true },
            React.createElement(PopOver, { className: cx('NestedSelect-popover', setThemeClassName(__assign(__assign({}, this.props), { name: 'nestedSelectPopoverClassName', id: id, themeCss: themeCss }))) }, body)));
    };
    NestedSelectControl.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, style = _b.style, disabled = _b.disabled, cx = _b.classnames, multiple = _b.multiple, placeholder = _b.placeholder, __ = _b.translate, inline = _b.inline, searchable = _b.searchable, selectedOptions = _b.selectedOptions, clearable = _b.clearable, loading = _b.loading, borderMode = _b.borderMode, mobileUI = _b.mobileUI, popOverContainer = _b.popOverContainer, env = _b.env, testIdBuilder = _b.testIdBuilder, loadingConfig = _b.loadingConfig, maxTagCount = _b.maxTagCount, overflowTagPopover = _b.overflowTagPopover;
        var _c = this.props, ns = _c.classPrefix, themeCss = _c.themeCss, id = _c.id;
        return (React.createElement("div", { className: cx('NestedSelectControl', className), ref: this.outTarget, style: style },
            React.createElement(ResultBox, { mobileUI: mobileUI, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover, disabled: disabled, ref: this.domRef, placeholder: __(placeholder !== null && placeholder !== void 0 ? placeholder : 'placeholder.empty'), inputPlaceholder: '', className: cx("NestedSelect", (_a = {
                    ...
                    _a), setThemeClassName(__assign(__assign({}, this.props), { name: 'nestedSelectControlClassName', id: id, themeCss: themeCss }))), result: multiple
                    ? selectedOptions
                    : selectedOptions.length
                        ? selectedOptions[0]
...
export { CascaderSelectControlRenderer, NestedSelectControlRenderer, NestedSelectControl as default };
