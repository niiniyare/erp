...
var FileControl = /** @class */ (function (_super) {
    ...
    FileControl.prototype.handleDropRejected = function (rejectedFiles, evt) {
        ...
        var _a = this.props, multiple = _a.multiple, env = _a.env, accept = _a.accept, __ = _a.translate, invalidTypeMessage = _a.invalidTypeMessage;
        var nameField = this.props.nameField || 'name';
    ...
    FileControl.prototype.handleSelect = function () {
        var _a = this.props, disabled = _a.disabled, multiple = _a.multiple, maxLength = _a.maxLength, isStatic = _a.static;
        !disabled && !isStatic;
    ...
    FileControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('FileControl', className) },
            ...
            React.createElement(DropZone, { disabled: disabled || isStatic, key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, accept: accept === '*' ? '' : accept, multiple: multiple }, function (_a) {
                ...
                return (React.createElement("div", __assign({}, getRootProps({
                    ...
                    React.createElement("input", __assign({ disabled: disabled || isStatic }, getInputProps(), { capture: capture }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('input').getTestId())),
                    drag || isDragActive ? (React.createElement("div", { className: cx('FileControl-acceptTip'), onClick: _this.handleSelect },
                        ...
                        React.createElement("div", { className: cx('FileControl-acceptTip-help', 'TplField fr-view') }, documentLink ? (React.createElement("a", { href: documentLink, onClick: function (e) { return e.stopPropagation(); } }, documentation ? documentation : __('File.helpText'))) : null),
                        maxSize ? (React.createElement("div", { className: cx('FileControl-sizeTip') }, _this.sizeLimitTip(maxSize))) : null)) : !isStatic ? (React.createElement(React.Fragment, null,
                        React.createElement(Button, { level: "enhance", disabled: disabled, className: cx('FileControl-selectBtn', btnClassName, {
                            ...
                            React.createElement("span", null, !multiple && files.length
                                ...
                                : multiple && files.length
                                    ? __('File.continueAdd')
                                    : filter(btnLabel, data) || __('File.upload'))))) : null));
            }),
            description
                ...
                : null,
            maxSize && !drag ? (React.createElement("div", { className: cx('FileControl-sizeTip') }, this.sizeLimitTip(maxSize))) : null,
                    ...
                    React.createElement(TooltipWrapper, { placement: "top", container: container || (env === null || env === void 0 ? void 0 : env.getModalContainer), tooltipClassName: cx('FileControl-list-tooltip', (file.state === 'invalid' || file.state === 'error') &&
                            ...
                            ? file.error ||
                                (maxSize && file.size > maxSize
                                    ? _this.sizeLimitTip(maxSize, file)
                                    : '')
                            : filename },
                        React.createElement("div", { className: cx('FileControl-itemInfo', {
                            ...
                            !disabled && !isStatic ? (React.createElement("a", { "data-tooltip": __('Select.clear'), "data-position": "left", className: cx('FileControl-clear'), onClick: function () { return _this.removeFile(file, index); } },
            ...
            failed ? (React.createElement("div", { className: cx('FileControl-sum') },
                ...
                __('File.failed'))) : null,
            !isStatic && !autoUpload && !hideUploadButton && files.length ? (React.createElement(Button, { level: "default", testIdBuilder: testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getChild('upload'), disabled: !hasPending, className: cx('FileControl-uploadBtn', btnUploadClassName), onClick: this.toggleUpload }, __(uploading ? 'File.pause' : 'File.start'))) : null));
    };
