...
import { __read, __extends, __assign, __awaiter, __generator, __decorate, __metadata } from 'tslib';
import React from 'react';
import isNumber from 'lodash/isNumber';
import isObject from 'lodash/isObject';
import isEqual from 'lodash/isEqual';
import forEach from 'lodash/forEach';
import { isPureVariable, resolveVariableAndFilter, filter, resolveEventData, autobind, getVariable, stripNumber, isNumeric, FormItem } from 'amis-core';
...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        var _a;
        var _b = this.props, cx = _b.classnames, style = _b.style, value = _b.value, multiple = _b.multiple, type = _b.type, step = _b.step, ns = _b.classPrefix, disabled = _b.disabled, max = _b.max, min = _b.min, mobileUI = _b.mobileUI, unit = _b.unit, showInputUnit = _b.showInputUnit;
        var _value = multiple
            ? type === 'min'
...
var RangeControl = /** @class */ (function (_super) {
    ...
    RangeControl.prototype.componentDidUpdate = function (prevProps) {
        ...
        var _a = this.props, nextPropsValue = _a.value, multiple = _a.multiple, delimiter = _a.delimiter, nextPropsMin = _a.min, nextPropsMax = _a.max, data = _a.data, onChange = _a.onChange;
    ...
    RangeControl.prototype.render = function () {
        ...
        var ns = props.classPrefix, multiple = props.multiple, parts = props.parts, showInput = props.showInput, cx = props.classnames, className = props.className, disabled = props.disabled, clearable = props.clearable, min = props.min, max = props.max, render = props.render, marks = props.marks, region = props.region, mobileUI = props.mobileUI;
        // 处理自定义json配置
...
export { Input, RangeControlRenderer, RangeControl as default, formatValue };
