...
import { evalExpression, createObject, isPureVariable, resolveVariableAndFilter, autobind, FormItem } from 'amis-core';
...
var ConditionBuilderControl = /** @class */ (function (_super) {
    ...
    ConditionBuilderControl.prototype.render = function () {
        var _a = this.props, className = _a.className, cx = _a.classnames, style = _a.style, pickerIcon = _a.pickerIcon, env = _a.env, popOverContainer = _a.popOverContainer, mobileUI = _a.mobileUI, rest = __rest(_a, ["className", "classnames", "style", "pickerIcon", "env", "popOverContainer", "mobileUI"]);
        // 处理一下formula类型值的变量列表
        ...
        return (React.createElement("div", { className: cx("ConditionBuilderControl", { 'is-mobile': mobileUI }, className) },
            React.createElement(ConditionBuilderWithRemoteOptions, __assign({ renderEtrValue: this.renderEtrValue, pickerIcon: this.renderPickerIcon(), isAddBtnVisibleOn: this.getAddBtnVisible, isAddGroupBtnVisibleOn: this.getAddGroupBtnVisible, popOverContainer: popOverContainer || env.getModalContainer }, rest, { placeholder: rest.placeholder, formula: formula }))));
    };
    __decorate([
        autobind,
...
var ConditionBuilderWithRemoteOptions = withRemoteConfig({
    ...
    class_1.prototype.render = function () {
        var _a = this.props, loading = _a.loading, config = _a.config, deferLoad = _a.deferLoad, disabled = _a.disabled, renderEtrValue = _a.renderEtrValue, rest = __rest(_a, ["loading", "config", "deferLoad", "disabled", "renderEtrValue"]);
...
export { ConditionBuilderRenderer, ConditionBuilderControl as default };
