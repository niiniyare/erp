...
var SubFormControl = /** @class */ (function (_super) {
    ...
    SubFormControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, multiple = _a.multiple, ns = _a.classPrefix, className = _a.className, style = _a.style, render = _a.render, mobileUI = _a.mobileUI, env = _a.env, popOverContainer = _a.popOverContainer;
...
export { SubFormControlRenderer, SubFormControl as default };
