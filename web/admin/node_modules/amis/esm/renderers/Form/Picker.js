...
import { __extends, __awaiter, __generator, __assign, __read, __decorate, __metadata } from 'tslib';
...
import { isApiOutdated, createObject, isPureVariable, resolveVariableAndFilter, isEffectiveApi, resolveEventData, setThemeClassName, getVariable, filter, noop, CustomStyle, autobind, OptionsControl } from 'amis-core';
import { OverflowTpl, Html, AutoFoldedList, Icon } from 'amis-ui';
...
var PickerControl = /** @class */ (function (_super) {
    ...
    PickerControl.prototype.renderTag = function (item, index) {
        var _this = this;
        var _a = this.props, _b = _a.itemClearable, itemClearable = _b === void 0 ? true : _b, ns = _a.classPrefix, cx = _a.classnames, labelField = _a.labelField, labelTpl = _a.labelTpl, __ = _a.translate, disabled = _a.disabled, env = _a.env, id = _a.id, themeCss = _a.themeCss, css = _a.css;
        return (React.createElement("div", { key: index, className: cx("".concat(ns, "Picker-value"), setThemeClassName(__assign(__assign({}, this.props), { name: 'pickValueWrapClassName', id: id, themeCss: themeCss || css })), {
            ...
            itemClearable && (React.createElement("span", { className: cx("".concat(ns, "Picker-valueIcon"), setThemeClassName(__assign(__assign({}, this.props), { name: 'pickValueIconClassName', id: id, themeCss: themeCss || css }))), onClick: function (e) {
                    e.stopPropagation();
                    _this.removeItem(index);
                } }, "\u00D7")),
            React.createElement(OverflowTpl, { inline: false, tooltip: getVariable(item, labelField || 'label') },
    ...
    PickerControl.prototype.renderValues = function () {
        ...
        var tooltipProps = __assign({ tooltipClassName: cx('Picker-overflow', overflowTagPopover === null || overflowTagPopover === void 0 ? void 0 : overflowTagPopover.tooltipClassName), title: __('已选项') }, omit(overflowTagPopover, ['children', 'content', 'tooltipClassName']));
        return (React.createElement(AutoFoldedList, { enabled: !!enableOverflow, tooltipClassName: cx('Picker-overflow-wrapper'), items: tags, popOverContainer: popOverContainer, tooltipOptions: tooltipProps, maxVisibleCount: maxTagCount, renderItem: function (item, index, folded) {
    ...
    PickerControl.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, modalClassName = _a.modalClassName, cx = _a.classnames, disabled = _a.disabled, render = _a.render, modalMode = _a.modalMode, source = _a.source, modalSize = _a.modalSize, clearable = _a.clearable, multiple = _a.multiple, placeholder = _a.placeholder, embed = _a.embed, selectedOptions = _a.selectedOptions, __ = _a.translate, popOverContainer = _a.popOverContainer, modalTitle = _a.modalTitle, data = _a.data, mobileUI = _a.mobileUI, env = _a.env, themeCss = _a.themeCss, css = _a.css, id = _a.id, ns = _a.classPrefix, testIdBuilder = _a.testIdBuilder;
        return (React.createElement("div", { className: cx("PickerControl", { 'is-mobile': mobileUI }, className) },
            embed ? (React.createElement("div", { className: cx('Picker') }, this.renderBody({ popOverContainer: popOverContainer }))) : (React.createElement("div", { className: cx("Picker", {
                ...
                React.createElement("div", { onClick: this.handleClick, className: cx('Picker-input', disabled && 'is-disabled', this.state.isFocused && 'is-focused', setThemeClassName(__assign(__assign({}, this.props), { name: 'pickControlClassName', id: id, themeCss: themeCss || css }))) },
                    !selectedOptions.length && placeholder ? (React.createElement("div", { className: cx('Picker-placeholder') }, __(placeholder))) : (React.createElement("div", __assign({ className: cx('Picker-valueWrap') }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId()),
                        this.renderValues(),
                        React.createElement("input", { onChange: noop, value: '', ref: this.input, onKeyDown: this.handleKeyDown, onClick: this.handleFocus, onBlur: this.handleBlur, readOnly: mobileUI }))),
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], PickerControl.prototype, "overrideCRUDProps", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
...
export { PickerControlRenderer, PickerControl as default };
