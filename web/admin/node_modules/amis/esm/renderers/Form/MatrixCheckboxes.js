...
import { buildApi, isValidApi, getVariable, setVariable, isEffectiveApi, resolveEventData, FormItem } from 'amis-core';
...
var MatrixCheckbox = /** @class */ (function (_super) {
    ...
    MatrixCheckbox.prototype.renderInput = function (forceDisabled) {
        ...
        var _b = this.props, rowLabel = _b.rowLabel, disabled = _b.disabled, cx = _b.classnames, multiple = _b.multiple, textAlign = _b.textAlign, xCheckAll = _b.xCheckAll, yCheckAll = _b.yCheckAll, testIdBuilder = _b.testIdBuilder, mobileUI = _b.mobileUI;
        var value = this.props.value || buildDefaultValue(columns, rows);
        return (React.createElement("div", { className: cx('Table m-b-none', { 'is-mobile': mobileUI }) },
    ...
    MatrixCheckbox.prototype.render = function () {
        var _a = this.props, className = _a.className, render = _a.render, cx = _a.classnames, loadingConfig = _a.loadingConfig;
...
export { MatrixRenderer, MatrixCheckbox as default };
