...
var SwitchControl = /** @class */ (function (_super) {
    ...
    SwitchControl.prototype.render = function () {
        var _a = this.props, size = _a.size, className = _a.className, style = _a.style, ns = _a.classPrefix, cx = _a.classnames, value = _a.value, trueValue = _a.trueValue, falseValue = _a.falseValue, onChange = _a.onChange, disabled = _a.disabled, loading = _a.loading, loadingConfig = _a.loadingConfig, testIdBuilder = _a.testIdBuilder;
...
export { SwitchControlRenderer, SwitchControl as default };
