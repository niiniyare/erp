...
var RichTextControl = /** @class */ (function (_super) {
    ...
    RichTextControl.prototype.render = function () {
        var _a, _b;
        var _c = this.props, className = _c.className, style = _c.style, ns = _c.classPrefix, value = _c.value, onChange = _c.onChange, disabled = _c.disabled, isStatic = _c.static, size = _c.size, vendor = _c.vendor, env = _c.env, locale = _c.locale, translate = _c.translate, borderMode = _c.borderMode;
