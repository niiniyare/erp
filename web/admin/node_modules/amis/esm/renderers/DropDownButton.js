...
import { resolveVariableAndFilter, createObject, isVisible, isDisabled, filterClassNameObject, RootClose, noop, Overlay, PopOver, setThemeClassName, filter, CustomStyle, Renderer } from 'amis-core';
...
var DropDownButton = /** @class */ (function (_super) {
    ...
    DropDownButton.prototype.renderButton = function (button, index) {
        var _a;
        var _this = this;
        var _b = this.props, render = _b.render, cx = _b.classnames, data = _b.data, ignoreConfirm = _b.ignoreConfirm, testIdBuilder = _b.testIdBuilder, mobileUI = _b.mobileUI;
        ...
        if (typeof button !== 'string' && Array.isArray(button === null || button === void 0 ? void 0 : button.children)) {
            return (React.createElement("div", { key: index, className: cx('DropDown-menu', { 'is-mobile': mobileUI }) },
    ...
    DropDownButton.prototype.renderOuter = function () {
        var _this = this;
        var _a;
        var _b = this.props, render = _b.render, _buttons = _b.buttons, data = _b.data, popOverContainer = _b.popOverContainer, popOverContainerSelector = _b.popOverContainerSelector, cx = _b.classnames, ns = _b.classPrefix, children = _b.children, body = _b.body, align = _b.align, closeOnClick = _b.closeOnClick, closeOnOutside = _b.closeOnOutside, menuClassName = _b.menuClassName, overlayPlacement = _b.overlayPlacement, trigger = _b.trigger, mobileUI = _b.mobileUI;
        var buttons = typeof _buttons === 'string'
            ? resolveVariableAndFilter(_buttons, data, '| raw')
            : _buttons;
        var popOverBody = (React.createElement(RootClose, { disabled: !this.state.isOpened, onRootClose: closeOnOutside !== false ? this.close : noop }, function (ref) {
            ...
            return (React.createElement("ul", { className: cx('DropDown-menu-root', 'DropDown-menu', {
                    'is-mobile': mobileUI
                }, menuClassName), onClick: closeOnClick ? _this.close : noop, onMouseEnter: _this.keepOpen, ref: ref, style: { width: (_a = _this.target) === null || _a === void 0 ? void 0 : _a.offsetWidth } }, children
                ? children
                : body
                    ? render('body', body)
        ...
        if (popOverContainer || popOverContainerSelector) {
            return (React.createElement(Overlay, { container: popOverContainer, containerSelector: popOverContainerSelector, target: function () { return _this.target; }, placement: overlayPlacement, show: true },
        ...
        return (React.createElement("div", { className: cx('DropDown ', {
            ...
            React.createElement(TooltipWrapper, { placement: placement, tooltip: disabled ? disabledTip : tooltip, container: tooltipContainer || (env === null || env === void 0 ? void 0 : env.getModalContainer), trigger: tooltipTrigger, rootClose: tooltipRootClose },
                React.createElement("button", __assign({ onClick: this.toogle, disabled: disabled || btnDisabled }, testIdBuilder === null || testIdBuilder === void 0 ? void 0 : testIdBuilder.getTestId(data), { className: cx('Button', btnClassName, typeof level === 'undefined'
                    ...
                    }, "Button--size-".concat(size), setThemeClassName(__assign(__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle })), setThemeClassName(__assign(__assign({}, this.props), { name: 'className', id: id, themeCss: themeCss }))) }),
                    React.createElement(Icon, { c: cx, icon: icon, className: cx('icon m-r-xs', setThemeClassName(__assign(__assign({}, this.props), { name: 'iconClassName', id: id, themeCss: themeCss }))) }),
                    typeof label === 'string' ? filter(label, data) : label,
                    rightIcon && (React.createElement(Icon, { cx: cx, icon: rightIcon, className: cx('icon m-l-xs', setThemeClassName(__assign(__assign({}, this.props), { name: 'iconClassName', id: id, themeCss: themeCss }))) })),
...
export { DropDownButtonRenderer, DropDownButton as default };
