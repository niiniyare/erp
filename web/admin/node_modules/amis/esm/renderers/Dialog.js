...
import { Spinner, Modal, Icon } from 'amis-ui';
    ...
    Dialog.prototype.render = function () {
        ...
        return (React.createElement(Wrapper, __assign({}, rest, { classPrefix: classPrefix, className: cx(className), style: style, draggable: store.isFullscreen ? false : draggable, size: size, height: height, width: width, isFullscreen: store.isFullscreen, modalClassName: cx(setThemeClassName(__assign(__assign({}, this.props), { name: 'dialogClassName', id: id, themeCss: themeCss })), store.isFullscreen ? 'Modal-fullScreen' : ''), modalMaskClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'dialogMaskClassName', id: id, themeCss: themeCss })), backdrop: "static", onHide: this.handleSelfClose, keyboard: closeOnEsc && !store.loading, closeOnEsc: closeOnEsc, closeOnOutside: !store.dialogOpen && closeOnOutside, show: show, onEntered: this.handleEntered, onExited: this.handleExited, container: env === null || env === void 0 ? void 0 : env.getModalContainer, enforceFocus: false, disabled: store.loading, overlay: overlay, dialogType: dialogType, cancelText: cancelText, confirmText: confirmText, confirmBtnLevel: confirmBtnLevel, cancelBtnLevel: cancelBtnLevel }),
            title && typeof title === 'string' ? (React.createElement("div", { className: cx('Modal-header', headerClassName, setThemeClassName(__assign(__assign({}, this.props), { name: 'dialogHeaderClassName', id: id, themeCss: themeCss }))) },
                ...
                allowFullscreen ? (React.createElement("a", { "data-tooltip": store.isFullscreen ? __('Dialog.reset') : __('Dialog.screen'), "data-position": "left", onClick: this.handleSelfScreen, className: cx('Modal-close Modal-screen') },
                    React.createElement(Icon, { icon: store.isFullscreen ? 'un-fullscreen' : 'full-screen', className: "icon" }))) : null,
...
export { DialogRenderer, Dialog as default };
