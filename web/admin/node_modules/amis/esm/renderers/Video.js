...
import { resolveVariable, padArr, filter, getPropValue, setThemeClassName, CustomStyle, autobind, Renderer } from 'amis-core';
...
var Video = /** @class */ (function (_super) {
    ...
    Video.prototype.renderPlayer = function () {
        var _a = this.props, poster = _a.poster, autoPlay = _a.autoPlay, muted = _a.muted, name = _a.name, data = _a.data, loop = _a.loop, isLive = _a.isLive, minVideoDuration = _a.minVideoDuration, videoType = _a.videoType, playerClassName = _a.playerClassName, ns = _a.classPrefix, aspectRatio = _a.aspectRatio, rates = _a.rates, cx = _a.classnames;
        ...
        return (React.createElement("div", { className: cx('Video-player', playerClassName) },
            React.createElement(Player, { ref: this.playerRef, poster: filter(poster, data, '| raw'), src: src, autoPlay: autoPlay, muted: muted, onPlay: this.handleVideoPlay, onPause: this.handleVideoPause, onEnded: this.handleVideoEnded, aspectRatio: aspectRatio, loop: loop },
    ...
    Video.prototype.render = function () {
        var _a = this.props, splitPoster = _a.splitPoster, className = _a.className, style = _a.style, ns = _a.classPrefix, cx = _a.classnames, themeCss = _a.themeCss, id = _a.id, wrapperCustomStyle = _a.wrapperCustomStyle;
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: cx("Video", className, setThemeClassName(__assign(__assign({}, this.props), { name: 'baseControlClassName', themeCss: themeCss, id: id }))), onClick: this.onClick, style: style },
                this.renderFrames(),
    ...
    ], Video.prototype, "handleVideoPlay", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Array, Object, String]),
        __metadata("design:returntype", Promise)
    ], Video.prototype, "handleVideoPause", null);
    __decorate([
        autobind,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", Promise)
    ], Video.prototype, "handleVideoEnded", null);
    return Video;
}(React.Component));
...
export { FlvSource, HlsSource, VideoRenderer, Video as default };
