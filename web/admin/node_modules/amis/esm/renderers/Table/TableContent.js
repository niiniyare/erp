...
var TableContent = /** @class */ (function (_super) {
    ...
    TableContent.prototype.render = function () {
        ...
        return (React.createElement("div", { onMouseMove: onMouseMove, className: cx('Table-content', className), onScroll: onScroll },
            React.createElement("table", { ref: tableRef, className: cx(tableClassName) },
...
var TableContent$1 = observer(function (props) {
    ...
    return (React.createElement(TableContent, __assign({}, props, { className: className, tableClassName: tableClassName, columnWidthReady: store.columnWidthReady, someChecked: store.someChecked, allChecked: store.allChecked, isSelectionThresholdReached: store.isSelectionThresholdReached, orderBy: store.orderBy, orderDir: store.orderDir })));
});
