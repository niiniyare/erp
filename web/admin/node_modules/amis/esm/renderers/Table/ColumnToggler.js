...
var ColumnToggler = /** @class */ (function (_super) {
    ...
    ColumnToggler.prototype.moveColumn = function (oldIndex, newIndex) {
        var columns = __spreadArray([], __read(this.state.tempColumns), false);
    ...
    ColumnToggler.prototype.renderModal = function () {
        var _this = this;
        var _a = this.props, render = _a.render, cx = _a.classnames, ns = _a.classPrefix, modalContainer = _a.modalContainer, draggable = _a.draggable, overlay = _a.overlay, __ = _a.translate, footerBtnSize = _a.footerBtnSize, children = _a.children, modalSize = _a.modalSize, modalWidth = _a.modalWidth, modalHeight = _a.modalHeight, modalColumnCount = _a.modalColumnCount, env = _a.env;
        ...
        if (modalColumnCount)
            listClasses.push("ColumnToggler-modal-content--column-".concat(modalColumnCount));
        return (React.createElement(React.Fragment, null,
            React.createElement(Modal, { closeOnEsc: true, onHide: this.close, show: this.state.isOpened, contentClassName: cx('ColumnToggler-modal'), container: modalContainer || this.target, overlay: typeof overlay === 'boolean' ? overlay : false, draggable: true, size: modalSize, style: style },
                React.createElement("header", { className: cx('ColumnToggler-modal-header') },
                    React.createElement("span", { className: cx('ColumnToggler-modal-title') }, enableSorting
                ...
                React.createElement("ul", { className: cx(listClasses), ref: this.dragRef }, Array.isArray(tempColumns)
