...
export default class Page extends React.Component<PageProps> {
    ...
    renderContent(subProps: any): React.JSX.Element;
    render(): React.JSX.Element;
}
export declare class PageRendererBase extends Page {
    static contextType: React.Context<IScopedContext>;
    constructor(props: PageProps, context: IScopedContext);
    componentWillUnmount(): void;
    reloadTarget(target: string, data?: any): void;
    handleAction(e: React.UIEvent<any>, action: ActionObject, ctx: object, throwErrors?: boolean, delegate?: IScopedContext): Promise<any>;
...
export declare class PageRenderer extends PageRendererBase {
}
export {};
