...
function interpolateColor(start, end, percent) {
    var r = Math.min(255, start.r + (end.r - start.r) * percent);
    var g = Math.min(255, start.g + (end.g - start.g) * percent);
    var b = Math.min(255, start.b + (end.b - start.b) * percent);
    return "".concat(rgbToHex(r, g, b));
}

export { Color, interpolateColor, rgbTint };
