...
import { parseSize, LengthUsage } from '../../word/parse/parseSize.js';
                ...
                for (var _b = __values(element.children), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    switch (tagName) {
                        ...
                        case 'a:noFill':
                            ...
                            break;
                        case 'a:solidFill':
                            shapePr.fillColor = parseChildColor(function (c) { return word.getThemeColor(c); }, child);
                            break;
                        default:
