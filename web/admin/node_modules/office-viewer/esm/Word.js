...
import { parseRelationships } from './word/parse/parseRelationship.js';
...
import renderDocument from './word/render/renderDocument.js';
...
import { renderStyle } from './word/render/renderStyle.js';
import { mergeRun } from './util/mergeRun.js';
import { WDocument } from './openxml/word/WDocument.js';
import { updateVariableText } from './word/render/renderRun.js';
...
import { renderFont } from './word/render/renderFont.js';
import { replaceT, replaceVar } from './util/replaceVar.js';
import { parseFootnotes } from './word/parse/Footnotes.js';
import { parseEndnotes } from './word/parse/parseEndnotes.js';
import { renderNotes } from './word/render/renderNotes.js';
...
var Word = /** @class */ (function () {
    ...
    Word.prototype.updateOptions = function (options) {
        this.renderOptions = __assign(__assign({}, defaultRenderOptions), options);
    ...
    Word.prototype.initTheme = function () {
        var e_1, _a;
        try {
            for (var _b = __values(this.contentTypes.overrides), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        blob = this.parser.generateZipBlob(buildXML(documentData));
