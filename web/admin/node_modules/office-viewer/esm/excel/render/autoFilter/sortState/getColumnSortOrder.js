 ...
 * 获取配置中这一列的排序状态
 */
function getColumnSortOrder(colIndex, rangeRef, sortState) {
    var e_1, _a;
    if (!sortState) {
        return 'none';
    }
    try {
        for (var _b = __values(sortState.sortCondition || []), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            var conditionRangeRef = parseRange(ref);
            var startCol = rangeRef.startCol, endCol = rangeRef.endCol;
