...
import { AutoFilterIconUI } from './AutoFilterIconUI.js';
...
function renderAutoFilterIcon(sheet, autoFilter, id, dataContainer, headerRowCount) {
    ...
    for (var i = startCol; i <= endCol; i++) {
        ...
        var filterIcon = new AutoFilterIconUI(sheet, dataContainer, autoFilter, rangeRef, colIndex, fid, headerRowCount);
