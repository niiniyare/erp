...
import { SortButtonUI } from './SortButtonUI.js';
import { getColumnSortOrder } from './getColumnSortOrder.js';
import { setColumnSortOrder } from './setColumnSortOrder.js';
...
var SortStateUI = /** @class */ (function () {
    function SortStateUI(autoFilterIcon, container, sheet, autoFilter, rangeRef, colIndex, headerRowCount) {
        ...
        this.sheet = sheet;
        var sortAscButton = new SortButtonUI(sortContainer, sheet.translate('autoFilter.sortAscending'), function (checked) {
            _this.clickButton('asc');
        }, false, Icons.sortUP);
        this.sortAscButton = sortAscButton;
        var sortDescButton = new SortButtonUI(sortContainer, sheet.translate('autoFilter.sortDescending'), function (checked) {
            _this.clickButton('desc');
        }, false, Icons.sortDown);
    ...
    SortStateUI.prototype.clickButton = function (sortState) {
        ...
        setColumnSortOrder(sheet, colIndex, rangeRef, autoFilter, sortState, headerRowCount);
        this.sheet
            .getWorkbook()
    ...
    SortStateUI.prototype.syncButtonActive = function () {
        ...
        var rangeRef = this.rangeRef;
        var autoFilter = this.autoFilter;
        var columnSortState = getColumnSortOrder(colIndex, rangeRef, autoFilter.sortState);
