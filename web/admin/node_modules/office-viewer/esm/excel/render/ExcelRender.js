...
import { drawCells } from './cell/drawCells.js';
import { drawRowColHeaders } from './header/drawRowColHeaders.js';
import { debounce } from '../../util/debounce.js';
import { drawFrozen } from './cell/frozen/drawFrozen.js';
import { SelectionCanvas } from './SelectionCanvas.js';
import { updateCursor } from './selection/updateCursor.js';
import { handleMousedown, dragState } from './dnd/handleMousedown.js';
import { drawDrawing } from './drawing/drawDrawing.js';
import { drawSparkline } from './sparkline/drawSparkline.js';
import { isPointerOnLink } from './cell/isPointerOnLink.js';
import { ResizeBox } from './drawing/ResizeBox.js';
import { renderAutoFilter } from './autoFilter/renderAutoFilter.js';
import { getMouseRelativePosition } from './dnd/getMouseRelativePosition.js';
import { CellEditor } from '../edit/ui/CellEditor.js';
import { getAllNotAvailableFont } from './cell/checkFont.js';
import { inValidTextSizeCache } from './cell/measureTextWithCache.js';
...
var ExcelRender = /** @class */ (function () {
    ...
    ExcelRender.prototype.handleMousedown = function (event) {
        ...
        var hitTestResult = this.workbook
            ...
            .hitTest(offsetX, offsetY);
        if (hitTestResult) {
            handleMousedown(this.workbook, hitTestResult, this.contentContainer, event);
        }
    };
    /**
    ...
    ExcelRender.prototype.handleMouseup = function (event) {
        ...
        var _a = this.getMouseRelativePosition(event), offsetX = _a.offsetX, offsetY = _a.offsetY;
        var pointerOnLink = isPointerOnLink(offsetX, offsetY, this.linkPositionCache);
        if (pointerOnLink) {
    ...
    ExcelRender.prototype.getMouseRelativePosition = function (event) {
        var _a = getMouseRelativePosition(this.contentContainer, event), offsetX = _a.offsetX, offsetY = _a.offsetY;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        // 绘制网格线
                        drawGridLines(currentSheet, viewRange, mainCanvas, height, width, this.renderOptions);
                        // 绘制 Sparkline，这个要在单元格前面
                        drawSparkline(currentSheet, viewRange, mainCanvas);
                        // 绘制单元格
                        drawCells(this, currentSheet, this.renderOptions, mainCanvas, displayData, this.linkPositionCache);
                        // 绘制自动筛选功能
                        renderAutoFilter(currentSheet, this.dataContainer);
                        // 绘制图片及文本框
                        drawDrawing(this, currentSheet, viewRange, mainCanvas);
                        // 表头晚于内容区绘制
                        drawRowColHeaders(currentSheet, viewRange, mainCanvas, this.renderOptions, this.defaultFontSize, this.dataProvider.getDefaultFontStyle());
                        frozenViewRange = drawFrozen(this, currentSheet, this.dataProvider, this.renderOptions, mainCanvas, height, width, this.linkPositionCache);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        notAvailableFonts = getAllNotAvailableFont();
                        needReDraw = false;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 7, 8, 9]);
                        notAvailableFonts_1 = __values(notAvailableFonts), notAvailableFonts_1_1 = notAvailableFonts_1.next();
                        _b.label = 2;
                    case 2:
