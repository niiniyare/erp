...
function isPointerOnLink(x, y, linkPositionCache) {
    var e_1, _a, e_2, _b;
    try {
        for (var linkPositionCache_1 = __values(linkPositionCache), linkPositionCache_1_1 = linkPositionCache_1.next(); !linkPositionCache_1_1.done; linkPositionCache_1_1 = linkPositionCache_1.next()) {
            var linkPosition = linkPositionCache_1_1.value;
            try {
                for (var _c = (e_2 = void 0, __values(linkPosition.pos)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var pos = _d.value;
