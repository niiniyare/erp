...
function drawSingleLineRichText(excelRender, sheet, ctx, dataProvider, fontStyle, richTexts, x, y, width, height, horizontal, vertical, row) {
    ...
    var text = '';
    try {
        for (var richTexts_1 = __values(richTexts), richTexts_1_1 = richTexts_1.next(); !richTexts_1_1.done; richTexts_1_1 = richTexts_1.next()) {
            ...
            var textSize = measureTextWithCache(ctx, font, richText.t);
    ...
    var padding = 0;
    drawMultiLineText(excelRender, sheet, ctx, dataProvider, fontStyle, lines, x, y, width, height, padding, horizontal, vertical, text, row);
}

export { drawSingleLineRichText };
