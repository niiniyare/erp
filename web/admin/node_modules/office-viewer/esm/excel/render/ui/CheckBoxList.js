...
var CheckBoxList = /** @class */ (function () {
    function CheckBoxList(container, selectAllText, searchPlaceholder, options, onCheck) {
        ...
        var checkAll = new CheckBox(listContainer, checkAllOption, function (checked) {
        ...
        try {
            for (var options_1 = __values(options), options_1_1 = options_1.next(); !options_1_1.done; options_1_1 = options_1.next()) {
                ...
                var checkbox = new CheckBox(listContainer, option, function (checked, option) {
    ...
    CheckBoxList.prototype.handleSearch = function (text) {
        ...
        if (text) {
            try {
                // 做一下过滤
                for (var _c = __values(this.checkBoxes), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            try {
                for (var _e = __values(this.checkBoxes), _f = _e.next(); !_f.done; _f = _e.next()) {
