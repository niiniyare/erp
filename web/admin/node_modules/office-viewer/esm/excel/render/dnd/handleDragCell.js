...
import { objectEqual } from '../../../util/objectEqual.js';
import { mergeRange } from '../../io/excel/util/Range.js';
import { cellToMergeCell } from '../cell/cellToMergeCell.js';
...
function mergeWithNewCell(range, mergeCells, row, col) {
    var mergeCell = cellToMergeCell(row, col, mergeCells);
...
function handleDragCell(offsetX, offsetY) {
    ...
    // 后续要支持多选得改这里
    var firstCellRange = dragState.selection.cellRanges[0];
    // 如果超出当前单元格，需要做 hitTest，判断是否在其他单元格内
    var hitTestResult = (_a = dragState.workbook) === null || _a === void 0 ? void 0 : _a.getActiveSheet().hitTest(offsetX, offsetY);
    // 目前只支持在相同类型的单元格内拖拽
    if (hitTestResult && hitTestResult.type === dragState.dragType) {
        var mergeCells = ((_b = dragState.workbook) === null || _b === void 0 ? void 0 : _b.getActiveSheet().getMergeCells()) || [];
        // 如果在选区范围内
        var newRange = mergeRange(dragState.selection.activeCell, hitTestResult);
        ...
        if (!objectEqual(newRange, firstCellRange)) {
            ...
            (_c = dragState.workbook) === null || _c === void 0 ? void 0 : _c.uiEvent.emit('CHANGE_SELECTION', dragState.selection);
        }
    }
}

export { handleDragCell };
