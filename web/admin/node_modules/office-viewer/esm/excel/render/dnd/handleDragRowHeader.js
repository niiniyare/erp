...
function handleDragRowHeader(offsetX, offsetY) {
    ...
    var row = dragState.selection.activeCell.startRow;
    // 后续要支持多选得改这里
    ...
    if (hitTestResult) {
        ...
        if (hitTestResult.startRow !== row) {
            ...
            (_b = dragState.workbook) === null || _b === void 0 ? void 0 : _b.uiEvent.emit('CHANGE_SELECTION', dragState.selection);
        }
        else {
