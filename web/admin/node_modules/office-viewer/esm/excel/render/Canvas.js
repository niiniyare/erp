...
import { drawOffscreenCanvas } from './canvas/drawOffscreenCanvas.js';
import { setPixelRatio } from './canvas/setPixelRatio.js';
...
var Canvas = /** @class */ (function () {
    ...
    Canvas.prototype.handleMousemove = function (event) {
        ...
        try {
            for (var _b = __values(this.widgets.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var widget = _c.value;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        img.src = url;
                        img.onload = function () {
                            var imageBitmap = drawOffscreenCanvas(ratio, width, height, function (ctx) {
