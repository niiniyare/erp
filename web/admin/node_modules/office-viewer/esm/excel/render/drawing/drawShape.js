...
import { drawTextInCell } from '../cell/drawTextInCell.js';
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    ...
                    if (!rectIntersect(renderRect, relativeDisplayRect)) return [3 /*break*/, 3];
                    ...
                    prst = prstGeom.prst;
                    shape = presetShape[prst];
                    if (!shape) return [3 /*break*/, 2];
                    avLst = [];
                    try {
                        // 将自动解析的 avLst 转成之前手动解析的 ShapeGuide
                        for (_h = __values(((_a = prstGeom.avLst) === null || _a === void 0 ? void 0 : _a.gd) || []), _j = _h.next(); !_j.done; _j = _h.next()) {
                            gd = _j.value;
                            avLst.push({
                                n: gd.name,
                                f: gd.fmla
                    ...
                    try {
                        // 将自动解析的 avLst 转成之前手动解析的 ShapeGuide
                        for (_k = __values(((_b = prstGeom.avLst) === null || _b === void 0 ? void 0 : _b.gd) || []), _l = _k.next(); !_l.done; _l = _k.next()) {
                            gd = _l.value;
                            avLst.push({
                                n: gd.name,
                                f: gd.fmla
                    ...
                    svg = shapeToSVG(shape, avLst, convertIShapePropertiesToShapePr(spPr), drawingRect.width, drawingRect.height, {
                ...
                case 2:
                    ...
                    if (richText) {
                        ...
                        drawTextInCell(excelRender, currentSheet, canvas.getContext(), dataProvider, cellInfo, drawingRect.x - displayRect.x, drawingRect.y - displayRect.y, drawingRect.width, drawingRect.height, 0, 0);
                    }
                    _p.label = 3;
