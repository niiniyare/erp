...
function fromPieChart(workbook, pieChart) {
    var e_1, _a;
    var _b, _c, _d, _e, _f;
    var categories = [];
    var series = [];
    var chartSer = pieChart.ser || [];
    try {
        for (var chartSer_1 = __values(chartSer), chartSer_1_1 = chartSer_1.next(); !chartSer_1_1.done; chartSer_1_1 = chartSer_1.next()) {
            var ser = chartSer_1_1.value;
            var seriesData = getData(workbook, ser.val);
            ...
            var label = buildLabel(ser.dLbls);
            series.push({
                name: name_1,
                data: seriesData,
                type: 'pie'
