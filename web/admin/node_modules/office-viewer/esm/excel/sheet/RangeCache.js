...
import { rangeIntersect } from '../io/excel/util/Range.js';
...
function rangeCacheKeyToRange(key) {
    var _a = __read(key.split('-'), 4), startRow = _a[0], startCol = _a[1], endRow = _a[2], endCol = _a[3];
    return {
    ...
    RangeCache.prototype.clear = function (ranges) {
        ...
        try {
            for (var ranges_1 = __values(ranges), ranges_1_1 = ranges_1.next(); !ranges_1_1.done; ranges_1_1 = ranges_1.next()) {
                ...
                try {
                    for (var _d = (e_2 = void 0, __values(this.cache.keys())), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var rangeKeys = _e.value;
                        var cacheRanges = rangeKeys.split(' ').map(rangeCacheKeyToRange);
                        try {
                            for (var cacheRanges_1 = (e_3 = void 0, __values(cacheRanges)), cacheRanges_1_1 = cacheRanges_1.next(); !cacheRanges_1_1.done; cacheRanges_1_1 = cacheRanges_1.next()) {
...
export { RangeCache, rangeCacheKey, rangeCacheKeyToRange };
