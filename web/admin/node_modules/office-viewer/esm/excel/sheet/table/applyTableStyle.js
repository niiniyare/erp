import { presetTableStyles } from '../../io/excel/preset/presetTableStyles.js';
import { applyDxf } from '../applyDxf.js';
import { buildTableStyle } from './buildTableStyle.js';
import { calcTableRelativePosition } from './calcTableRelativePosition.js';
...
function applyTableStyle(cellInfo, tablePart, ref, sheet, row, col) {
    ...
    var tableStyle = presetTableStyles[name];
    if (!tableStyle) {
        console.warn('未知的表格样式', name);
        return;
    }
    var tablePosition = calcTableRelativePosition(ref, function (r) { return sheet.isRowHidden(r); }, function (c) { return sheet.isColHidden(c); }, row, col, headerRowCount, totalsRowCount, totalsRowShown);
    ...
    var tableStyles = buildTableStyle(tableStyle);
