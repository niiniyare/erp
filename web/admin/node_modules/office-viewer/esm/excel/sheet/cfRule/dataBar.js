...
function findExt(extLst, sheetExtLst) {
    ...
    try {
        for (var _g = __values(extLst || []), _h = _g.next(); !_h.done; _h = _g.next()) {
            var exts = _h.value;
            try {
                for (var _j = (e_2 = void 0, __values(exts.ext || [])), _k = _j.next(); !_k.done; _k = _j.next()) {
                    var ext = _k.value;
                    var x14Id = ext['x14:id'];
                    if (x14Id) {
                        try {
                            for (var _l = (e_3 = void 0, __values(sheetExtLst.ext || [])), _m = _l.next(); !_m.done; _m = _l.next()) {
                                ...
                                try {
                                    for (var _o = (e_4 = void 0, __values(x14CFs || [])), _p = _o.next(); !_p.done; _p = _o.next()) {
                                        var x14CFItem = _p.value;
                                        var x14CfRules = x14CFItem['x14:cfRule'];
                                        try {
                                            for (var _q = (e_5 = void 0, __values(x14CfRules || [])), _r = _q.next(); !_r.done; _r = _q.next()) {
...
function dataBar(sheet, cellInfo, ranges, cfRule) {
    ...
    if (!dataBarCache) {
        ...
        var _d = getMinMax(rangeValues), min = _d.min, max = _d.max;
