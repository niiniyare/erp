 ...
 * @returns 返回宽度像素
 */
function baseColWidth2px(colWidth, fontWidth) {
    // 文档（P.1685）里的说法是
 ...
 * @returns 返回宽度像素
 */
function colWidth2px(colWidth, fontWidth) {
    return baseColWidth2px(colWidth - 0.83203125, fontWidth);
}
/**
 * 根据像素反算列宽
 */
function px2colWidth(px, fontWidth) {
    return (px - 5) / fontWidth + 0.83203125;
}

export { baseColWidth2px, colWidth2px, px2colWidth };
