...
import { pt2px } from '../../util/ptToPx.js';
import { colWidth2px, px2colWidth, baseColWidth2px } from '../sheet/ColWidth.js';
import { hasValue } from '../types/worksheet/CellData.js';
import defaultFont from './defaultFont.js';
import numfmt from 'numfmt';
import BuiltInNumFmt from '../sheet/BuiltInNumFmt.js';
import { rgbTint } from '../../util/color.js';
import { AUTO_COLOR, DEFAULT_FONT_SIZE, MAX_ROW } from '../render/Consts.js';
import { measureTextWithCache } from '../render/cell/measureTextWithCache.js';
import { genFontStr } from '../render/cell/genFontStr.js';
import { IndexedColors } from '../render/IndexedColors.js';
import { PresetColorMap } from '../../openxml/colorNameMap.js';
import { applyAutoFilter } from './applyAutoFilter.js';
import { numfmtExtend } from './numfmtExtend.js';
import { getThemeColor } from './getThemeColor.js';
import { sortByRange } from './autoFilter/sortByRange.js';
import { px2pt } from '../../util/px2pt.js';
...
var LocalDataProvider = /** @class */ (function () {
    ...
    LocalDataProvider.prototype.initNumfmt = function () {
        ...
        BuiltInNumFmt.forEach(function (numFmt, index) {
            var instance = numfmt(numFmt, {
                locale: locale
            });
            _this.numfmtInstances[index] = instance;
        });
        try {
            for (var _e = __values(((_c = (_b = this.workbook.styleSheet) === null || _b === void 0 ? void 0 : _b.numFmts) === null || _c === void 0 ? void 0 : _c.numFmt) || []), _f = _e.next(); !_f.done; _f = _e.next()) {
                var numFmt = _f.value;
                var instance = void 0;
                try {
                    // 不知为啥还有 aaaa 这种写法，在稻壳里比较常见
                    instance = numfmt((_d = numFmt.formatCode) === null || _d === void 0 ? void 0 : _d.replace('aaaa', 'dddd').replace('aaa', 'ddd'), {
                        locale: locale
                    });
                }
                catch (error) {
    ...
    LocalDataProvider.prototype.applyFilter = function () {
        ...
        var _c, _d;
        try {
            for (var _e = __values(this.workbook.sheets.entries()), _f = _e.next(); !_f.done; _f = _e.next()) {
                var _g = __read(_f.value, 2), sheetIndex = _g[0], sheet = _g[1];
                ...
                try {
                    // 应用表格中的自动过滤
                    for (var _h = (e_3 = void 0, __values(((_d = sheet.worksheet) === null || _d === void 0 ? void 0 : _d.tableParts) || [])), _j = _h.next(); !_j.done; _j = _h.next()) {
                        var tableParts = _j.value;
                        if (tableParts.autoFilter) {
                            var headerRowCount = tableParts.headerRowCount || 1;
                            applyAutoFilter(sheetIndex, this.workbook, sheet, this, tableParts.autoFilter, headerRowCount);
                        }
                    }
                }
    ...
    LocalDataProvider.prototype.getColWidth = function (sheetIndex, colIndex) {
        ...
        if (sheet) {
            var cols = ((_b = sheet.worksheet) === null || _b === void 0 ? void 0 : _b.cols) || [];
            try {
                for (var _e = __values(cols.entries()), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var _g = __read(_f.value, 2), index = _g[0], col = _g[1];
                    if (!col) {
                        continue;
                    }
    ...
    LocalDataProvider.prototype.setColWidth = function (sheetIndex, col, width) {
        ...
        if (sheet && sheet.worksheet) {
            ...
            var defaultFontSize = this.getDefaultFontSize();
            sheet.worksheet.cols[col].width = px2colWidth(width, defaultFontSize.width);
        }
    };
    ...
    LocalDataProvider.prototype.getMaxCol = function (sheetIndex) {
        ...
        if (sheet) {
            ...
            var index = 0;
            try {
                for (var cellData_1 = __values(cellData), cellData_1_1 = cellData_1.next(); !cellData_1_1.done; cellData_1_1 = cellData_1.next()) {
    ...
    LocalDataProvider.prototype.getDefaultFont = function () {
        var _a, _b, _c;
        return ((_c = (_b = (_a = this.workbook.styleSheet) === null || _a === void 0 ? void 0 : _a.fonts) === null || _b === void 0 ? void 0 : _b.font) === null || _c === void 0 ? void 0 : _c[0]) || defaultFont;
    };
    LocalDataProvider.prototype.getColor = function (color, defaultColor) {
        ...
        if (typeof color.theme !== 'undefined') {
            var themeColor = this.getThemeColor(color.theme);
            if (color.tint) {
    ...
    LocalDataProvider.prototype.getFontStyle = function (font) {
        ...
        var size = ((_c = font === null || font === void 0 ? void 0 : font.sz) === null || _c === void 0 ? void 0 : _c.val) || ((_d = defaultFont.sz) === null || _d === void 0 ? void 0 : _d.val) || DEFAULT_FONT_SIZE;
    ...
    LocalDataProvider.prototype.getDefaultFontSize = function () {
        ...
        var defaultFont = genFontStr(this.defaultFontStyle);
        ctx.font = defaultFont;
        var size = measureTextWithCache(ctx, defaultFont, '1');
