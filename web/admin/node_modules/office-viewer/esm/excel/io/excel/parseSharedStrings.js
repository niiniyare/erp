...
import { parseColor } from './stylesheet/parseColor.js';
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 1:
                    sst = _k.sent();
                    try {
                        for (_a = __values(sst.children || []), _b = _a.next(); !_b.done; _b = _a.next()) {
                            si = _b.value;
                            ...
                            if (si.tag === 'si') {
                                ...
                                try {
                                    for (_c = (e_3 = void 0, __values(si.children || [])), _d = _c.next(); !_d.done; _d = _c.next()) {
                                        rst = _d.value;
                                        if (rst.tag === 'r') {
                                            isSimple = false;
                                            rPr = {};
                                            ...
                                            try {
                                                // 对应 CT_RElt
                                                for (_e = (e_4 = void 0, __values(rst.children || [])), _f = _e.next(); !_f.done; _f = _e.next()) {
                                                    relt = _f.value;
                                                    tag = relt.tag;
                                                    if (tag === 'rPr') {
                                                        rPr = parseRPr(relt);
