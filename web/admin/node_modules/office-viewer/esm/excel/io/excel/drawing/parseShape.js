...
import { CT_Shape_Attributes } from '../../../../openxml/ExcelTypes.js';
import { parseOutline } from '../../../../openxml/drawing/ShapeProperties.js';
import { parseChildColor } from '../../../../word/parse/parseChildColor.js';
import { getThemeColor } from '../../../data/getThemeColor.js';

function parseShape(workbook, child, twoCellAnchorElement) {
    var e_1, _a, e_2, _b, e_3, _c, e_4, _d;
    var shape = autoParse(child, CT_Shape_Attributes);
    // 下面是转成渲染需要的数据
    if (twoCellAnchorElement) {
        ...
        if (spPrs.length && shape.spPr) {
            var spPr = spPrs[0];
            try {
                for (var _e = __values(spPr.children || []), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var spPrChild = _f.value;
                    var tag = spPrChild.tagName;
                    switch (tag) {
                        case 'a:ln':
                            var outline = parseOutline(function (c) {
                                return getThemeColor(c, workbook);
                            }, spPrChild);
                            shape.spPr.outline = outline;
                            break;
                        case 'a:solidFill':
                            shape.spPr.fillColor = parseChildColor(function (c) {
                                return getThemeColor(c, workbook);
                            }, spPrChild);
                            break;
                        default:
        ...
        if (style.length) {
            ...
            try {
                for (var _g = __values(style[0].children || []), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var styleChild = _h.value;
                    var tagName = styleChild.tagName;
                    switch (tagName) {
                        case 'a:lnRef':
                            styleColor.lnRefColor = parseChildColor(function (c) {
                                return getThemeColor(c, workbook);
                            }, styleChild);
                            break;
                        case 'a:fillRef':
                            styleColor.fillRefColor = parseChildColor(function (c) {
                                return getThemeColor(c, workbook);
                            }, styleChild);
                            break;
                        case 'a:effectRef':
                            styleColor.effectRefColor = parseChildColor(function (c) {
                                return getThemeColor(c, workbook);
                            }, styleChild);
                            break;
                        case 'a:fontRef':
                            styleColor.fontRefColor = parseChildColor(function (c) {
                                return getThemeColor(c, workbook);
                            }, styleChild);
                            break;
                        default:
        ...
        if (txBodies.length) {
            ...
            try {
                for (var ps_1 = __values(ps), ps_1_1 = ps_1.next(); !ps_1_1.done; ps_1_1 = ps_1.next()) {
                    ...
                    try {
                        for (var rs_1 = (e_4 = void 0, __values(rs)), rs_1_1 = rs_1.next(); !rs_1_1.done; rs_1_1 = rs_1.next()) {
                            var r = rs_1_1.value;
                            ...
                            if (t.length) {
                                ...
                                if (rPrNodes.length) {
                                    ...
                                    if (solidFill.length) {
                                        rPr.color = {
                                            rgb: parseChildColor(function (c) {
                                                return getThemeColor(c, workbook);
                                            }, solidFill[0])
                                        };
                                    }
