...
import { ExcelRender } from './render/ExcelRender.js';
import { Sheet } from './sheet/Sheet.js';
import { handleKeydown } from './render/keyboard/handleKeydown.js';
import { handlePaste } from './render/keyboard/handlePaste.js';
import { FormulaBar } from './render/formulaBar/FormulaBar.js';
import { SheetTabBar } from './render/sheetTab/SheetTabBar.js';
import { H } from '../util/H.js';
import { getTranslate } from './lang/lang.js';
import { renderInIframe } from './print/renderInIframe.js';
...
var Workbook = /** @class */ (function () {
    function Workbook(container, workbookData, dataProvider, renderOptions, sheetName) {
         ...
         */
        this.uiEvent = new EventEmitter();
        this.renderOptions = renderOptions;
        this.container = container;
        this.dataProvider = dataProvider;
        dataProvider.getSheets().forEach(function (sheetData, index) {
            _this.sheets.push(new Sheet(index, dataProvider, sheetData, _this, renderOptions));
        });
        this.workbookData = workbookData;
        this.initActiveSheet();
        this.initDom(container);
        // 公式栏
        this.formulaBar = new FormulaBar(this.formulaBarContainer, this, renderOptions);
        this.styleSheet = new StyleSheet(dataProvider);
        this.excelRender = new ExcelRender(this.contentContainer, this.dataContainer, this, dataProvider, renderOptions);
        // 底部 sheet 切换
        this.sheetTabBar = new SheetTabBar(this.sheetTabBarContainer, this, renderOptions);
    ...
    Workbook.prototype.setActiveSheet = function (sheetName) {
        ...
        if (!sheetName) {
            ...
            try {
                for (var _b = __values(this.sheets), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var sheet = _c.value;
