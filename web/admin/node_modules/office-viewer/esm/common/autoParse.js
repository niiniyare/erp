...
function autoParse(node, attributes, fillDefault) {
    ...
    for (var key in attrs) {
        ...
        if (resultKey in attributes) {
            ...
            if (attribute.type === 'int') {
                ...
                result[resultKey] = normalizeBoolean(value, attribute.defaultValue);
            }
    ...
    var _loop_1 = function (attributeKey) {
        ...
        if (attribute.type === 'child') {
            try {
                for (var _d = (e_1 = void 0, __values((node === null || node === void 0 ? void 0 : node.children) || [])), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var child = _e.value;
            ...
            try {
                for (var _f = (e_2 = void 0, __values((node === null || node === void 0 ? void 0 : node.children) || [])), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var child = _g.value;
                    var tag = removeNamespace(child.tag);
                    if (tag === attributeKey) {
            ...
            try {
                for (var _h = (e_3 = void 0, __values((node === null || node === void 0 ? void 0 : node.children) || [])), _j = _h.next(); !_j.done; _j = _h.next()) {
                    var child = _j.value;
                    var tag = removeNamespace(child.tag);
                    if (tag === attributeKey) {
            ...
            result[ANY_KEY] = (node === null || node === void 0 ? void 0 : node.children) || [];
        }
    };
    // 自定义类型
