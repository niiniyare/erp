...
var ed5 = require('./xmlchars/xml/1.0/ed5.js');
var ed2 = require('./xmlchars/xml/1.1/ed2.js');
var ed3 = require('./xmlchars/xmlns/1.0/ed3.js');
...
var DOCTYPE_TERMINATOR = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(QUOTES), false), [OPEN_BRACKET, GREATER], false);
var DTD_TERMINATOR = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(QUOTES), false), [LESS, CLOSE_BRACKET], false);
var XML_DECL_NAME_TERMINATOR = tslib.__spreadArray([EQUAL, QUESTION], tslib.__read(S_LIST), false);
var ATTRIB_VALUE_UNQUOTED_TERMINATOR = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(S_LIST), false), [GREATER, AMP, LESS], false);
...
function nsMappingCheck(parser, mapping) {
    var e_1, _a;
    try {
        for (var _b = tslib.__values(Object.keys(mapping)), _c = _b.next(); !_c.done; _c = _b.next()) {
            var local = _c.value;
...
var SaxesParser = /** @class */ (function () {
    ...
    function SaxesParser(opt) {
        ...
        if (xmlnsOpt) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-assignment
            this.ns = tslib.__assign({ __proto__: null }, rootNS);
...
/^[A-Za-z0-9][A-Za-z0-9._-]*$/.');
    ...
    SaxesParser.prototype.processAttribsNS = function () {
        ...
        try {
            ...
            for (var _d = tslib.__values(attribList), _e = _d.next(); !_e.done; _e = _d.next()) {
                var attr = _e.value;
    ...
    SaxesParser.prototype.processAttribsPlain = function () {
        ...
        try {
            for (var attribList_1 = tslib.__values(attribList), attribList_1_1 = attribList_1.next(); !attribList_1_1.done; attribList_1_1 = attribList_1.next()) {
