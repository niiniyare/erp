...
var fromExcelDate = require('../../io/excel/util/fromExcelDate.js');
var inDateGroupItems = require('./inDateGroupItems.js');
    ...
    try {
        for (var values_1 = tslib.__values(values), values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
            ...
            if (dateGroupItemDates.length > 0) {
                if (!inDateGroupItems.inDateGroupItems(dateGroupItemDates, fromExcelDate.fromExcelDate(cellValue.value, is1904))) {
                    hiddenRows.add(cellValue.row);
                }
            }
        }
