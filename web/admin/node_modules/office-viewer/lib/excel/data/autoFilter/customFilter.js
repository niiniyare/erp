...
var evalCustomFilter = require('./evalCustomFilter.js');
...
function customFilter(values, customFilters) {
    ...
    try {
        for (var values_1 = tslib.__values(values), values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
            ...
            try {
                for (var filters_1 = (e_2 = void 0, tslib.__values(filters)), filters_1_1 = filters_1.next(); !filters_1_1.done; filters_1_1 = filters_1.next()) {
                    ...
                    var evalResult = evalCustomFilter.evalCustomFilter(operator, val, cellValue);
                    // 在并的场景下，只要有个条件不匹配就隐藏
                    if (and) {
                        if (!evalResult) {
    ...
    if (!and) {
        try {
            for (var showRows_1 = tslib.__values(showRows), showRows_1_1 = showRows_1.next(); !showRows_1_1.done; showRows_1_1 = showRows_1.next()) {
