...
function getViewPointData(getSheetRowData, getMergeCells, getRowHeight, getColWidth, viewRange) {
    ...
    try {
        for (var rows_1 = tslib.__values(rows), rows_1_1 = rows_1.next(); !rows_1_1.done; rows_1_1 = rows_1.next()) {
            ...
            var cIndex = 0;
            try {
                for (var cols_1 = (e_3 = void 0, tslib.__values(cols)), cols_1_1 = cols_1.next(); !cols_1_1.done; cols_1_1 = cols_1.next()) {
...
exports.calcCellDisplaySize = calcCellDisplaySize;
exports.getViewPointData = getViewPointData;
