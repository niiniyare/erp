...
function getRange(offset, shift, totalLength, getHeight, hiddenRange, rangeCache) {
    ...
    while (!(foundStart && foundEnd)) {
        try {
            ...
            for (var hiddenRange_1 = (e_1 = void 0, tslib.__values(hiddenRange)), hiddenRange_1_1 = hiddenRange_1.next(); !hiddenRange_1_1.done; hiddenRange_1_1 = hiddenRange_1.next()) {
...
exports.findStartInCache = findStartInCache;
