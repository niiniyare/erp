...
var ISheet = require('../../types/ISheet.js');
var parseWorksheet = require('./parseWorksheet.js');
                ...
                case 0:
                    ...
                    _loop_1 = function (sheetNode) {
                        ...
                        return tslib.__generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    sheet = autoParse.autoParse(sheetNode, ISheet.ISheet_Attributes);
                                    sheets.push(sheet);
                                    rId = sheet['r:id'];
                                    sheet.state;
                                    ...
                                    worksheetRelationPath = getRelPath.getRelPath(worksheetPath);
                                    worksheetRelationships = [];
                                    if (!parser.fileExists(worksheetRelationPath)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, parseRelationship.parseRelationship(parser.getString(worksheetRelationPath))];
                                case 1:
                                    worksheetRelationships = _g.sent();
                                    _g.label = 2;
                                case 2:
                                    _f = sheet;
                                    return [4 /*yield*/, parseWorksheet.parseWorksheet(workbook, parser, worksheetPath, sheetXML, worksheetRelationships, sharedStrings)];
                                case 3:
...
exports.parseSheets = parseSheets;
