...
var CustomFiltersUI = require('./CustomFiltersUI.js');
var FiltersUI = require('./FiltersUI.js');
...
var FilterColumnUI = /** @class */ (function () {
    function FilterColumnUI(autoFilterIcon, container, sheet, autoFilter, rangeRef, colIndex, headerRowCount) {
        var e_1, _a;
        var columnDataRange = tslib.__assign({}, rangeRef);
        ...
        new Divider.Divider(container);
        new CustomFiltersUI.CustomFiltersUI(autoFilterIcon, container, sheet, autoFilter, colIndex, headerRowCount, texts, isDate);
        new Divider.Divider(container);
        new FiltersUI.FiltersUI(autoFilterIcon, container, sheet, autoFilter, colIndex, headerRowCount, texts);
    }
    return FilterColumnUI;
}());

exports.FilterColumnUI = FilterColumnUI;
