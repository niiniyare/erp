...
function drawCells(excelRender, currentSheet, excelRenderOptions, canvas, displayData, linkPositionCache) {
    ...
    try {
        for (var displayData_1 = tslib.__values(displayData), displayData_1_1 = displayData_1.next(); !displayData_1_1.done; displayData_1_1 = displayData_1.next()) {
    ...
    try {
        for (var displayData_2 = tslib.__values(displayData), displayData_2_1 = displayData_2.next(); !displayData_2_1.done; displayData_2_1 = displayData_2.next()) {
            ...
            if (cellInfoMap.has(key)) {
                ...
                canvas.drawCell(excelRender, cellInfo, x, y, width, height, excelRenderOptions.indentSize, Consts.PADDING_SIZE, needClear, linkPositionCache);
            }
        }
    }
