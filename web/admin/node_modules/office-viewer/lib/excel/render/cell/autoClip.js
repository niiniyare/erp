...
function autoClip(ctx, dataProvider, cellInfoMap) {
    ...
    var _b;
    try {
        for (var cellInfoMap_1 = tslib.__values(cellInfoMap), cellInfoMap_1_1 = cellInfoMap_1.next(); !cellInfoMap_1_1.done; cellInfoMap_1_1 = cellInfoMap_1.next()) {
            var _c = tslib.__read(cellInfoMap_1_1.value, 2), key = _c[0], cellInfo = _c[1];
            ...
            if (cellInfoMap.has("".concat(row, ",").concat(nextCol))) {
                ...
                if (((_b = cellInfo.alignment) === null || _b === void 0 ? void 0 : _b.wrapText) !== true &&
                    ...
                    var size = measureTextWithCache.measureTextWithCache(ctx, font, cellInfo.text);
