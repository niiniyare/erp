...
var drawTopFrozen = require('./drawTopFrozen.js');
var drawLeftFrozen = require('./drawLeftFrozen.js');
var drawTopLeftFrozen = require('./drawTopLeftFrozen.js');
...
function drawFrozen(excelRender, currentSheet, dataProvider, excelRenderOptions, mainCanvas, height, width, linkPositionCache) {
    ...
    if (xSplit > 0 && ySplit > 0) {
        var rangeResult = drawTopLeftFrozen.drawTopLeftFrozen(excelRender, xSplit, ySplit, currentSheet, dataProvider, excelRenderOptions, mainCanvas, height, width, linkPositionCache);
        ...
        topViewRange = drawTopFrozen.drawTopFrozen(excelRender, ySplit, currentSheet, dataProvider, excelRenderOptions, mainCanvas, width, linkPositionCache);
    }
    else if (xSplit > 0) {
        leftViewRange = drawLeftFrozen.drawLeftFrozen(excelRender, xSplit, currentSheet, dataProvider, excelRenderOptions, mainCanvas, height, linkPositionCache);
    }
    return {
