...
var checkFont = require('./checkFont.js');
...
function mergeRPrWithDefaultFont(rPr, defaultFont) {
    ...
    return tslib.__assign(tslib.__assign({}, defaultFont), fontStyle);
}
/**
 * 基于 rPr 生成字体字符串
...
exports.genFontStr = genFontStr;
exports.genFontStrFromRPr = genFontStrFromRPr;
exports.mergeRPrWithDefaultFont = mergeRPrWithDefaultFont;
exports.rPrToFontStyle = rPrToFontStyle;
