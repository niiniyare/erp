...
var SheetList = /** @class */ (function () {
    ...
    SheetList.prototype.renderSheetMenuList = function (sheetMenu) {
        ...
        H.H('div', {
            ...
            parent: sheetMenu,
            innerHTML: Icons.Icons.menu
        });
        var sheetMenuList = H.H('div', {
        ...
        onClickOutside.onClickOutside(sheetMenu, function () {
    ...
    SheetList.prototype.renderNav = function (container) {
        ...
        var rightNav = H.H('div', {
            className: 'ov-excel-sheet-tab-bar__nav-icon',
            parent: sheetNav,
            innerHTML: Icons.Icons.right
        });
    ...
    SheetList.prototype.makeActiveSheetVisible = function () {
        ...
        try {
            for (var _b = tslib.__values(this.sheetTabs), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    SheetList.prototype.renderSheets = function (sheetList, firstRender) {
        ...
        this.workbook.sheets.forEach(function (sheet) {
            ...
            var sheetTab = H.H('div', {
                className: 'ov-excel-sheet-tab-bar__list-tab',
                parent: sheetList
            });
            var tabColor = sheet.getTabColor();
            if (tabColor !== 'none') {
                var color$1 = new color.Color(tabColor);
                sheetTab.style.backgroundImage = "linear-gradient(".concat(color$1.toRgba(0.1), ", ").concat(color$1.toRgba(0.5), ")");
