...
var stripNumber = require('../../../util/stripNumber.js');
...
var StatusBar = /** @class */ (function () {
    ...
    StatusBar.prototype.syncStatus = function () {
        ...
        var numberCount = 0;
        try {
            for (var rangesData_1 = tslib.__values(rangesData), rangesData_1_1 = rangesData_1.next(); !rangesData_1_1.done; rangesData_1_1 = rangesData_1.next()) {
        ...
        sum = stripNumber.stripNumber(sum, 10);
        var average = numberCount ? stripNumber.stripNumber(sum / numberCount, 10) : 0;
        status.innerHTML = '';
        H.H('span', {
