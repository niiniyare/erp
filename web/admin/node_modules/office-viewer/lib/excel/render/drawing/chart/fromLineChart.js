...
var calcPercentStacked = require('./calcPercentStacked.js');
var getStack = require('./getStack.js');
...
function fromLineChart(workbook, lineChart) {
    ...
    try {
        for (var ser_1 = tslib.__values(ser), ser_1_1 = ser_1.next(); !ser_1_1.done; ser_1_1 = ser_1.next()) {
            var lineSeries = ser_1_1.value;
            var seriesData = getData.getData(workbook, lineSeries.val);
            ...
            var label = buildLabel.buildLabel(lineSeries.dLbls);
            var stack = getStack.getStack(lineChart.grouping);
    ...
    if (isPercentStacked) {
        calcPercentStacked.calcPercentStacked(series);
    }
    return {
...
exports.fromLineChart = fromLineChart;
