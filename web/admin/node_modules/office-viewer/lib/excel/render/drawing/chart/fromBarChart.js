...
function fromBarChart(workbook, barChart) {
    ...
    try {
        for (var barSer_1 = tslib.__values(barSer), barSer_1_1 = barSer_1.next(); !barSer_1_1.done; barSer_1_1 = barSer_1.next()) {
            var barSeries = barSer_1_1.value;
            var seriesData = getData.getData(workbook, barSeries.val);
            ...
            var stack = getStack.getStack(barChart.grouping);
...
exports.fromBarChart = fromBarChart;
