...
var EChartsRender = require('./EChartsRender.js');
var convertToEChartOptions = require('./convertToEChartOptions.js');
...
function drawChart(currentSheet, displayRect, rowHeaderWidth, colHeaderHeight, chartRect, chartSpace) {
    ...
    if (Rect.rectIntersect(renderRect, relativeDisplayRect)) {
        ...
        if (EChartsMap[gid] && chartElement) {
            ...
            echartsRender = new EChartsRender.EChartsRender(dataContainer, renderRect, gid);
            EChartsMap[gid] = echartsRender;
            var echartsOption = convertToEChartOptions.convertToEChartOptions(workbook, chartSpace);
            if (echartsOption) {
