...
function getTwoCellAnchorPosition(twoCellAnchor, sheet) {
    ...
    var fromRowOffset = emuToPx.emuToPx((_d = from.rowOff) === null || _d === void 0 ? void 0 : _d[0]);
    var fromCol = ((_e = from.col) === null || _e === void 0 ? void 0 : _e[0]) || 0;
    var fromColOffset = emuToPx.emuToPx((_f = from.colOff) === null || _f === void 0 ? void 0 : _f[0]);
    var fromPosition = sheet.getCellPosition(fromRow, fromCol);
    var toRow = ((_g = to.row) === null || _g === void 0 ? void 0 : _g[0]) || 0;
    var toRowOffset = emuToPx.emuToPx((_h = to.rowOff) === null || _h === void 0 ? void 0 : _h[0]);
    var toCol = ((_j = to.col) === null || _j === void 0 ? void 0 : _j[0]) || 0;
    var toColOffset = emuToPx.emuToPx((_k = to.colOff) === null || _k === void 0 ? void 0 : _k[0]);
...
exports.getTwoCellAnchorPosition = getTwoCellAnchorPosition;
