 ...
 * 应用样式
 */
function applyColor(ctx, data, index, value, min, max, sparklineOptions, defaultColor, getColor) {
    value = stripNumber.stripNumber(value);
    min = stripNumber.stripNumber(min);
    max = stripNumber.stripNumber(max);
