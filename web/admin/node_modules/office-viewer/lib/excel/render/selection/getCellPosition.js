...
var binarySearch = require('../../../util/binarySearch.js');
...
function findColInViewRange(col, viewRange) {
    ...
    var colIndex = binarySearch.binarySearch(viewRange.cols, col);
    if (colIndex !== -1) {
        return {
...
function findRowInViewRange(row, viewRange) {
    ...
    var rowIndex = binarySearch.binarySearch(viewRange.rows, row);
    if (rowIndex !== -1) {
        return {
...
exports.getCellColPosition = getCellColPosition;
exports.getCellPositionWithMerge = getCellPositionWithMerge;
exports.getCellRowPosition = getCellRowPosition;
