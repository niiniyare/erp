        ...
        for (var _b = tslib.__values(element.children), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            switch (tagName) {
                ...
                case 'w14:shadow':
                    ...
                    var childColor = parseChildColor.parseChildColor(function (c) { return word.getThemeColor(c); }, child);
                    if (childColor) {
                        color = childColor;
                    }
                ...
                case 'w14:textOutline':
                    ...
                    if (fillColor.length > 0) {
                        outlineColor =
                            parseChildColor.parseChildColor(function (c) { return word.getThemeColor(c); }, fillColor.item(0)) ||
                                'white';
                    }
