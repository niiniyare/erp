...
var UnSupport = require('./UnSupport.js');
...
function createOfficeViewer(docFile, renderOptions, fileName, parser) {
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        var fileExt, excel, fileType$1, isWord, isExcel, contentTypes, _a, _b, item, excel;
        var e_1, _c;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    excel = new Excel["default"](docFile, fileName, renderOptions, parser);
                ...
                case 2:
                    ...
                    if (fileType$1 === null || (fileType$1.ext !== 'zip' && fileType$1.ext !== 'xml')) {
                        ...
                        return [2 /*return*/, new UnSupport["default"]('不支持的文件类型: ' + (fileType$1 === null || fileType$1 === void 0 ? void 0 : fileType$1.ext))];
                    }
                    try {
                        parser.load(docFile);
                    }
                    catch (error) {
                        return [2 /*return*/, new UnSupport["default"]('文件解析失败')];
                    }
                    isWord = false;
                    isExcel = false;
                    // 有些程序生成的文件没有这个，兼容一下
                    if (parser.fileExists('[Content_Types].xml')) {
                        contentTypes = ContentType.parseContentType(parser.getXML('[Content_Types].xml'));
                        try {
                            for (_a = tslib.__values(contentTypes.overrides), _b = _a.next(); !_b.done; _b = _a.next()) {
                                item = _b.value;
...
exports.createOfficeViewer = createOfficeViewer;
