...
var InvoiceLineDefinition = def.SystemDefinition{
	...
	Permissions: def.PermissionSet{
		Create: []string{"finance.invoice_line.create"},
		Read:   []string{"finance.invoice_line.read"},
		Write:  []string{"finance.invoice_line.update"},
		Delete: []string{"finance.invoice_line.delete"},
	},
}
	...
	Actions: []def.ActionDef{
		{
			...
			Permission:  "finance.credit_note.approve",
			Icon:        "fa fa-check",
			HandlerFunc: approveCreditNote,
		},
	},
	Permissions: def.PermissionSet{
		Create: []string{"finance.credit_note.create"},
		Read:   []string{"finance.credit_note.read"},
		Write:  []string{"finance.credit_note.update"},
		Delete: []string{"finance.credit_note.delete"},
	},
}
	...
	Actions: []def.ActionDef{
		{
			...
			Permission:  "finance.debit_note.approve",
			Icon:        "fa fa-check",
			HandlerFunc: approveDebitNote,
		},
	},
	Permissions: def.PermissionSet{
		Create: []string{"finance.debit_note.create"},
		Read:   []string{"finance.debit_note.read"},
		Write:  []string{"finance.debit_note.update"},
		Delete: []string{"finance.debit_note.delete"},
	},
}
