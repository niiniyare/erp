    ...
    "actions": [
        {
            ...
            "dialog": {
              "title": "Edit",
              "body": "You are editing this card"
            }
        },
        {
          "type": "button",
...
You can set clicking the card to open external links through the `href` attribute
...
```schema: scope="body"
{
    ...
    "media": {
      "type": "image",
      "className": "w-36 h-24",
      "url": "https://internal-awo-ui-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80",
      "position": "left"
    },
    "body": "这里是内容",
    "secondary": "次要说明",
