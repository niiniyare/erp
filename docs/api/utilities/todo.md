Update Todos
  ⎿  Add permission evaluation caching layer with Redis
      Research existing workflow patterns in codebase
     [*] Design access request data models and states
     [*] Implement access request repository layer
