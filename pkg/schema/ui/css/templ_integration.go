...
func (tsg *TemplStyleGenerator) mergeStyles(dest, src *ExpandedStyles) {
	// Layout properties
	if src.Layout.Display != "" { dest.Layout.Display = src.Layout.Display }
	if src.Layout.Position != "" { dest.Layout.Position = src.Layout.Position }
	if src.Layout.Top != "" { dest.Layout.Top = src.Layout.Top }
	if src.Layout.Right != "" { dest.Layout.Right = src.Layout.Right }
	if src.Layout.Bottom != "" { dest.Layout.Bottom = src.Layout.Bottom }
	if src.Layout.Left != "" { dest.Layout.Left = src.Layout.Left }
	if src.Layout.ZIndex != "" { dest.Layout.ZIndex = src.Layout.ZIndex }

	// Box model properties
	if src.BoxModel.Width != "" { dest.BoxModel.Width = src.BoxModel.Width }
	if src.BoxModel.Height != "" { dest.BoxModel.Height = src.BoxModel.Height }
	if src.BoxModel.MinWidth != "" { dest.BoxModel.MinWidth = src.BoxModel.MinWidth }
	if src.BoxModel.MinHeight != "" { dest.BoxModel.MinHeight = src.BoxModel.MinHeight }
	if src.BoxModel.MaxWidth != "" { dest.BoxModel.MaxWidth = src.BoxModel.MaxWidth }
	if src.BoxModel.MaxHeight != "" { dest.BoxModel.MaxHeight = src.BoxModel.MaxHeight }
	if src.BoxModel.BoxSizing != "" { dest.BoxModel.BoxSizing = src.BoxModel.BoxSizing }

	// Margin properties
	if src.Margin.Margin != "" { dest.Margin.Margin = src.Margin.Margin }
	if src.Margin.Top != "" { dest.Margin.Top = src.Margin.Top }
	if src.Margin.Right != "" { dest.Margin.Right = src.Margin.Right }
	if src.Margin.Bottom != "" { dest.Margin.Bottom = src.Margin.Bottom }
	if src.Margin.Left != "" { dest.Margin.Left = src.Margin.Left }

	// Padding properties
	if src.Padding.Padding != "" { dest.Padding.Padding = src.Padding.Padding }
	if src.Padding.Top != "" { dest.Padding.Top = src.Padding.Top }
	if src.Padding.Right != "" { dest.Padding.Right = src.Padding.Right }
	if src.Padding.Bottom != "" { dest.Padding.Bottom = src.Padding.Bottom }
	if src.Padding.Left != "" { dest.Padding.Left = src.Padding.Left }

	// Border properties
	if src.Border.Border != "" { dest.Border.Border = src.Border.Border }
	if src.Border.Radius != "" { dest.Border.Radius = src.Border.Radius }
	if src.Border.Width != "" { dest.Border.Width = src.Border.Width }
	if src.Border.Style != "" { dest.Border.Style = src.Border.Style }
	if src.Border.Color != "" { dest.Border.Color = src.Border.Color }

	// Background properties
	if src.Background.Background != "" { dest.Background.Background = src.Background.Background }
	if src.Background.Color != "" { dest.Background.Color = src.Background.Color }
	if src.Background.Image != "" { dest.Background.Image = src.Background.Image }

	// Typography properties
	if src.Typography.Color != "" { dest.Typography.Color = src.Typography.Color }
	if src.Typography.FontSize != "" { dest.Typography.FontSize = src.Typography.FontSize }
	if src.Typography.FontWeight != "" { dest.Typography.FontWeight = src.Typography.FontWeight }
	if src.Typography.FontFamily != "" { dest.Typography.FontFamily = src.Typography.FontFamily }
	if src.Typography.LineHeight != "" { dest.Typography.LineHeight = src.Typography.LineHeight }
	if src.Typography.TextAlign != "" { dest.Typography.TextAlign = src.Typography.TextAlign }

	// Flexbox properties
	if src.Flexbox.Direction != "" { dest.Flexbox.Direction = src.Flexbox.Direction }
	if src.Flexbox.JustifyContent != "" { dest.Flexbox.JustifyContent = src.Flexbox.JustifyContent }
	if src.Flexbox.AlignItems != "" { dest.Flexbox.AlignItems = src.Flexbox.AlignItems }
	if src.Flexbox.Wrap != "" { dest.Flexbox.Wrap = src.Flexbox.Wrap }
	if src.Flexbox.Flex != "" { dest.Flexbox.Flex = src.Flexbox.Flex }

	// Grid properties
	if src.Grid.TemplateColumns != "" { dest.Grid.TemplateColumns = src.Grid.TemplateColumns }
	if src.Grid.TemplateRows != "" { dest.Grid.TemplateRows = src.Grid.TemplateRows }
	if src.Grid.Gap != "" { dest.Grid.Gap = src.Grid.Gap }

	// Visual effects
	if src.VisualEffects.Opacity != "" { dest.VisualEffects.Opacity = src.VisualEffects.Opacity }
	if src.VisualEffects.BoxShadow != "" { dest.VisualEffects.BoxShadow = src.VisualEffects.BoxShadow }
	if src.VisualEffects.Transform != "" { dest.VisualEffects.Transform = src.VisualEffects.Transform }

	// Transition properties
	if src.Transition.Transition != "" { dest.Transition.Transition = src.Transition.Transition }

	// Overflow properties
	if src.Overflow.Overflow != "" { dest.Overflow.Overflow = src.Overflow.Overflow }
	if src.Overflow.X != "" { dest.Overflow.X = src.Overflow.X }
	if src.Overflow.Y != "" { dest.Overflow.Y = src.Overflow.Y }
