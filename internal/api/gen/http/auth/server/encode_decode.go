...
// endpoint.
func DecodeRefreshRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*auth.RefreshPayload, error) {
	return func(r *http.Request) (*auth.RefreshPayload, error) {
		var (
...
// validate endpoint.
func DecodeValidateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*auth.ValidatePayload, error) {
	return func(r *http.Request) (*auth.ValidatePayload, error) {
		var (
			token *string
		)
		tokenRaw := r.Header.Get("Authorization")
