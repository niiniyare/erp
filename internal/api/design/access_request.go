...
// AccessReviewItem represents an individual access item being reviewed
var AccessReviewItem = Type("AccessReviewItem", func() {
	Description("Individual access right under review")
...
var ApprovalStep = Type("ApprovalStep", func() {
	Description("Individual step in the approval workflow")
...
var AccessRequest = ResultType("application/vnd.erp.access_request", func() {
	...
	Attributes(func() {
		...
		Field(19, "approval_steps", ArrayOf(ApprovalStep), "Approval workflow steps", func() {
...
var AccessReview = Type("AccessReview", func() {
	...
	Field(10, "access_items", ArrayOf(AccessReviewItem), "Items being reviewed", func() {
