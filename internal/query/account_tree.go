...
type AccountTreeNode struct {
	...
	NodeType domain.AccountNodeType `json:"node_type"`

	// Hierarchy metadata — always populated regardless of node type.
	ParentID    *uuid.UUID              `json:"parent_id,omitempty"`
	Level       int                     `json:"level"`
	Path        domain.MaterialisedPath `json:"path"`
...
type AccountNodeType = domain.AccountNodeType
...
type AccountNodeData struct {
	// Classification
	RootType      domain.RootType      `json:"root_type"`
...
type GroupNodeData struct {
	...
	StatementSection    *domain.StatementSection    `json:"financial_statement_section,omitempty"`
	ConsolidationMethod *domain.ConsolidationMethod `json:"consolidation_method,omitempty"`
	CashFlowCategory    *domain.CashFlowCategory    `json:"cash_flow_category,omitempty"`
...
type ChartOfAccountsFilter struct {
	EntityID          *uuid.UUID               `json:"entity_id,omitempty"`
	ReportingSchemeID *uuid.UUID               `json:"reporting_scheme_id,omitempty"`
	StatementSection  *domain.StatementSection `json:"statement_section,omitempty"`
