...
//
<<<<<<< HEAD:internal/shared/logger/mock_logger.go
//	mockgen -source=logger.go -destination=mock_logger.go -package=logger
=======
//	mockgen -source=logger.go -destination=logger_mock.go -package=logger
>>>>>>> ft/ffg:internal/shared/logger/logger_mock.go
//
