...
-- Drop constraints
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS valid_lockout_time;
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS valid_session_timeout;
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS valid_failed_attempts;
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS users_username_unique_active;
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS users_email_unique_active;
