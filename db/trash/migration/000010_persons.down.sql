...
-- Drop constraints
ALTER TABLE IF EXISTS persons DROP CONSTRAINT IF EXISTS persons_national_id_unique_active;
ALTER TABLE IF EXISTS persons DROP CONSTRAINT IF EXISTS persons_email_unique_active;
