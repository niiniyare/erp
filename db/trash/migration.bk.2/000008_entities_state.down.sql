...
-- Drop constraints
ALTER TABLE IF EXISTS entitystate DROP CONSTRAINT IF EXISTS positive_sequence;
ALTER TABLE IF EXISTS entitystate DROP CONSTRAINT IF EXISTS unique_tenant_entity_key_fy;
