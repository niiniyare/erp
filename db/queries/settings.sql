...
INSERT INTO config_definitions (
    ...
    sqlc.arg(module_name), sqlc.arg(config_key), sqlc.arg(data_type), sqlc.arg(default_value), 
    sqlc.arg(validation_rules), sqlc.arg(description), sqlc.arg(required_permission), 
    sqlc.arg(required_feature_flag), sqlc.arg(is_overridable)
) RETURNING *;
