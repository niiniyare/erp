...
DECLARE
    tid_str text;
BEGIN
    -- Get the setting with missing_ok=true
    ...
    -- Convert to integer
    BEGIN
        RETURN tid_str::integer;
    EXCEPTION WHEN invalid_text_representation THEN
        RAISE EXCEPTION 'Invalid tenant ID: %', tid_str USING ERRCODE = 'P0002';
    END;
END;
$$ LANGUAGE plpgsql;
...
-- Already calls apply/remove which now do logging
