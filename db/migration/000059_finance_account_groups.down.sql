...
-- Revoke permissions
REVOKE SELECT, INSERT, UPDATE, DELETE ON finance_account_groups FROM application_role;
REVOKE SELECT, INSERT, UPDATE, DELETE ON finance_account_groups FROM admin_role;
...
-- Disable RLS
ALTER TABLE finance_account_groups DISABLE ROW LEVEL SECURITY;
