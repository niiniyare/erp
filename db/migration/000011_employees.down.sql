...
-- Drop constraints
ALTER TABLE IF EXISTS employees DROP CONSTRAINT IF EXISTS valid_security_level;
ALTER TABLE IF EXISTS employees DROP CONSTRAINT IF EXISTS valid_termination_date;
ALTER TABLE IF EXISTS employees DROP CONSTRAINT IF EXISTS employees_number_unique_active;
