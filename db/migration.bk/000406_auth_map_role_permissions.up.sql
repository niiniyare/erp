...
-- ------------------------------------------------------------------------------------------------
-- Maps permissions to roles with optional entity-specific scoping and additional conditions
-- for flexible, context-aware authorization.
--
-- NOTE: Depends on tenants(id), roles(id), permissions(id), entities(uuid), and users(id).
--       RLS uses current_tenant_id().
-- ------------------------------------------------------------------------------------------------
