...
- [ ] Module permission identifiers documented in [`03-auth/RBAC_ROLES_REFERENCE.md`](../03-auth/RBAC_ROLES_REFERENCE.md) (role-to-permission mapping)
- [ ] `PermissionSet` on every entity uses permission identifiers only — no `role:` strings
