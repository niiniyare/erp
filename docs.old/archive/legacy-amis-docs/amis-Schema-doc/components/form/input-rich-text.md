...
```schema: scope="body"
{
    ...
    "body": [
        {
            "type": "input-rich-text",
            "receiver": "/api/mock2/sample/mirror?json={%22link%22:%22/awo-ui/static/logo_c812f54.png%22}",
            "name": "rich",
            "label": "Rich Text"
        }
    ]
...
> awo-ui 2.1.0 版本升级到了 tinymce 6，导致 plugins 的写法有变化
...
因为 awo-ui 中使用的是开源版本 tinymce，没有商业版本功能，导致比如从 Word 中粘贴表格会看不到边框，解决方法是自己
