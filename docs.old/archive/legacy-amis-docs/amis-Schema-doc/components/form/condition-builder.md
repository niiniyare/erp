          ...
          "fields": [
            {
              ...
              "name": "select",
              "searchable": true,
              "autoComplete": "https://3xsw4ap8wah59.cfc-execute.bj.baidubce.com/api/awo-ui-mock/mock2/options/autoComplete?term=$term",
            }
          ]
        }
    ]
...
- `value` 字段配置右边值需要渲染的组件，支持 awo-ui 输入类组件或自定义输入类组件
